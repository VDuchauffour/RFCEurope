...
def lookupFunction(module, functionOrClass, log=True):
    ...
    try:
        ...
        raise ConfigError(
            "Module '%s' must define function or class '%s'", module, functionOrClass
        )
...
def bindFunction(obj, functionOrAttribute):
    ...
    try:
        ...
        raise ConfigError(
            "Class '%s' must define function '%s'", obj.__class__, functionOrAttribute
        )
