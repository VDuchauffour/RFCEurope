...
class BugAlertsOptionsTab(BugOptionsTab.BugOptionsTab):
    ...
    def create(self, screen):
        ...
        self.addCheckboxIntDropdown(
            ...
            rightL,
            rightR,
            "Civ4lerts__GoldTrade",
            "Civ4lerts__GoldTradeThresh",
            "LAYOUT_LEFT",
        )
        self.addCheckboxIntDropdown(
            screen,
            rightL,
            rightR,
            "Civ4lerts__GoldPerTurnTrade",
            "Civ4lerts__GoldPerTurnTradeThresh",
            "LAYOUT_LEFT",
        )
        ...
        self.addCheckboxFloatDropdown(
            screen,
            rightL,
            rightR,
            "MoreCiv4lerts__DomPop",
            "MoreCiv4lerts__DomPopThresh",
            "LAYOUT_LEFT",
        )
        self.addCheckboxFloatDropdown(
            screen,
            rightL,
            rightR,
            "MoreCiv4lerts__DomLand",
            "MoreCiv4lerts__DomLandThresh",
            "LAYOUT_LEFT",
        )
