...
class BugCityScreenOptionsTab(BugOptionsTab.BugOptionsTab):
    ...
    def createProductionQueuePanel(self, screen, panel):
        ...
        self.addIntDropdown(
            screen, left, center, "CityScreen__ProductionDecayQueueUnitThreshold", True
        )
        self.addIntDropdown(
            screen, left, center, "CityScreen__ProductionDecayQueueBuildingThreshold", True
        )
        self.addIntDropdown(screen, None, right, "CityScreen__ProductionDecayHoverUnitThreshold")
        self.addIntDropdown(
            screen, None, right, "CityScreen__ProductionDecayHoverBuildingThreshold"
        )
