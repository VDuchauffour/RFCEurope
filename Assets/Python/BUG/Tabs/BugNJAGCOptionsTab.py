...
class BugNJAGCOptionsTab(BugOptionsTab.BugOptionsTab):
    ...
    def create(self, screen):
        ...
        leftPanel, centerPanel, rightPanel = self.addThreeColumnLayout(
            screen, upperPanel, "EraColors"
        )
        ...
        centerPanelL, centerPanelR = self.addTwoColumnLayout(
            screen, centerPanel, "ShowEraColor_Column"
        )
        self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_ANCIENT", True)
        self.addColorDropdown(
            screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_CLASSICAL", True
        )
        self.addColorDropdown(
            screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_MEDIEVAL", True
        )
        self.addColorDropdown(
            screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_RENAISSANCE", True
        )
        rightPanelL, rightPanelR = self.addTwoColumnLayout(
            screen, rightPanel, "ShowEraColor_Column"
        )
        self.addColorDropdown(
            screen, rightPanelL, rightPanelR, "NJAGC__Color_ERA_INDUSTRIAL", True
        )
