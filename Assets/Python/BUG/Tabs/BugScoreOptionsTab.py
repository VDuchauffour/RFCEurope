...
class BugScoreOptionsTab(BugOptionsTab.BugOptionsTab):
    ...
    def create(self, screen):
        ...
        col1L, col1R, col2, col3 = self.addMultiColumnLayout(
            screen, right, 4, "Scores_Power_Column"
        )
        self.addCheckboxTextDropdown(
            screen, col1L, col1R, "Scores__Power", "Scores__PowerFormula", "LAYOUT_LEFT"
        )
        ...
        left, space, center, right = self.addMultiColumnLayout(
            screen, column, 4, "Advanced_Scores_Column"
        )
        ...
        self.addCheckboxIntDropdown(
            screen, left, left, "Scores__ResearchIcons", "Scores__ResearchIconSize"
        )
        ...
        self.addIntDropdown(
            screen, centerL, centerR, "Scores__DefaultSpacing", True, "LAYOUT_LEFT"
        )
