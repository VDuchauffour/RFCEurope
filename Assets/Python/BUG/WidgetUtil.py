...
def _setWidgetHelp(widget, type, func):
    ...
    if widget in g_widgetHelp:
        ...
        BugUtil.debug(
            "WidgetUtil - registering %s hover help for WidgetTypes %d: %s", type, widget, func
        )
        ...
        ## City Hover Text ##
            ...
            if CyGame().GetWorldBuilderMode():
                ...
                if len(lBuildings) > 0:
                    ...
                    sText += (
                        "\n"
                        + CyTranslator().getText("[COLOR_BUILDING_TEXT]", ())
                ...
                if len(lWonders) > 0:
                    ...
                    sText += (
                        ...
                        + CyTranslator().getText("TXT_KEY_CONCEPT_WONDERS", ())
                        + ": </color>"
                    )
