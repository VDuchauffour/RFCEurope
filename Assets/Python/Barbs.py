...
class Barbs:
		...
		if ( iGameTurn >= con.i960AD and iGameTurn < con.i1401AD):
			self.spawnPirate( iBarbarian, (9,15), (55,33), con.iWarGalley, 1, 0, 0, iGameTurn, 10, 3, utils.outerSeaSpawn, 1)
		
		if ( iGameTurn >= con.i1401AD ):
			self.spawnPirate( iBarbarian, (9,15), (55,33), con.iCorsair, 1, 0, 0, iGameTurn, 5,3, utils.outerSeaSpawn, 1)
		...
		if ( iGameTurn >= con.i1200AD and iGameTurn < con.i1500AD):
			self.spawnPirate( iBarbarian, (9,15), (55,33), con.iCogge, 1, con.iSwordsman, 2, iGameTurn, 10, 5, utils.outerSeaSpawn, 1)

		if ( iGameTurn >= con.i1500AD ):
			self.spawnPirate( iBarbarian, (9,15), (55,33), con.iGalleon, 1, con.iMusketman, 2, iGameTurn, 10, 5, utils.outerSeaSpawn, 1)
		...
		if (iGameTurn >= con.i940AD and iGameTurn < con.i1000AD):
			self.spawnUnits( iBarbarian, (88,31),(99,40), con.iHorseArcher, 1 + iHandicap*2, iGameTurn,5,1,utils.outerInvasion,1)

		#Pechenegs and Cumans in Northern Balkans
		if (iGameTurn >= con.i940AD and iGameTurn < con.i1160AD):
			self.spawnUnits( iBarbarian, (66,33),(78,43), con.iHorseArcher, 2 + iHandicap*2, iGameTurn,6,1,utils.outerInvasion,1)
		...
		if (iGameTurn>=con.i1000AD and iGameTurn < con.i1060AD):
			#Scots
			self.spawnUnits( iBarbarian, (39,62),(44,66), con.iAxeman, 2 + iHandicap*2, iGameTurn,8,0,utils.outerInvasion,1)
			self.spawnUnits( iBarbarian, (39,62),(44,66), con.iSpearman, 2 + iHandicap*2, iGameTurn,8,0,utils.outerInvasion,1)
		...
		if (gc.getPlayer(con.iArabia).isAlive()):
                        if (iGameTurn>=con.i700AD and iGameTurn <= con.i1300AD ):
                            if (not gc.getTeam(gc.getPlayer(con.iArabia).getTeam()).isHasTech(con.iFarriers)):
		...
		self.foundCity(iBarbarian, lToulouse, "Tolosa", iGameTurn, 1, con.iArcher, 1)
		self.foundCity(iIndependent, lMarseilles, "Massilia", iGameTurn, 1, con.iArcher, 1)
		self.foundCity(iIndependent2, lTunis, "Tunis", iGameTurn, 1, con.iArcher, 1)
		self.foundCity(iIndependent, lMediolanum, "Mediolanum", iGameTurn, 3, con.iArcher, 1)
		self.foundCity(iIndependent, lMilan, "Milano", iGameTurn, 5, con.iArcher, 2)
		self.foundCity(iIndependent2, lFlorentia, "Florentia", iGameTurn, 3, con.iArcher, 1)
		self.foundCity(iIndependent2, lFirenze, "Firenze", iGameTurn, 5, con.iArcher, 2)
		self.foundCity(iBarbarian, lTripoli, "Tripoli", iGameTurn, 1, con.iArcher, 1) 
		self.foundCity(iIndependent3, lAugsburg, "Augsburg", iGameTurn, 1, con.iArcher, 1)
		self.foundCity(iIndependent, lNapoli, "Neapolis", iGameTurn, 3, con.iArcher, 1)
		self.foundCity(iIndependent2, lRagusa, "Ragusa", iGameTurn, 1, con.iArcher, 1)
		self.foundCity(iBarbarian, lBeograd, "Beograd", iGameTurn, 1, con.iArcher, 2)
		self.foundCity(iIndependent2, lRhodes, "Rhodes", iGameTurn, 1, con.iArcher, 1) #Start with Orthodoxy and a Harbor?
		...
		self.foundCity(iIndependent3, lTonsberg, "Tonsberg", iGameTurn, 1, con.iArcher, 2)
		self.foundCity(iBarbarian, lRiga, "Riga", iGameTurn, 1, con.iCrossbowman, 2)
		self.foundCity(iIndependent4, lTvanksta, "Tvanksta", iGameTurn, 1, con.iCrossbowman, 2)
		self.foundCity(iIndependent2, lLubeck, "Liubice", iGameTurn, 1, con.iArcher, 2)
		self.foundCity(iIndependent, lPrague, "Praha", iGameTurn, 1, con.iCrossbowman, 2)
		self.foundCity(iIndependent3, lKrakow, "Krakow", iGameTurn, 1, con.iCrossbowman, 2)
		self.foundCity(iIndependent4, lKharkov, "Kharkov", iGameTurn, 1, con.iCrossbowman, 2)
		...
		self.foundCity(iIndependent3, lYaroslavl, "Yaroslavl", iGameTurn, 1, con.iCrossbowman, 1)
		self.foundCity(iIndependent2, lVologda, "Vologda", iGameTurn, 1, con.iCrossbowman, 2)
		...
		self.foundCity(iIndependent2, lGroningen, "Groningen", iGameTurn, 1, con.iCrossbowman, 2)
