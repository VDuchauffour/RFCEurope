...
class MapFinderStatusScreen:
    ...
    def drawPanel(self, screen):
        ...
        screen.setLabel(
            "TitleLabel",
            self.MAIN_PANEL_ID,
            BugUtil.getPlainText("TXT_KEY_MAPFINDER_SCREEN_TITLE"),
            CvUtil.FONT_CENTER_JUSTIFY,
            self.MAIN_PANEL_X + self.MAIN_PANEL_W / 2,
            y,
            z,
        ...
        screen.setLabel(
            "StopMsgLabel",
            self.MAIN_PANEL_ID,
            BugUtil.getPlainText("TXT_KEY_MAPFINDER_STOP_SHORTCUT"),
            CvUtil.FONT_CENTER_JUSTIFY,
            self.MAIN_PANEL_X + self.MAIN_PANEL_W / 2,
            y,
            z,
    ...
    def drawCounts(self, screen):
        ...
        screen.setLabel(
            "RegenCountLabel",
            self.MAIN_PANEL_ID,
            unicode(str(MapFinder.iRegenCount)),
        ...
        screen.setLabel(
            "SaveCountLabel",
            self.MAIN_PANEL_ID,
            unicode(str(MapFinder.iSavedCount)),
            CvUtil.FONT_RIGHT_JUSTIFY,
            x,
            y,
            z,
