...
lForbiddenUnits = ("UNIT_LION",
          ...
          "UNIT_SCOUT",
          "UNIT_ARABIA_GHAZI",
          "UNIT_AUSTRIAN_KURASSIER",
          "UNIT_BULGARIAN_KONNIK",
          "UNIT_BURGUNDIAN_PALADIN",
          "UNIT_BYZANTINE_CATAPHRACT",
          "UNIT_CORDOBAN_BERBER",
          "UNIT_NETHERLANDS_GRENADIER",
          "UNIT_ENGLISH_LONGBOWMAN",
          "UNIT_FRENCH_MUSKETEER",
          "UNIT_GENOA_BALESTRIERI",
          "UNIT_HOLY_ROMAN_LANDSKNECHT",
          "UNIT_HUNGARIAN_LANCER",
          "UNIT_KIEV_DRUZHINA",
          "UNIT_MOSCOW_BOYAR",
          "UNIT_VIKING_BESERKER",
          "UNIT_POLISH_WINGED_HUSSAR",
          "UNIT_PORTUGAL_FOOT_KNIGHT",
          "UNIT_SPANISH_TERCIO",
          "UNIT_SWEDISH_KAROLIN",
          "UNIT_TURKEY_GREAT_BOMBARD",
          "UNIT_VENICE_GALLEAS",
          "UNIT_LITHUANIAN_BAJORAS",
          "UNIT_MONGOL_KESHIK",
          "UNIT_SELJUK",
          "UNIT_TAGMATA",
          "UNIT_WELSH_LONGBOWMAN",
          "UNIT_HIGHLANDER",
          "UNIT_CORSAIR",
          "UNIT_KNIGHT_OF_ST_JOHNS",
          "UNIT_TEMPLAR",
          "UNIT_TEUTONIC",
          "UNIT_CATAPULT",
          "UNIT_TREBUCHET",
	...
	def getAtWarCivilizations(self, iPlayer):
		...
		for pyPlayer in playerList:
			...
			if(playerTeam.isAtWar(cyPlayer.getTeam())):
                                ...
                                if ((cyPlayer.getID() < con.iNumPlayers and gc.getTeam(gc.getPlayer(iPlayer).getTeam()).canContact(cyPlayer.getID())) or (cyPlayer.getID() >= con.iNumPlayers)):
                                        enemyPlayersList.append(cyPlayer)
                                #Rhye - end
...
class Mercenary:
	...
	def getHireCostXPlayer(self, iPlayer):
		...
		iResult = int(self.iHireCost*g_dHireCostModifier) + g_dBaseHireCost #Rhye
                #3MiroUP: Mercenaries
                if ( gc.hasUP(iPlayer,con.iUP_Mercenaries) ):
                	return iResult/2
                else:
                	return iResult
        #Rhye - end Carthaginian UP
