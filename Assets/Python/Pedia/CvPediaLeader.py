...
class CvPediaLeader:
    ...
    def __init__(self, main):
        ...
        self.X_LEADERHEAD = self.X_LEADERHEAD_PANE + (
            (self.W_LEADERHEAD_PANE - self.W_LEADERHEAD) / 2
        )
        self.Y_LEADERHEAD = (
            self.Y_LEADERHEAD_PANE + ((self.H_LEADERHEAD_PANE - self.H_LEADERHEAD) / 2) + 3
        )
    ...
    def interfaceScreen(self, iLeader):
        ...
        # Header...
        szHeader = (
            u"<font=4b>" + gc.getLeaderHeadInfo(self.iLeader).getDescription().upper() + u"</font>"
        )
        ...
        screen.setText(
            ...
            CivilopediaPageTypes.CIVILOPEDIA_PAGE_LEADER,
            -1,
        )
        ...
        screen.addPanel(
            ...
            True,
            True,
            self.X_LEADERHEAD_PANE,
            self.Y_LEADERHEAD_PANE,
            self.W_LEADERHEAD_PANE,
            self.H_LEADERHEAD_PANE,
    ...
    def placeCivic(self):
        ...
        if -1 != iCivic:
            ...
            screen.appendListBoxString(
                listName, szCivicText, WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY
            )
    ...
    def handleInput(self, inputClass):
        if inputClass.getData() == int(InputTypes.KB_RETURN) or inputClass.getData() == int(
