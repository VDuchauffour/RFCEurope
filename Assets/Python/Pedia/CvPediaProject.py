...
class CvPediaProject:
    ...
    def interfaceScreen(self, iProject):
        ...
        # Header...
        szHeader = (
            u"<font=4b>" + gc.getProjectInfo(self.iProject).getDescription().upper() + u"</font>"
        )
        ...
        screen.setText(
            ...
            CivilopediaPageTypes.CIVILOPEDIA_PAGE_PROJECT,
            -1,
        )
        ...
        screen.addDDSGFC(
            self.top.getNextWidgetName(),
            gc.getProjectInfo(self.iProject).getButton(),
