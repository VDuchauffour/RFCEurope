...
class CvPediaPromotion:
    ...
    def interfaceScreen(self, iPromotion):
        ...
        szHeader = (
            u"<font=4b>"
            + gc.getPromotionInfo(self.iPromotion).getDescription().upper()
            + u"</font>"
        )
        ...
        screen.setText(
            ...
            CivilopediaPageTypes.CIVILOPEDIA_PAGE_PROMOTION,
            -1,
        )
        ...
        screen.addDDSGFC(
            self.top.getNextWidgetName(),
            gc.getPromotionInfo(self.iPromotion).getButton(),
    ...
    def placeLeadsTo(self):
        ...
        screen.addPanel(
            ...
            False,
            True,
            self.X_LEADS_TO_PANE,
            self.Y_LEADS_TO_PANE,
            self.W_LEADS_TO_PANE,
            self.H_LEADS_TO_PANE,
            PanelStyles.PANEL_STYLE_BLUE50,
        )
    ...
    def placePrereqs(self):
        ...
        if ePromo > -1:
            screen.attachImageButton(
                panelName,
                "",
                gc.getPromotionInfo(ePromo).getButton(),
                GenericButtonSizes.BUTTON_SIZE_CUSTOM,
                WidgetTypes.WIDGET_PEDIA_JUMP_TO_PROMOTION,
                ePromo,
                1,
    ...
    def placeUnitGroups(self):
        ...
        screen.addPanel(
            ...
            True,
            True,
            self.X_UNIT_GROUP_PANE,
            self.Y_UNIT_GROUP_PANE,
            self.W_UNIT_GROUP_PANE,
            self.H_UNIT_GROUP_PANE,
            PanelStyles.PANEL_STYLE_BLUE50,
        )
        ...
        screen.addTableControlGFC(
            szTable,
            1,
            self.X_UNIT_GROUP_PANE + 10,
            self.Y_UNIT_GROUP_PANE + 40,
            self.W_UNIT_GROUP_PANE - 20,
            self.H_UNIT_GROUP_PANE - 50,
            False,
            False,
            24,
            24,
        ...
        for iI in range(gc.getNumUnitCombatInfos()):
            if 0 != gc.getPromotionInfo(self.iPromotion).getUnitCombat(iI):
                ...
                screen.setTableText(
                    ...
                    0,
                    i,
                    u"<font=4>" + gc.getUnitCombatInfo(iI).getDescription() + u"</font>",
                    gc.getUnitCombatInfo(iI).getButton(),
