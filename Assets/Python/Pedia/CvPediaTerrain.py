...
class CvPediaTerrain:
    ...
    def interfaceScreen(self, iTerrain):
        ...
        # Header...
        szHeader = (
            u"<font=4b>" + gc.getTerrainInfo(self.iTerrain).getDescription().upper() + u"</font>"
        )
        ...
        screen.setText(
            ...
            CivilopediaPageTypes.CIVILOPEDIA_PAGE_TERRAIN,
            -1,
        )
        ...
        screen.addDDSGFC(
            self.top.getNextWidgetName(),
            gc.getTerrainInfo(self.iTerrain).getButton(),
