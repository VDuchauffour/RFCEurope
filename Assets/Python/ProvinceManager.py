...
tCordobaPot2Core = [xml.iP_Andalusia,xml.iP_Valencia,xml.iP_LaMancha,xml.iP_Tetouan,xml.iP_Morocco]
tCordobaPot2Norm = []
tCordobaDesire = []
...
tKievCore = []
tKievNorm = []
tKievOuter = [xml.iP_Minsk,xml.iP_Kuban,xml.iP_Donets,xml.iP_Simbirsk,xml.iP_Chernigov]
