...
tHungaryPot2Norm = [xml.iP_Dalmatia,xml.iP_Moravia,xml.iP_Austria,xml.iP_Bosnia,xml.iP_Banat]
tHungaryDesire = []
...
tAustriaCore = []
tAustriaNorm = []
tAustriaOuter = [xml.iP_Verona,xml.iP_UpperHungary,xml.iP_Hungary,xml.iP_Transylvania,xml.iP_Slavonia,xml.iP_Dalmatia,xml.iP_Silesia,xml.iP_LesserPoland,xml.iP_GaliciaPoland]
