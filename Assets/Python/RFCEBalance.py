...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiers(iBurgundy,  150, 100, 100, 165 )
		gc.setProductionModifiers(iByzantium, 400, 200, 200, 495 )
		gc.setProductionModifiers(iFrankia,   150, 100, 100, 250 )
		gc.setProductionModifiers(iArabia,    150, 100, 100, 330 )
		gc.setProductionModifiers(iBulgaria,  150, 100, 100, 285 )
		gc.setProductionModifiers(iCordoba,   200, 200, 100, 330)
		gc.setProductionModifiers(iSpain,     100, 100, 100, 180 )
		gc.setProductionModifiers(iNorse,     150, 100, 100, 225 )
		gc.setProductionModifiers(iVenecia,   150, 100, 100, 225 )
		gc.setProductionModifiers(iKiev,      150, 100, 100, 225 )
		gc.setProductionModifiers(iHungary,   150, 100, 100, 225 )
		gc.setProductionModifiers(iGermany,   150, 100, 100, 180 )
		gc.setProductionModifiers(iPoland,    150, 150, 120, 220 )
		gc.setProductionModifiers(iMoscow,     70,  70, 100, 120 )
		gc.setProductionModifiers(iGenoa,     150, 100, 100, 120 )
		gc.setProductionModifiers(iEngland,   150, 100, 100, 150 )
		gc.setProductionModifiers(iPortugal,  135, 100, 100, 150 )
		gc.setProductionModifiers(iAustria,   110,  90, 100, 150 )
		gc.setProductionModifiers(iTurkey,     70,  70, 100, 110 )
		gc.setProductionModifiers(iSweden,     75,  60, 100,  90 )
		gc.setProductionModifiers(iDutch,      75,  50, 100,  75 )
		gc.setProductionModifiers(iPope,      300, 200, 100, 360 )
		gc.setProductionModifiers(iIndependent, 150, 100, 500, 675 )
		gc.setProductionModifiers(iIndependent2, 150, 100, 500, 675 )
		gc.setProductionModifiers(iIndependent3, 150, 100, 500, 675 )
		gc.setProductionModifiers(iIndependent4, 150, 100, 500, 675 )
		gc.setProductionModifiers(iBarbarian, 150, 100, 1000, 750 )
