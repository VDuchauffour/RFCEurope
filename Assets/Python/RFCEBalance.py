...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiers(iBurgundy,  150, 100, 100, 150 )
		gc.setProductionModifiers(iByzantium, 400, 200, 200, 275 )
		gc.setProductionModifiers(iFrankia,   150, 100, 100, 175 )
		gc.setProductionModifiers(iArabia,    150, 100, 100, 225 )
		gc.setProductionModifiers(iBulgaria,  150, 100, 100, 175 )
		gc.setProductionModifiers(iCordoba,   200, 200, 100, 250)
		gc.setProductionModifiers(iSpain,     100, 100, 100, 140 )
		gc.setProductionModifiers(iNorse,     150, 100, 100, 160 )
		gc.setProductionModifiers(iVenecia,   150, 100, 100, 160 )
		gc.setProductionModifiers(iKiev,      150, 100, 100, 140 )
		gc.setProductionModifiers(iHungary,   150, 100, 100, 140 )
		gc.setProductionModifiers(iGermany,   150, 100, 100, 130 )
		gc.setProductionModifiers(iPoland,    150, 150, 120, 170 )
		...
		gc.setProductionModifiers(iTurkey,     70,  70, 100,  90 )
