...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setSupportModifiersAI(iFrankia,       10, 100,  70,  25, 100 )
		gc.setSupportModifiersHu(iFrankia,       10, 100,  70,  25, 100 )
		gc.setSupportModifiersAI(iArabia,        30, 150,  70,  15, 120 )
		gc.setSupportModifiersHu(iArabia,        30, 150,  70,  15, 120 )
		gc.setSupportModifiersAI(iBulgaria,      40, 150,  70,  25, 110 )
		gc.setSupportModifiersHu(iBulgaria,      40, 150,  70,  25, 110 )
		...
		gc.setSupportModifiersAI(iHungary,       10, 100,  70,  25, 100 )
		gc.setSupportModifiersHu(iHungary,       10, 100,  70,  25, 100 )
