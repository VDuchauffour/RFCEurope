...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiersHu(iSpain,     100, 100, 100, 120 )
		...
		gc.setProductionModifiersAI(iGermany,   100, 100, 100, 100 )
		gc.setProductionModifiersHu(iGermany,   100, 100, 100, 100 )
		...
		gc.setProductionModifiersAI(iEngland,   100, 100, 100, 100 )
		...
		gc.setSupportModifiersHu(iPortugal,      10, 100,  50,  25, 100 )
                gc.setSupportModifiersAI(iLithuania,     10, 100,  75,  40, 100 )
		gc.setSupportModifiersHu(iLithuania,     10, 100,  75,  40, 100 )
		...
		gc.setDiplomacyModifiers( iPoland, iAustria, -2 )
                gc.setDiplomacyModifiers( iLithuania, iPoland, 3 )
		gc.setDiplomacyModifiers( iPoland, iLithuania, 3 )
