...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiersAI(iArabia,    125, 125, 150, 220 )
		gc.setProductionModifiersHu(iArabia,    125, 125, 150, 220 )
		gc.setProductionModifiersAI(iBulgaria,  125, 100, 125, 170 )
		gc.setProductionModifiersHu(iBulgaria,  125, 100, 125, 170 )
		gc.setProductionModifiersAI(iCordoba,   125, 150, 125, 220 )
		gc.setProductionModifiersHu(iCordoba,   125, 150, 125, 220 )
		...
		gc.setSupportModifiersAI(iArabia,        10, 150,  70,  15, 120 )
		gc.setSupportModifiersHu(iArabia,        10, 150,  70,  15, 120 )
		gc.setSupportModifiersAI(iBulgaria,      10, 150,  70,  25, 110 )
		gc.setSupportModifiersHu(iBulgaria,      10, 150,  70,  25, 110 )
