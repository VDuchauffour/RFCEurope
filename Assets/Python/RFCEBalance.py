...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiersAI(iBulgaria,  150, 100, 125, 200 )
		gc.setProductionModifiersHu(iBulgaria,  125, 100, 125, 170 )
		...
		gc.setProductionModifiersHu(iAustria,    50,  75, 100,  70 )
		gc.setProductionModifiersAI(iTurkey,     50,  75, 100,  90 )
		gc.setProductionModifiersHu(iTurkey,     50,  75, 100,  90 )
		...
		gc.setSupportModifiersAI(iBulgaria,      40, 150,  70,  45, 110 )
		gc.setSupportModifiersHu(iBulgaria,      40, 150,  70,  35, 110 )
		...
		gc.setSupportModifiersAI(iHungary,       40, 100,  80,  45, 100 )
		gc.setSupportModifiersHu(iHungary,       40, 100,  80,  45, 100 )
