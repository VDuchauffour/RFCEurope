...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setGrowthModifiers(iPortugal,     100,  90, 100, 100, 100, 3 )
		gc.setGrowthModifiers(iAustria,      100,  80, 100, 100, 100, 3 )
		gc.setGrowthModifiers(iTurkey,       100,  70, 100, 100, 100, 3 )
		gc.setGrowthModifiers(iSweden,       100,  60, 100, 100, 100, 4 )
		...
		gc.setProductionModifiers(iPoland, 150, 150, 120, 280 )
		...
		gc.setSupportModifiers(iPoland,        10, 150,  75,  40, 100 )
