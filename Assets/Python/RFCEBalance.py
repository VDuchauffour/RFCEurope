...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiers(iArabia,    100, 100, 100, 150 )
		gc.setProductionModifiers(iBulgaria,  125, 100, 100, 125 )
		gc.setProductionModifiers(iCordoba,   125, 150, 100, 150 )
