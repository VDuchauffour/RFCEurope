...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiers(iCordoba,   200, 200, 100, 150 )
		gc.setProductionModifiers(iSpain,     100, 100, 100, 120 )
		gc.setProductionModifiers(iNorse,     150, 100, 100, 120 )
		gc.setProductionModifiers(iVenecia,   150, 100, 100, 120 )
		gc.setProductionModifiers(iKiev,      150, 100, 100, 120 )
		gc.setProductionModifiers(iHungary,   150, 100, 100, 120 )
		gc.setProductionModifiers(iGermany,   150, 100, 100, 120 )
