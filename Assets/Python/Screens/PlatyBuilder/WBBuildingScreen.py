...
class WBBuildingScreen:
    ...
    def interfaceScreen(self, pCityX):
        ...
        screen.setLabel(
            ...
            screen.getXResolution() * 5 / 8 - 10,
            screen.getYResolution() / 2,
            -0.1,
        ...
        screen.setLabel(
            "WonderHeader",
            "Background",
            u"<font=4b>" + CyTranslator().getText("TXT_KEY_CONCEPT_WONDERS", ()) + "</font>",
            CvUtil.FONT_CENTER_JUSTIFY,
            screen.getXResolution() * 5 / 8 - 10,
            20,
            -0.1,
        ...
        sText = (
            ...
            + "<font=3b>"
            + CyTranslator().getText("TXT_KEY_WB_GRANT_AVAILABLE", ())
            + "</color></font>"
        )
        screen.setText(
            "BuildingAvailable",
        ...
        sText = (
            ...
            + CyTranslator().getText(
                "TXT_KEY_WB_COPY_ALL", (CyTranslator().getText("TXT_KEY_CONCEPT_CITIES", ()),)
            )
            + "</font>"
        )
    ...
    def sortBuildings(self):
        ...
        for i in xrange(gc.getNumBuildingInfos()):  # type: ignore
            ...
            if CvPlatyBuilderScreen.bHideInactive:
                if (
                    gc.getCivilizationInfo(pCity.getCivilizationType()).getCivilizationBuildings(
                        iClass
                    )
                    != i
                ):
