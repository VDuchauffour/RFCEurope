...
class WBProjectScreen:
    ...
    def interfaceScreen(self, iTeamX):
        ...
        screen.setLabel(
            "ProjectHeader",
            "Background",
            "<font=4b>" + CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_PROJECT", ()) + "</font>",
        ...
        screen.addPullDownString(
            "ProjectType",
            CyTranslator().getText("TXT_KEY_PEDIA_TEAM_PROJECT", ()),
            1,
            1,
            iProjectType == 1,
        )
        screen.addPullDownString(
            "ProjectType",
            CyTranslator().getText("TXT_KEY_PEDIA_WORLD_PROJECT", ()),
            2,
            2,
            iProjectType == 2,
        )
        ...
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_PROJECT", ()), 2, 2, True
        )
        screen.addPullDownString(
        ...
        sText = (
            "<font=3b>"
            + CyTranslator().getText("TXT_KEY_GAME_OPTION_NO_BARBARIANS", ())
            + "</font>"
        )
        ...
        sText = (
            ...
            + CyTranslator().getText(
                "TXT_KEY_WB_COPY_ALL", (CyTranslator().getText("TXT_KEY_MAIN_MENU_PLAYERS", ()),)
            )
            + "</font>"
        )
        sColor = CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
