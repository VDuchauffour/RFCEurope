...
class WBTeamScreen:
    ...
    def interfaceScreen(self, iTeamX):
        ...
        sText = (
            "<font=4b>"
            + CyTranslator().getText("TXT_KEY_WB_TEAM_DATA", ()).upper()
            + " (ID: "
            + str(iTeam)
            + ")</font>"
        )
        ...
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_TEAM_DATA", ()), 1, 1, True
        )
        screen.addPullDownString(
            "CurrentPage",
        ...
        for i in xrange(gc.getMAX_TEAMS()):  # type: ignore
            if gc.getTeam(i).isAlive():
                ...
                if gc.getTeam(i).getNumMembers() > 1:
                    sName += (
                        " ("
                        + str(gc.getTeam(i).getNumMembers())
                        + " "
                        + CyTranslator().getText("TXT_KEY_MEMBERS_TITLE", ())
                        + ")"
                    )
        ...
        for i in xrange(gc.getNumVoteSourceInfos()):  # type: ignore
            ...
            if iVoteBuilding == -1:
                continue
            lVoteBuildings.append(
                [gc.getBuildingInfo(iVoteBuilding).getDescription(), iVoteBuilding]
            )
        lVoteBuildings.sort()
    ...
    def placeStats(self):
        ...
        sText = (
            ...
            + CyTranslator().getText(
                "TXT_KEY_WB_NUKE_INTERCEPTION", (pTeam.getNukeInterception(),)
            )
            + "</font>"
        )
        screen.setLabel(
            "NukeInterceptionText",
            "Background",
            sText,
        ...
        sText = (
            "<font=3>"
            + CyTranslator().getText(
                "TXT_KEY_WB_ENEMY_WAR_WEARINESS", (pTeam.getEnemyWarWearinessModifier(),)
            )
            + "</font>"
        )
        screen.setLabel(
        ...
        sText = (
            ...
            + CyTranslator().getText("TXT_KEY_MISC_MASTER", ())
            + ": "
            + str(pTeam.getMasterPower())
            + "</font>"
        )
        screen.setLabel(
            "MasterPowerText",
        ...
        sText = (
            "<font=3>"
            + CyTranslator().getText("[ICON_STRENGTH]", ())
            + CyTranslator().getText("TXT_KEY_MISC_VASSAL_SHORT", ())
            + ": "
            + str(pTeam.getVassalPower())
            + "</font>"
        )
        screen.setLabel(
            "VassalPowerText",
        ...
        sText = (
            "<font=3>"
            + CyTranslator().getText("[ICON_ESPIONAGE]", ())
            + CyTranslator().getText("TXT_KEY_WB_EVER", ())
            + ": "
            + str(pTeam.getEspionagePointsEver())
            + "</font>"
        )
        screen.setLabel(
            "EspionageEverText",
    ...
    def placeVotes(self):
        ...
        screen.setLabel(
            ...
            "Background",
            "<font=3b>"
            + CyTranslator().getText("TXT_KEY_WB_GUARANTEED_ELIGIBILITY", ())
            + "</font>",
            CvUtil.FONT_CENTER_JUSTIFY,
            iX + iWidth / 2,
            iY,
        ...
        for item in lRoutes:
            ...
            if iChange != 0:
                sText = u"%+d%s %s" % (
                    ...
                    CyTranslator().getText("TXT_KEY_ESPIONAGE_SCREEN_COST", ()),
                )
                screen.setTableInt(
                    "WBTeamRoutes",
                    1,
    ...
    def placeDomains(self):
        ...
        screen.addTableControlGFC(
            ...
            iY,
            iWidth,
            DomainTypes.NUM_DOMAIN_TYPES * 24 + 2,
            False,
            False,
            24,
            24,
        ...
        for i in xrange(DomainTypes.NUM_DOMAIN_TYPES):  # type: ignore
            ...
            screen.setTableText(
                ...
                0,
                i,
                "<font=3>" + Info.getDescription() + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                1030,
                i,
    ...
    def placeMembers(self):
        ...
        screen.setLabel(
            "MemberHeader",
            "Background",
            "<font=3b>" + CyTranslator().getText("TXT_KEY_MEMBERS_TITLE", ()) + "</font>",
            CvUtil.FONT_CENTER_JUSTIFY,
            iX + iWidth / 2,
            self.iTable_Y - 30,
            -0.1,
        ...
        for iPlayerX in xrange(gc.getMAX_PLAYERS()):  # type: ignore
            ...
            sColor = u"<color=%d,%d,%d,%d>" % (
                pPlayerX.getPlayerTextColorR(),
                pPlayerX.getPlayerTextColorG(),
                pPlayerX.getPlayerTextColorB(),
                pPlayerX.getPlayerTextColorA(),
            )
            sText = "<font=3>" + sColor + sText + "</font></color>"
            sCiv = (
                "<font=3>"
                + sColor
                + pPlayerX.getCivilizationShortDescription(0)
                + "</font></color>"
            )
            lMembers.append(
                [
                    ...
                    sText,
                    iPlayerX,
                    pPlayerX.getCivilizationType(),
                    pPlayerX.getLeaderType(),
                    sCiv,
                ]
            )
        lMembers.sort()
        for item in lMembers:
            ...
            screen.setTableText(
                ...
                iRow,
                item[5],
                gc.getCivilizationInfo(item[3]).getButton(),
                WidgetTypes.WIDGET_PYTHON,
                7872,
                item[2] * 10000 + item[3],
                CvUtil.FONT_LEFT_JUSTIFY,
            ...
            screen.setTableText(
                ...
                iRow,
                item[1],
                gc.getLeaderHeadInfo(item[4]).getButton(),
                WidgetTypes.WIDGET_PYTHON,
                7876,
                item[2] * 10000 + item[4],
                CvUtil.FONT_LEFT_JUSTIFY,
    ...
    def placeAbilities(self):
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_MAPCENTER").getPath(),
            lAbilities[0][0],
            lAbilities[0][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_MAPTRADING").getPath(),
            lAbilities[1][0],
            lAbilities[1][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_TECHTRADING").getPath(),
            lAbilities[2][0],
            lAbilities[2][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_GOLDTRADING").getPath(),
            lAbilities[3][0],
            lAbilities[3][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_OPENBORDERS").getPath(),
            lAbilities[4][0],
            lAbilities[4][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_DEFENSIVEPACT").getPath(),
            lAbilities[5][0],
            lAbilities[5][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_PERMALLIANCE").getPath(),
            lAbilities[6][0],
            lAbilities[6][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_VASSAL").getPath(),
            lAbilities[7][0],
            lAbilities[7][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_BRIDGEBUILDING").getPath(),
            lAbilities[8][0],
            lAbilities[8][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_IRRIGATION").getPath(),
            lAbilities[9][0],
            lAbilities[9][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_NOIRRIGATION").getPath(),
            lAbilities[10][0],
            lAbilities[10][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
        ...
        screen.setTableText(
            ...
            + "</font></color>",
            CyArtFileMgr().getInterfaceArtInfo("INTERFACE_TECH_WATERWORK").getPath(),
            lAbilities[11][0],
            lAbilities[11][1],
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getFunctionName() == "ChangeBy":
            ...
            pTeam.addTeam(
                screen.getPullDownData("MergeTeam", screen.getSelectedPullDownID("MergeTeam"))
            )
    ...
    def doTeamAbilities(self, i, iType):
        if i == 0:
            ...
            if pTeam.isPermanentAllianceTrading():
                if iType != 1:
                    pTeam.changePermanentAllianceTradingCount(
                        -pTeam.getPermanentAllianceTradingCount()
                    )
            elif iType != 0:
