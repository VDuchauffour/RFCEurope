			...
			if (iStateReligion == 3):
			        iTemple = con.iOrthodoxTemple
                        if (not city.hasBuilding(iTemple)):
                                ...
                                pFaithful.changeFaith( 1 )
                        #if (not city.hasBuilding(con.iCatholicCathedral + iStateReligion*4)):
                        #        city.setHasRealBuilding((con.iCatholicCathedral + iStateReligion*4), True)
...
#------------------AZTEC U.P.-------------------
        ...
        def aztecUP(self, argsList): #Real Slavery by Sevo
                ...
                if (pLosingUnit.getUnitType() < con.iSpearman):
                        return
