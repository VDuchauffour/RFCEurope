...
lMercList = [
    [Unit.AXEMAN.value, "TXT_KEY_MERC_SERBIAN", 60, 108, xml.lRegionBalkans, [], 20],
    [Unit.ARCHER.value, "TXT_KEY_MERC_SERBIAN", 60, 108, xml.lRegionBalkans, [], 20],
    [
        Unit.HORSE_ARCHER.value,
        "TXT_KEY_MERC_KHAZAR",
        25,
        90,
        xml.lRegionBalkans + [xml.iP_Constantinople],
        [],
        20,
    ],
    [
    ...
    [
        ...
        25,
        75,
        xml.lRegionBalkans + xml.lRegionAustria + xml.lRegionHungary + [xml.iP_Constantinople],
        [],
        20,
    ],
    [
    ...
    [Unit.MOUNTED_INFANTRY.value, "TXT_KEY_MERC_GENERIC", 50, 80, xml.lRegionFrance, [], 20],
    [Unit.MOUNTED_INFANTRY.value, "TXT_KEY_MERC_GENERIC", 50, 80, xml.lRegionGermany, [], 20],
    [Unit.MOUNTED_INFANTRY.value, "TXT_KEY_MERC_GENERIC", 50, 80, xml.lRegionIberia, [], 20],
    [Unit.ARCHER.value, "TXT_KEY_MERC_GENERIC", 50, 80, xml.lRegionFrance, [], 20],
    [Unit.ARCHER.value, "TXT_KEY_MERC_GENERIC", 50, 80, xml.lRegionGermany, [], 20],
    [Unit.ARCHER.value, "TXT_KEY_MERC_GENERIC", 50, 80, xml.lRegionIberia, [], 20],
    [Unit.CROSSBOWMAN.value, "TXT_KEY_MERC_GENERIC", 100, 200, xml.lRegionFrance, [], 20],
    [Unit.CROSSBOWMAN.value, "TXT_KEY_MERC_GENERIC", 100, 200, xml.lRegionGermany, [], 20],
    [Unit.CROSSBOWMAN.value, "TXT_KEY_MERC_GENERIC", 100, 200, xml.lRegionIberia, [], 20],
    [Unit.CROSSBOWMAN.value, "TXT_KEY_MERC_GENERIC", 100, 200, xml.lRegionBritain, [], 20],
    [Unit.CROSSBOWMAN.value, "TXT_KEY_MERC_GENERIC", 100, 200, xml.lRegionPoland, [], 20],
    [Unit.CROSSBOWMAN.value, "TXT_KEY_MERC_GENERIC", 100, 200, xml.lRegionHungary, [], 20],
    [Unit.CROSSBOWMAN.value, "TXT_KEY_MERC_GENERIC", 100, 200, xml.lRegionMiddleEast, [], 20],
    [Unit.LONGBOWMAN.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionFrance, [], 20],
    [Unit.LONGBOWMAN.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionGermany, [], 20],
    [Unit.LONGBOWMAN.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionIberia, [], 20],
    [Unit.LONGBOWMAN.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionBritain, [], 20],
    [Unit.LONGBOWMAN.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionBalkans, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionFrance, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionGermany, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionIberia, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionBritain, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionPoland, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionHungary, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionBalkans, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionKiev, [], 20],
    [Unit.SPEARMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionMiddleEast, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionFrance, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionGermany, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionIberia, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionBritain, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionPoland, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionHungary, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionBalkans, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionKiev, [], 20],
    [Unit.SWORDSMAN.value, "TXT_KEY_MERC_GENERIC", 50, 150, xml.lRegionMiddleEast, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionFrance, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionGermany, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionIberia, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionBritain, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionPoland, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionHungary, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionBalkans, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionKiev, [], 20],
    [Unit.KNIGHT.value, "TXT_KEY_MERC_GENERIC", 200, 300, xml.lRegionMiddleEast, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionFrance, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionGermany, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionIberia, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionBritain, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionPoland, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionHungary, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionBalkans, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionKiev, [], 20],
    [Unit.MUSKETMAN.value, "TXT_KEY_MERC_GENERIC", 300, 400, xml.lRegionMiddleEast, [], 20],
    [
        Unit.TEMPLAR.value,
    ...
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 217, 233, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 233, 249, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 249, 265, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 265, 281, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 281, 296, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 296, 311, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 311, 327, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 327, 343, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 343, 359, xml.lRegionItaly, [], 10],
    [Unit.CONDOTTIERI.value, "TXT_KEY_MERC_ITALIAN", 359, 375, xml.lRegionItaly, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 233, 243, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 243, 253, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 253, 263, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 263, 273, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 273, 283, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 283, 293, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 293, 303, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 303, 313, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 238, 248, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 248, 258, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 258, 268, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 268, 278, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 278, 288, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 288, 298, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_PIKEMAN.value, "TXT_KEY_MERC_SWISS", 298, 308, xml.lRegionSwiss, [], 10],
    [
    ...
    [
        ...
        120,
        140,
        [xml.iP_Denmark, xml.iP_Skaneland],
        [],
        10,
    ],
    [
    ...
    [Unit.DENMARK_HUSKARL.value, "TXT_KEY_MERC_DANISH", 160, 170, xml.lRegionScandinavia, [], 10],
    [Unit.DENMARK_HUSKARL.value, "TXT_KEY_MERC_DANISH", 170, 180, xml.lRegionScandinavia, [], 10],
    [Unit.DENMARK_HUSKARL.value, "TXT_KEY_MERC_DANISH", 180, 190, xml.lRegionScandinavia, [], 10],
    [Unit.DENMARK_HUSKARL.value, "TXT_KEY_MERC_DANISH", 190, 200, xml.lRegionScandinavia, [], 10],
    [
        Unit.ARAGON_ALMOGAVAR.value,
        "TXT_KEY_MERC_ARAGON",
        188,
        198,
        [xml.iP_Catalonia, xml.iP_Aragon],
        [],
        10,
    ],
    [
    ...
    [
        ...
        218,
        228,
        [xml.iP_Catalonia, xml.iP_Aragon, xml.iP_Valencia],
        [],
        15,
    ],
    [
    ...
    [
        ...
        234,
        246,
        [xml.iP_Thessaly, xml.iP_Thessaloniki],
        [],
        10,
    ],
    [
    ...
    [
        ...
        375,
        385,
        [xml.iP_Morocco, xml.iP_Oran, xml.iP_Tetouan, xml.iP_Marrakesh, xml.iP_Fez],
        [],
        10,
    ],
    [
    ...
    [
        ...
        359,
        375,
        [xml.iP_Osterland, xml.iP_Norrland, xml.iP_Karelia],
        [],
        10,
    ],
    [
    ...
    [
        ...
        300,
        320,
        [xml.iP_Zaporizhia, xml.iP_Kiev, xml.iP_Sloboda],
        [],
        5,
    ],
    [
    ...
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 350, 370, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 370, 390, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 390, 410, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 410, 425, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 425, 440, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 440, 455, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 455, 470, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 470, 485, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DON_COSSACK.value, "TXT_KEY_MERC_DON", 485, 500, [xml.iP_Kuban, xml.iP_Donets], [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 300, 310, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 310, 320, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 320, 330, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 330, 340, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 340, 350, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 350, 360, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 360, 370, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 370, 380, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 380, 390, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 390, 400, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 335, 345, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 345, 355, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 355, 365, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 365, 375, xml.lRegionGermany, [], 10],
    [Unit.DOPPELSOLDNER.value, "TXT_KEY_MERC_GERMAN", 375, 385, xml.lRegionGermany, [], 10],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 390, 400, [xml.iP_Ireland], [], 10],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 400, 410, [xml.iP_Ireland], [], 10],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 410, 420, [xml.iP_Ireland], [], 10],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 420, 430, [xml.iP_Ireland], [], 10],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 430, 440, [xml.iP_Ireland], [], 10],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 440, 450, [xml.iP_Ireland], [], 15],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 450, 460, [xml.iP_Ireland], [], 15],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 460, 470, [xml.iP_Ireland], [], 15],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 470, 480, [xml.iP_Ireland], [], 15],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 480, 490, [xml.iP_Ireland], [], 15],
    [Unit.IRISH_BRIGADE.value, "TXT_KEY_MERC_IRISH", 490, 500, [xml.iP_Ireland], [], 15],
    [
        Unit.STRADIOT.value,
        "TXT_KEY_MERC_BALKAN",
        280,
        295,
        xml.lRegionBalkans + [xml.iP_Calabria, xml.iP_Apulia],
        [],
        10,
    ],
    [
    ...
    [
        ...
        340,
        355,
        [xml.iP_Netherlands, xml.iP_Flanders],
        [],
        10,
    ],
    [
    ...
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 375, 385, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 385, 395, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 395, 405, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 405, 415, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 415, 425, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 425, 435, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 435, 445, xml.lRegionSwiss, [], 15],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 430, 440, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 445, 455, xml.lRegionSwiss, [], 15],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 440, 450, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 455, 465, xml.lRegionSwiss, [], 15],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 450, 460, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 465, 475, xml.lRegionSwiss, [], 15],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 460, 470, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 475, 485, xml.lRegionSwiss, [], 15],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 470, 480, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 485, 495, xml.lRegionSwiss, [], 15],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 480, 490, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 485, 495, xml.lRegionSwiss, [], 15],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 490, 500, xml.lRegionSwiss, [], 10],
    [Unit.SWISS_GUN.value, "TXT_KEY_MERC_SWISS", 485, 500, xml.lRegionSwiss, [], 20],
    [
        Unit.LIPKA_TATAR.value,
        "TXT_KEY_MERC_BALTIC",
        240,
        255,
        xml.lRegionLithuania + [xml.iP_Polotsk, xml.iP_Suvalkija, xml.iP_Minsk],
        [],
        5,
    ],
    [
    ...
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 380, 390, [xml.iP_Scotland], [], 10],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 390, 400, [xml.iP_Scotland], [], 10],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 400, 410, [xml.iP_Scotland], [], 10],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 410, 420, [xml.iP_Scotland], [], 10],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 420, 430, [xml.iP_Scotland], [], 10],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 430, 440, [xml.iP_Scotland], [], 10],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 440, 450, [xml.iP_Scotland], [], 10],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 450, 460, [xml.iP_Scotland], [], 15],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 460, 470, [xml.iP_Scotland], [], 15],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 470, 480, [xml.iP_Scotland], [], 15],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 480, 490, [xml.iP_Scotland], [], 15],
    [Unit.HIGHLANDER_GUN.value, "TXT_KEY_MERC_SCOTTISH", 490, 500, [xml.iP_Scotland], [], 15],
    [
        Unit.ZANJI.value,
    ...
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 37, 48, [xml.iP_Egypt], [], 5],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 48, 58, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 58, 68, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 68, 78, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 78, 88, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 88, 98, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 98, 108, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 108, 118, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 118, 128, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 128, 139, [xml.iP_Egypt], [], 10],
    [Unit.NUBIAN_LONGBOWMAN.value, "TXT_KEY_MERC_NUBIAN", 139, 150, [xml.iP_Egypt], [], 5],
    [
        Unit.HIGHLANDER.value,
        "TXT_KEY_MERC_SCOTTISH",
        180,
        195,
        [xml.iP_Scotland, xml.iP_Northumbria, xml.iP_TheIsles],
        [],
        5,
    ],
    [
    ...
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 200, 220, [xml.iP_Wales], [], 5],
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 220, 240, [xml.iP_Wales], [], 10],
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 240, 260, [xml.iP_Wales], [], 10],
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 260, 280, [xml.iP_Wales], [], 10],
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 280, 300, [xml.iP_Wales], [], 10],
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 300, 320, [xml.iP_Wales], [], 10],
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 320, 340, [xml.iP_Wales], [], 10],
    [Unit.WELSH_LONGBOWMAN.value, "TXT_KEY_MERC_WELSH", 340, 350, [xml.iP_Wales], [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 80, 100, xml.lRegionAsiaMinor, [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 100, 120, xml.lRegionAsiaMinor, [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 120, 140, xml.lRegionAsiaMinor, [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 140, 160, xml.lRegionAsiaMinor, [], 10],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 160, 180, xml.lRegionAsiaMinor, [], 10],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 80, 100, [xml.iP_Constantinople], [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 100, 120, [xml.iP_Constantinople], [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 120, 140, [xml.iP_Constantinople], [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 140, 160, [xml.iP_Constantinople], [], 5],
    [Unit.TAGMATA.value, "TXT_KEY_MERC_GREEK", 160, 180, [xml.iP_Constantinople], [], 5],
    [
        Unit.CORSAIR.value,
    ...
    [Unit.MAMLUK_HEAVY_CAVALRY.value, "TXT_KEY_MERC_EGYPTIAN", 200, 220, [xml.iP_Egypt], [], 20],
    [Unit.MAMLUK_HEAVY_CAVALRY.value, "TXT_KEY_MERC_EGYPTIAN", 220, 240, [xml.iP_Egypt], [], 20],
    [Unit.MAMLUK_HEAVY_CAVALRY.value, "TXT_KEY_MERC_EGYPTIAN", 240, 260, [xml.iP_Egypt], [], 20],
    [Unit.MAMLUK_HEAVY_CAVALRY.value, "TXT_KEY_MERC_EGYPTIAN", 260, 280, [xml.iP_Egypt], [], 20],
    [Unit.MAMLUK_HEAVY_CAVALRY.value, "TXT_KEY_MERC_EGYPTIAN", 280, 300, [xml.iP_Egypt], [], 20],
    [
        Unit.SOUTH_SLAV_VLASTELA.value,
        "TXT_KEY_MERC_BALKAN",
        160,
        170,
        [xml.iP_Serbia, xml.iP_Bosnia, xml.iP_Banat, xml.iP_Slavonia, xml.iP_Dalmatia],
        [],
        10,
    ],
    [
    ...
    [
        ...
        188,
        198,
        [xml.iP_Lombardy, xml.iP_Verona, xml.iP_Tuscany, xml.iP_Liguria],
        [],
        10,
    ],
    [
    ...
    [Unit.CRIMEAN_TATAR_RIDER.value, "TXT_KEY_MERC_CRIMEAN", 250, 280, [xml.iP_Crimea], [], 10],
    [Unit.CRIMEAN_TATAR_RIDER.value, "TXT_KEY_MERC_CRIMEAN", 280, 310, [xml.iP_Crimea], [], 10],
    [Unit.CRIMEAN_TATAR_RIDER.value, "TXT_KEY_MERC_CRIMEAN", 310, 340, [xml.iP_Crimea], [], 10],
    [Unit.CRIMEAN_TATAR_RIDER.value, "TXT_KEY_MERC_CRIMEAN", 340, 370, [xml.iP_Crimea], [], 10],
    [Unit.CRIMEAN_TATAR_RIDER.value, "TXT_KEY_MERC_CRIMEAN", 370, 400, [xml.iP_Crimea], [], 10],
]
        ...
        if pHuman.getProvinceCityCount(iCurrentProvince) > 0:
            ...
            if iStateReligion in lMercList[iMerc][5]:
                ...
                CyInterface().addMessage(
                    ...
                    + " "
                    + szCurrentProvince
                    + CyTranslator().getText("TXT_KEY_MERC_NEW_MERC_RELIGION", ()),
                    "",
                    0,
                    "",
                    ColorTypes(MessageData.LIME),
                ...
                if not ProvMessage:
                    ...
                    CyInterface().addMessage(
                        ...
                        + " "
                        + szCurrentProvince
                        + CyTranslator().getText("TXT_KEY_MERC_NEW_MERC_CULTURE", ()),
                        "",
                        0,
                        "",
                        ColorTypes(MessageData.LIME),
