...
class BugFinanceAdvisor:
    ...
    def drawContents(self):
        ...
        screen.setLabel(
            ...
            self.Z_CONTROLS,
            FontTypes.TITLE_FONT,
            # WidgetTypes.WIDGET_HELP_STABILITY,
            WidgetTypes.WIDGET_GENERAL,
            # iStabilityLevel,
            -1,
            -1,
        ...
        screen.setLabel(
            ...
            self.Z_CONTROLS + self.DZ,
            FontTypes.GAME_FONT,
            # WidgetTypes.WIDGET_HELP_STABILITY_EXPANSION,
            WidgetTypes.WIDGET_GENERAL,
            self.iActiveLeader,
            -1,
        )
        screen.setLabel(
            ...
            CvUtil.FONT_CENTER_JUSTIFY,
            self.X_PARAMETERS1 + self.PARAMETERS_WIDTH / 2,
            self.Y_PARAMETERS + self.H_PARAMETERS / 2,
            self.Z_CONTROLS + self.DZ,
            FontTypes.GAME_FONT,
            # WidgetTypes.WIDGET_HELP_STABILITY_EXPANSION,
            WidgetTypes.WIDGET_GENERAL,
        ...
        screen.setLabel(
            ...
            self.Z_CONTROLS + self.DZ,
            FontTypes.GAME_FONT,
            # WidgetTypes.WIDGET_HELP_STABILITY_DOMESTIC,
            WidgetTypes.WIDGET_GENERAL,
            self.iActiveLeader,
            -1,
        )
        ...
        screen.setLabel(
            ...
            self.Z_CONTROLS + self.DZ,
            FontTypes.GAME_FONT,
            # WidgetTypes.WIDGET_HELP_STABILITY_FOREIGN,
            WidgetTypes.WIDGET_GENERAL,
            self.iActiveLeader,
            -1,
        )
        ...
        screen.setLabel(
            ...
            self.Z_CONTROLS + self.DZ,
            FontTypes.GAME_FONT,
            # WidgetTypes.WIDGET_HELP_STABILITY_MILITARY,
            WidgetTypes.WIDGET_GENERAL,
            self.iActiveLeader,
            -1,
        )
        ...
        screen.setLabel(
            ...
            "Background",
            u"<font=3>"
            + localText.getText("TXT_KEY_CONCEPT_WORKED_TILES", (iWorkedTileCount,))
            + "</font>",
