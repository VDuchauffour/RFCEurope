...
class CvCustomizableDomesticAdvisor:
    ...
    def __init__(self):
        ...
        self.COLUMNS_LIST = [
            ...
            (
                ...
                None,
                None,
                'localText.getText("TXT_KEY_DOMESTIC_ADVISOR_NAME", ()).upper()',
            ),
            (
                "ADVISE_CULTURE",
                150,
                ...
                self.advise,
                "Culture",
                'localText.getText("TXT_KEY_CONCEPT_CULTURE", ()).upper()',
            ),
            (
                "ADVISE_MILITARY",
                150,
                ...
                self.advise,
                "Military",
                'localText.getText("TXT_KEY_ADVISOR_MILITARY", ()).upper()',
            ),
            ...
            (
                ...
                self.advise,
                "Religion",
                'localText.getText("TXT_KEY_CONCEPT_RELIGION", ()).upper()',
            ),
            (
                "ADVISE_RESEARCH",
                150,
                ...
                self.advise,
                "Research",
                'localText.getText("TXT_KEY_COMMERCE_RESEARCH", ()).upper()',
            ),
            (
                "ADVISE_SPACESHIP",
                150,
                ...
                self.advise,
                "Spaceship",
                'localText.getText("TXT_KEY_CONCEPT_SPACESHIP", ()).upper()',
            ),
            ...
            (
                ...
                "int",
                None,
                CyCity.getBaseYieldRate,
                YieldTypes.YIELD_COMMERCE,
                None,
                None,
                'u"B" + self.commerceIcon',
            ),
            (
                "BASE_FOOD",
                38,
            ...
            (
                ...
                None,
                0,
                self.calculateConscriptAnger,
                None,
                'u"D" + self.unhappyIcon',
            ),
            (
                "CONSCRIPT_UNIT",
                90,
                ...
                None,
                0,
                self.calculateConscriptUnit,
                None,
                'localText.getText("TXT_KEY_CONCEPT_DRAFT", ()).upper()',
            ),
            (
                "COULD_CONSCRIPT_UNIT",
                90,
                "text",
                None,
                None,
                0,
                self.calculatePotentialConscriptUnit,
                None,
                'localText.getText("TXT_KEY_CONCEPT_DRAFT", ()).upper() + u"#"',
            ),
            (
                "CORPORATIONS",
                90,
                ...
                None,
                0,
                self.calculateCorporations,
                None,
                'localText.getText("TXT_KEY_CONCEPT_CORPORATIONS", ()).upper()',
            ),
            (
                "CULTURE",
                53,
            ...
            (
                ...
                "int",
                None,
                CyCity.getCommerceRate,
                CommerceTypes.COMMERCE_CULTURE,
                None,
                None,
                'self.cultureIcon + u"R"',
            ),
            (
                "CULTURE_TURNS",
                38,
                ...
                None,
                None,
                self.calculateCultureTurns,
                None,
                'self.cultureIcon + u"T"',
            ),
            ...
            (
                ...
                60,
                "int",
                CyCity.getEspionageDefenseModifier,
                None,
                0,
                self.calculateEspionageDefense,
                None,
                'self.espionageIcon + u"%"',
            ),
            (
                "FEATURES",
                106,
                ...
                None,
                'localText.getText("TXT_KEY_MISC_FEATURES", ())',
            ),
            ...
            (
                ...
                None,
                0,
                self.calculateFounded,
                None,
                'localText.getText("TXT_KEY_DOMESTIC_ADVISOR_FOUNDED", ()).upper()',
            ),
            (
                "FREE_EXPERIENCE_LAND",
                30,
                "int",
                None,
                None,
                0,
                self.calculateFreeExperience,
                "L",
                "self.landIcon",
            ),
            (
            ...
            (
                ...
                30,
                "int",
                CyCity.getMilitaryHappinessUnits,
                None,
                0,
                None,
                None,
            ...
            (
                ...
                None,
                0,
                self.findGlobalBaseYieldRateRank,
                YieldTypes.YIELD_COMMERCE,
                'u"B" + self.commerceIcon + u"g"',
            ),
            (
                "GRANK_BASE_FOOD",
                42,
                ...
                self.findGlobalBaseYieldRateRank,
                YieldTypes.YIELD_FOOD,
                'u"B" + self.foodIcon + u"g"',
            ),
            (
                "GRANK_BASE_PRODUCTION",
                42,
                "int",
                None,
                None,
            ...
            (
                ...
                None,
                0,
                self.findGlobalYieldRateRank,
                YieldTypes.YIELD_COMMERCE,
                'self.commerceIcon + u"g"',
            ),
            (
                "GRANK_FOOD",
                38,
            ...
            (
                ...
                None,
                0,
                self.findGlobalCommerceRateRank,
                CommerceTypes.COMMERCE_CULTURE,
                'self.cultureIcon + u"g"',
            ),
            (
                "GRANK_GOLD",
                38,
            ...
            (
                ...
                'self.researchIcon + u"g"',
            ),
            (
                "GREATPEOPLE",
                45,
                "int",
                CyCity.getGreatPeopleProgress,
                None,
                0,
                None,
                None,
            ...
            (
                ...
                38,
                "int",
                CyCity.getGreatPeopleRate,
                None,
                0,
                None,
                None,
                'self.figureheadIcon + u"R"',
            ),
            (
                "GREATPEOPLE_TURNS",
                38,
                ...
                None,
                None,
                self.calculateGreatPeopleTurns,
                None,
                'self.figureheadIcon + u"T"',
            ),
            ...
            (
                ...
                None,
                0,
                self.calculateWhipOverflowProduction,
                None,
                'u"H" + self.hammerIcon',
            ),
            (
                ...
                None,
                0,
                self.calculateWhipOverflowGold,
                None,
                'u"H" + self.goldIcon',
            ),
            (
                ...
                None,
                0,
                self.calculateWhipAnger,
                None,
                'u"H" + self.unhappyIcon',
            ),
            ...
            (
                ...
                "int",
                None,
                CyCity.findBaseYieldRateRank,
                YieldTypes.YIELD_COMMERCE,
                None,
                None,
                'u"B" + self.commerceIcon + u"n"',
            ),
            (
                "NRANK_BASE_FOOD",
                42,
                ...
                None,
                None,
                'u"B" + self.foodIcon + u"n"',
            ),
            (
                "NRANK_BASE_PRODUCTION",
                42,
                "int",
                None,
                CyCity.findBaseYieldRateRank,
            ...
            (
                ...
                "int",
                None,
                CyCity.findYieldRateRank,
                YieldTypes.YIELD_COMMERCE,
                None,
                None,
                'self.commerceIcon + u"n"',
            ),
            (
                "NRANK_FOOD",
                38,
            ...
            (
                ...
                "int",
                None,
                CyCity.findCommerceRateRank,
                CommerceTypes.COMMERCE_CULTURE,
                None,
                None,
                'self.cultureIcon + u"n"',
            ),
            (
                "NRANK_GOLD",
                38,
            ...
            (
                ...
                None,
                0,
                self.countFreeSpecialists,
                "GREAT_GENERAL",
                "self.milInstructorIcon",
            ),
            (
                "POPULATION",
                35,
                ...
                None,
                None,
                'localText.getText("TXT_KEY_POPULATION", ()).upper()',
            ),
            (
                "POPULATION_REAL",
                65,
                "int",
                CyCity.getRealPopulation,
                None,
                0,
                None,
                None,
                'localText.getText("TXT_KEY_POPULATION", ()).upper() + u"#"',
            ),
            ...
            (
                ...
                None,
                0,
                self.calculateReligions,
                None,
                'localText.getText("TXT_KEY_ADVISOR_RELIGION", ()).upper()',
            ),
            (
                "RESEARCH",
                38,
            ...
            (
                ...
                None,
                0,
                self.calculateSpecialists,
                None,
                'localText.getText("TXT_KEY_CONCEPT_SPECIALISTS", ()).upper()',
            ),
            ...
            (
                ...
                None,
                0,
                self.countTradeRoutes,
                None,
                'u"#" + self.tradeIcon',
            ),
            (
                "TRADE_ROUTES_DOMESTIC",
                30,
                "int",
                None,
                None,
    ...
    def createDictionaries(self):
        ...
        self.objectHave = localText.changeTextColor(
            self.objectIsPresent, gc.getInfoTypeForString("COLOR_GREEN")
        )  # "x"
        ...
        self.corpMaintPercent = gc.getWorldInfo(
        ...
        for i in range(gc.getNumBuildingInfos()):
            ...
            if (
                info.getFreeExperience() > 0
                or info.getFreePromotion() != -1
                or info.getGlobalFreeExperience() > 0
                or info.getDomainFreeExperience(DomainTypes.DOMAIN_LAND) > 0
                or info.getDomainFreeExperience(DomainTypes.DOMAIN_SEA) > 0
                or info.getDomainFreeExperience(DomainTypes.DOMAIN_AIR) > 0
            ):
                icon += self.militaryIcon

            if (
                info.getDefenseModifier() > 0
                or info.getAllCityDefenseModifier() > 0
                or info.getNukeModifier() < 0
                or info.getAirModifier() < 0
            ):
            ...
            if (
                info.getWarWearinessModifier() < 0
                or info.getAnarchyModifier() > 0
                or info.getGlobalWarWearinessModifier() < 0
            ):
                icon += "[" + self.angryIcon + "]"
            ...
            if (
                info.getSpaceProductionModifier() > 0
            ...
            if (
                info.getTradeRouteModifier() > 0
                or info.getTradeRoutes() > 0
                or info.getCoastalTradeRoutes() > 0
                or info.getGlobalTradeRoutes() > 0
                or info.getForeignTradeRouteModifier() > 0
            ):
                icon += self.tradeIcon
        ...
        for i in range(gc.getNumBuildingInfos()):
            ...
            if classInfo.getDefaultBuildingIndex() != i:
                ...
                desc = info.getDescription()
                self.COLUMNS_LIST.append(
                    (key, 22, "bldg", None, None, 0, self.calculateBuilding, i, 'u"%s"' % desc)
                )
        ...
        for i in range(gc.getNumBonusInfos()):
            ...
            self.COLUMNS_LIST.append(
                (key, 24, "bonus", None, None, 0, self.calculateHasBonus, i, 'u"' + desc + '"')
            )
        ...
        for i in range(gc.getNumBonusInfos()):
            ...
            self.COLUMNS_LIST.append(
                (key, 50, "text", None, None, 0, self.calculateBonus, i, 'u"' + desc + '"')
            )
    ...
    def createPositions(self, screen):
        ...
        self.nShortTableLength = (
            self.nPanelY + self.nPanelLength - 140
        )  # was 400 when nPanelLength was 562

        self.nSecondHalfTableX = self.nTableX + self.nTableWidth / 2 + 10
        self.nHalfTableWidth = self.nTableWidth / 2 - 10

        self.nCustomizeControlY = (
            self.nPanelY + self.nPanelLength - 120
        )  # was 450 when nPanelLength was 562

        BugUtil.debug(
            "CDA Screen: %d x %d from (%d, %d) to (%d, %d)"
            % (
                self.nScreenWidth,
                self.nScreenLength,
                self.nScreenX,
                self.nScreenY,
                self.nScreenX + self.nScreenWidth,
                self.nScreenY + self.nScreenLength,
            )
        )
        BugUtil.debug(
            "CDA Panel: %d x %d from (%d, %d) to (%d, %d)"
            % (
                self.nPanelWidth,
                self.nPanelLength,
                self.nPanelX,
                self.nPanelY,
                self.nPanelX + self.nPanelWidth,
                self.nPanelY + self.nPanelLength,
            )
        )
        BugUtil.debug(
            "CDA Table: %d x %d from (%d, %d) to (%d, %d)"
            % (
                self.nTableWidth,
                self.nTableLength,
                self.nTableX,
                self.nTableY,
                self.nTableX + self.nTableWidth,
                self.nTableY + self.nTableLength,
            )
        )
        ...
        nExitTextWidth = CyInterface().determineWidth(
        ...
        self.nCultureLevelX = (
            self.nPanelX + self.nPanelWidth - 354
        )  # was 670 when nPanelWidth was 1024
        self.nCultureLevelY = (
            self.nPanelY + self.nPanelLength - 120
        )  # was 450 when nPanelLength was 562
    ...
    def interfaceScreen(self):
        ...
        if self.bCanLiberate:
            screen.setImageButton(
                ...
                gc.getControlInfo(ControlTypes.CONTROL_FREE_COLONY).getActionInfoIndex(),
                -1,
            )
    ...
    def drawBasicScreen(self):
        ...
        screen.setImageButton(
            self.PREV_PAGE_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_LEFT").getPath(),
            x,
            self.Y_SPECIAL,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_PREV_PAGE,
            -1,
            -1,
        )
        ...
        screen.setImageButton(
            self.NEXT_PAGE_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_RIGHT").getPath(),
            x,
            self.Y_SPECIAL,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_NEXT_PAGE,
            -1,
            -1,
        )
        x += self.nControlSize + 12
        screen.addCheckBoxGFC(
            self.START_CUSTOMIZING_NAME,
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_EDIT_PAGE,
            -1,
            -1,
        ...
        x += self.nControlSize + 2
        screen.setImageButton(
            self.RENAME_PAGE_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_BTN_EVENT_LOG").getPath(),
            x,
            self.Y_SPECIAL,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_RENAME_PAGE,
            -1,
            -1,
        )
        x += self.nControlSize + 2
        ...
        screen.addCheckBoxGFC(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_TOGGLE_SPECIALISTS,
            -1,
            -1,
            ButtonStyles.BUTTON_STYLE_IMAGE,
        )
        ...
        screen.setImageButton(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_ADD_PAGE,
            -1,
            -1,
        )
        x += self.nControlSize + 2
        screen.setImageButton(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_REMOVE_PAGE,
            -1,
            -1,
        )
        x += self.nControlSize + 2
        screen.setImageButton(
            self.PAGE_UP_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_UPARROW").getPath(),
            x,
            self.Y_SPECIAL,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_MOVE_PAGE_UP,
            -1,
            -1,
        )
        x += self.nControlSize + 2
        screen.setImageButton(
            self.PAGE_DOWN_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_GENERAL_DOWNARROW").getPath(),
            x,
            self.Y_SPECIAL,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_MOVE_PAGE_DOWN,
            -1,
            -1,
        )
        x += self.nControlSize + 12
        screen.setImageButton(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_SAVE,
            -1,
            -1,
        )
        x += self.nControlSize + 2
        screen.setImageButton(
            self.RELOAD_PAGES_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_CANCEL").getPath(),
            x,
            self.Y_SPECIAL,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_RELOAD,
            -1,
            -1,
        )
        x += self.nControlSize + 2
        ...
        for i in range(gc.getNumCultureLevelInfos()):
            ...
            if nValue != 0:
                # Set text
                screen.setText(
                    self.CULTURE_TEXT_NAME + str(i),
                    "Background",
                    "<font=2>" + pCultureLevel.getText() + "</font>",
                    CvUtil.FONT_LEFT_JUSTIFY,
                    self.nCultureLevelX,
                    self.nCultureLevelY + (self.nCultureLevelDistance * iCount),
                    self.Z_TEXT,
                    FontTypes.GAME_FONT,
                    WidgetTypes.WIDGET_GENERAL,
                    -1,
                ...
                # Set value
                screen.setText(
                    self.CULTURE_TEXT_NAME + self.NUMBER_TEXT + str(i),
                    "Background",
                    "<font=2>" + str(nValue) + "</font>",
                    CvUtil.FONT_RIGHT_JUSTIFY,
                    self.nCultureLevelX + self.nCultureLevelTextOffset,
                    self.nCultureLevelY + (self.nCultureLevelDistance * iCount),
                    self.Z_TEXT,
                    FontTypes.GAME_FONT,
                    WidgetTypes.WIDGET_GENERAL,
        ...
        for i in range(self.getNumSpecialistInfos()):
            ...
            if gc.getSpecialistInfo(i).isVisible():
                ...
                screen.setImageButton(
                    ...
                    self.nSpecialistY,
                    self.nSpecialistWidth,
                    self.nSpecialistLength,
        ...
        for i in range(self.getNumSpecialistInfos()):
            if gc.getSpecialistInfo(i).isVisible():
                ...
                screen.setButtonGFC(
                    ...
                    u"",
                    "",
                    self.nFirstSpecialistX + (self.nSpecialistDistance * i) + self.nPlusOffsetX,
                    self.nSpecialistY + self.nPlusOffsetY,
                    self.nPlusWidth,
                    self.nPlusHeight,
        ...
        for i in range(self.getNumSpecialistInfos()):
            if gc.getSpecialistInfo(i).isVisible():
                ...
                screen.setButtonGFC(
                    ...
                    u"",
                    "",
                    self.nFirstSpecialistX + (self.nSpecialistDistance * i) + self.nMinusOffsetX,
                    self.nSpecialistY + self.nMinusOffsetY,
                    self.nMinusWidth,
                    self.nMinusHeight,
                    WidgetTypes.WIDGET_CHANGE_SPECIALIST,
                    i,
        ...
        for i in range(self.getNumSpecialistInfos()):
            if gc.getSpecialistInfo(i).isVisible():
                ...
                screen.setText(
                    ...
                    "",
                    CvUtil.FONT_LEFT_JUSTIFY,
                    self.nFirstSpecialistX
                    + (self.nSpecialistDistance * i)
                    + self.nSpecTextOffsetX,
                    self.nSpecialistY + self.nSpecTextOffsetY,
                    self.Z_TEXT,
                    FontTypes.GAME_FONT,
                    WidgetTypes.WIDGET_GENERAL,
                    -1,
        ...
        if city:
            ...
            for i in range(self.getNumSpecialistInfos()):
                ...
                screen.setText(
                    ...
                    + u" %c" % self.SPECIALIST_ICON_DICT[i],
                    CvUtil.FONT_LEFT_JUSTIFY,
                    self.nFirstSpecialistX
                    + (self.nSpecialistDistance * i)
                    + self.nSpecTextOffsetX,
                ...
                if city.isSpecialistValid(i, 1) and (
                    city.getForceSpecialistCount(i) < (nPopulation + nFreeSpecial)
                ):
                    # Show the Plus
                    szName = self.SPECIALIST_PLUS_NAME + str(i)
                    screen.show(szName)
    ...
    def drawCustomizationControls(self):
        ...
        screen.setImageButton(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_MOVE_COLUMN_DOWN,
            -1,
            -1,
        )
        x -= self.nControlSize + 2
        screen.setImageButton(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_MOVE_COLUMN_UP,
            -1,
            -1,
        )
        x -= self.nControlSize + 2
        screen.setImageButton(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_REMOVE_COLUMN,
            -1,
            -1,
        )
        x -= self.nControlSize + 2
        screen.setImageButton(
            ...
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_ADD_COLUMN,
            -1,
            -1,
        )
        x -= self.nControlSize + 2
        screen.setImageButton(
            self.COLUMN_WIDEN_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_RIGHT").getPath(),
            x,
            self.nCustomizeControlY,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_EXPAND_COLUMN,
            -1,
            -1,
        )
        x -= self.nControlSize + 2
        screen.setImageButton(
            self.COLUMN_SHRINK_NAME,
            ArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_LEFT").getPath(),
            x,
            self.nCustomizeControlY,
            self.nControlSize,
            self.nControlSize,
            WidgetTypes.WIDGET_CDA_SHRINK_COLUMN,
            -1,
            -1,
        )
    ...
    def calculateFeatures(self, city, szKey, arg):
        ...
        for i in range(gc.getNumBuildingInfos()):
            ...
            classInfo = gc.getBuildingClassInfo(info.getBuildingClassType())
            if (
                classInfo.getMaxGlobalInstances() == -1
                and classInfo.getMaxPlayerInstances() == 1
                and city.getNumBuilding(i) > 0
                and not info.isCapital()
            ):
    ...
    def calculateFood(self, city, szKey, arg):
        ...
        # If this is a food production (i.e., worker or settler)
        if self.isFoodProduction(city.getProductionName()):
            nFood = city.getCurrentProductionDifference(
                False, False
            ) - city.getCurrentProductionDifference(True, False)
        else:
            nFood = city.foodDifference(True)
        return nFood
            ...
            if pTradeCity and pTradeCity.getOwner() >= 0:
                ...
                if not arg or ((arg == "F" and bForeign) or (arg == "D" and not bForeign)):
                    for j in range(YieldTypes.NUM_YIELD_TYPES):
                        iTradeProfit = city.calculateTradeYield(
                            j, city.calculateTradeProfit(pTradeCity)
                        )
        ...
        if city.getOrderQueueLength() > 0:
            ...
            if bProdColors or bProdIcons:
                ...
                if city.isProductionBuilding():
                    szColorKey = "WONDER"
                    pInfo = gc.getBuildingClassInfo(
                        gc.getBuildingInfo(city.getProductionBuilding()).getBuildingClassType()
                    )
                ...
                if bProdColors:
                    szReturn = localText.changeTextColor(
                        szReturn, self.PROD_COLOR_DICT[szColorKey]
                    )
        # BUG - Production Grouping - end
    ...
    def calculateWhipOverflow(self, city, szKey, arg):
        ...
        if city.canHurry(self.HURRY_TYPE_POP, False):
            ...
            iOverflowGold = (
                max(0, iOverflow - iMaxOverflow) * gc.getDefineINT("MAXED_UNIT_GOLD_PERCENT") / 100
            )
            iOverflow = (
                100
                * iMaxOverflow
                / city.getBaseYieldRateModifier(
                    gc.getInfoTypeForString("YIELD_PRODUCTION"), city.getProductionModifier()
                )
            )
    ...
    def calculateValue(self, city, szKey, arg):
        ...
        if szKey.find("BUILDING_") == 0:
            if (
                city.getNumActiveBuilding(self.BUILDING_DICT[szKey]) > 0
                or city.getProductionName() == self.HEADER_DICT[szKey]
            ):
                ...
                if (
                    info.getMilitaryProductionModifier() > 0
                    and city.isProductionUnit()
                    and gc.getUnitInfo(city.getProductionUnit()).isMilitaryProduction()
                ):
    ...
    def canAdviseToConstruct(self, city, i):
        ...
        if info.getObsoleteTech() != TechTypes.NO_TECH and PyPlayer(
            CyGame().getActivePlayer()
        ).getTeam().isHasTech(info.getObsoleteTech()):
            return False

        sinfo = gc.getSpecialBuildingInfo(info.getSpecialBuildingType())

        if sinfo:
            if sinfo.getObsoleteTech() != TechTypes.NO_TECH and PyPlayer(
                CyGame().getActivePlayer()
            ).getTeam().isHasTech(sinfo.getObsoleteTech()):
                return False
        ...
        if bestOrder == -1:
            for i in range(gc.getNumBuildingClassInfos()):
                ...
                if self.canAdviseToConstruct(city, bldg):
                    info = gc.getBuildingInfo(bldg)
                    if (
                        self.calculateNetHappiness(city) < 3
                        and self.calculateNetHappiness(city) - self.calculateNetHealth(city) > 2
                    ):
                        ...
                        self.calculateNetHealth(city) < 3
                        and self.calculateNetHealth(city) - self.calculateNetHappiness(city) > 2
                    ):
                ...
                if self.canAdviseToConstruct(city, bldg):
                    ...
                    if type == "Culture":
                        if city.findBaseYieldRateRank(YieldTypes.YIELD_COMMERCE) < 6:
                            value = info.getCommerceModifier(
                                CommerceTypes.COMMERCE_CULTURE
                            ) / float(info.getProductionCost())
                            if value > bestData:
                                bestOrder = bldg
                                bestData = value
                        else:
                        ...
                        value = (
                            math.sin(
                                float(info.getProductionCost())
                                * city.getBaseYieldRate(YieldTypes.YIELD_COMMERCE)
                            )
                            + 1
                        )
                        if value > bestData:
                        ...
                        value = info.getCommerceModifier(CommerceTypes.COMMERCE_RESEARCH) / float(
                            info.getProductionCost()
                        )
                        if value > bestData:
                            bestOrder = bldg
                            bestData = value
                        ...
                        if not city.isPower():
                            if info.isPower():
                                value = city.getBaseYieldRate(YieldTypes.YIELD_PRODUCTION) / float(
                                    info.getProductionCost()
                                )
                                if value > bestData:
                                    bestOrder = bldg
                        ...
                        if city.findBaseYieldRateRank(YieldTypes.YIELD_PRODUCTION) < 12:
                            value = (
                                city.getBaseYieldRate(YieldTypes.YIELD_PRODUCTION)
                                * 2
                                * info.getYieldModifier(YieldTypes.YIELD_PRODUCTION)
                                / float(info.getProductionCost())
                            )
                            if value > bestData:
                                bestOrder = bldg
                        ...
                        if (
                            city.findBaseYieldRateRank(YieldTypes.YIELD_COMMERCE)
                            < player.getNumCities() / 2
                        ):
                            value = (
                                city.getBaseYieldRate(YieldTypes.YIELD_COMMERCE)
                                * info.getCommerceModifier(CommerceTypes.COMMERCE_RESEARCH)
                                / float(info.getProductionCost())
                            )
                            if value > bestData:
                                bestOrder = bldg
                ...
                if self.canAdviseToConstruct(city, bldg):
                    ...
                    if type == "Culture":
                        if city.findBaseYieldRateRank(YieldTypes.YIELD_COMMERCE) < 6:
                            ...
                            bestOrder = (
                                -1
                            )  # In a cultural game, build units in the culturally weak cities
                    elif type == "Military":
                        if city.findBaseYieldRateRank(YieldTypes.YIELD_PRODUCTION) <= 3:
                            value = (
                                -1
                                * info.getMilitaryProductionModifier()
                                / float(info.getProductionCost())
                            )
                            ...
                            value = info.getYieldModifier(YieldTypes.YIELD_PRODUCTION) / float(
                                info.getProductionCost()
                            )
                            if value > bestData:
                                bestOrder = bldg
                        ...
                        value = info.getCommerceModifier(CommerceTypes.COMMERCE_GOLD) / float(
                            info.getProductionCost()
                        )
                        if value > bestData:
                            bestOrder = bldg
            ...
            for szCompareType, clDict in self.COLOR_DICT_DICT.iteritems():
                ...
                if clDict is not None and clDict.has_key(szKey):
                    if szKey in self.COMPARISON_REVERSED:
                        ...
                        if (
                            szCompareType == "PROBLEM"
                            and int(nValue) >= clDict[szKey]
                            or szCompareType == "NEUTRAL"
                            and int(nValue) == clDict[szKey]
                            or szCompareType == "GREAT"
                            and int(nValue) <= clDict[szKey]
                        ):
                            # ...color and return it
    ...
    def drawContents(self, page):
        ...
        screen.addDropDownBoxGFC(
            ...
            self.Y_SPECIAL,
            self.PAGES_DD_W,
            WidgetTypes.WIDGET_CDA_SELECT_PAGE,
            -1,
            -1,
            FontTypes.GAME_FONT,
        )
        ...
        if self.customizing:
            ...
            if screen.getTableNumRows(self.COLUMNS_LIST_PAGE) != len(self.COLUMNS_LIST):
                ...
                screen.addTableControlGFC(
                    self.COLUMNS_LIST_PAGE,
                    4,
                    self.nSecondHalfTableX,
                    self.nTableY,
                    self.nHalfTableWidth,
                    self.nShortTableLength,
                    True,
                ...
                screen.setTableColumnHeader(
                    self.COLUMNS_LIST_PAGE, 2, u"<font=2>TITLE</font>", 160
                )
                ...
                for i, column in enumerate(columns):
                    ...
                    try:
                        screen.setTableText(
                            ...
                            2,
                            i,
                            unicode(self.HEADER_DICT[column[0]]),
                            "",
                            WidgetTypes.WIDGET_GENERAL,
                            -1,
                            -1,
        ...
        # If displaying the normal advisor screen (not the customization interface)
            ...
            # Build the table
            if (
                not self.PAGES[self.currentPageNum]["showSpecControls"]
                and not self.PAGES[self.currentPageNum]["showCultureLegend"]
            ...
            for value, key in columns:
                ...
                try:
                    ...
                    if type == "bldg" or type == "bldgclass":
                        ...
                        x = (
                            iBuildingButtonX
                            + (self.columnWidth[key] - self.BUILDING_BUTTON_X_SIZE) / 2
                        )
                        screen.setImageButton(
                            szName,
                            buildingInfo.getButton(),
                            x,
                            iBuildingButtonY,
                            self.BUILDING_BUTTON_X_SIZE,
                            self.BUILDING_BUTTON_Y_SIZE,
                        ...
                        screen.setTableColumnHeader(
                            page,
                            value + 1,
                            "<font=2>" + self.HEADER_DICT[key] + "</font>",
                    ...
                    if columnDef[3]:
                        ...
                        for i in cityRange:
                            szValue = colorFunc(
                                unicode(calcFunc(cityList[i].city, columnDef[5])), key
                            )
                            funcTableWrite(
                                page,
                                value + 1,
                        ...
                        for i in cityRange:
                            szValue = colorFunc(
                                unicode(calcFunc(cityList[i].city, key, columnDef[7])), key
                            )
                            funcTableWrite(
                                page,
                                value + 1,
    ...
    def handleInput(self, inputClass):
            ...
            if szWidget == self.PAGES_DD_NAME + "0":
                ...
                if inputClass.getMouseX() == 0:
                    ...
                    self.updateAppropriateCitySelection(
                        self.currentPage, len(PyPlayer(CyGame().getActivePlayer()).getCityList())
                    )
        ...
        elif code == NotifyCode.NOTIFY_CLICKED and self.DomesticScreenInputMap.has_key(
        ...
        if not self.renameEventContext or self.renameEventContext is None:
            ...
            for i in range(5000, 6000):
                if not eventManager.Events.has_key(i):
                    ...
                    eventManager.Events[self.renameEventContext] = (
                        "DomAdvRenamePage",
                        self.renameApply,
                        self.renameBegin,
                    )
