...
class CvDomesticAdvisor:
    ...
    def drawHeaders(self):
        ...
        screen.setTableColumnHeader(
            "CityListBackground", 0, "", (30 * self.nTableWidth) / self.nNormalizedTableWidth
        )
        ...
        screen.setTableColumnHeader(
            "CityListBackground",
            3,
            "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.HAPPY_CHAR)) + "</font>",
            (40 * self.nTableWidth) / self.nNormalizedTableWidth,
        )
        ...
        screen.setTableColumnHeader(
            "CityListBackground",
            4,
            "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.HEALTHY_CHAR)) + "</font>",
            (40 * self.nTableWidth) / self.nNormalizedTableWidth,
        )
        ...
        screen.setTableColumnHeader(
            "CityListBackground",
            5,
            "<font=2>" + (u"%c" % gc.getYieldInfo(YieldTypes.YIELD_FOOD).getChar()) + "</font>",
            (40 * self.nTableWidth) / self.nNormalizedTableWidth,
        )
        ...
        screen.setTableColumnHeader(
            ...
            + "</font>",
            (70 * self.nTableWidth) / self.nNormalizedTableWidth,
        )
        ...
        screen.setTableColumnHeader(
            "CityListBackground",
            11,
            "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.TRADE_CHAR)) + "</font>",
        ...
        screen.setTableColumnHeader(
            "CityListBackground",
            12,
            "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.BAD_GOLD_CHAR)) + "</font>",
            (40 * self.nTableWidth) / self.nNormalizedTableWidth,
        )
        ...
        screen.setTableColumnHeader(
            "CityListBackground",
            13,
            "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.GREAT_PEOPLE_CHAR)) + "</font>",
            (70 * self.nTableWidth) / self.nNormalizedTableWidth,
        )
        ...
        screen.setTableColumnHeader(
            "CityListBackground",
            14,
            "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.DEFENSE_CHAR)) + "</font>",
            (35 * self.nTableWidth) / self.nNormalizedTableWidth,
        )
        ...
        # Liberate Column
        screen.setTableColumnHeader(
            "CityListBackground", 16, "", (25 * self.nTableWidth) / self.nNormalizedTableWidth
        )
    ...
    def updateTable(self, pLoopCity, i):
        ...
        if iGreatPersonRate > 0:
            iGPPLeft = (
                ...
                - pLoopCity.getGreatPeopleProgress()
            )
            if iGPPLeft > 0:
            ...
            for i in range(gc.getNumSpecialistInfos()):
                if gc.getSpecialistInfo(i).isVisible():
                    ...
                    screen.setLabel(
                        szName,
                        "Background",
                        str(city.getSpecialistCount(i)) + "/" + str(city.getMaxSpecialistCount(i)),
                        CvUtil.FONT_LEFT_JUSTIFY,
                        self.nFirstSpecialistX
                        + (self.nSpecialistDistance * i)
                        + self.nSpecTextOffsetX,
