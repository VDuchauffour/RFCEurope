...
class CvEspionageAdvisor:
    ...
    def interfaceScreen(self):
        ...
        self.EPScreen.addTitle(
            self.WIDGET_HEADER,
            "TXT_KEY_ESPIONAGE_SCREEN",
            "4b",
            True,
            self.X_SCREEN,
            self.Y_TITLE,
        ...
        self.EPScreen.addTab(
            self.MissionsTabWidget,
            "TXT_KEY_ESPIONAGE_MISSIONS_TAB",
            "4",
            True,
            50,
            self.Y_EXIT,
        ...
        self.EPScreen.addTab(
            self.SpyvSpyTabWidget,
            "TXT_KEY_ESPIONAGE_SPYVSPY_TAB",
            "4",
            False,
            350,
            self.Y_EXIT,
        ...
        if self.EPScreenTab == -1 or self.EPScreenTab == 1:
        ...
        if self.iTargetPlayer != -1:
            ...
            if EspionageOpt.isEnabled():
                ...
                screen.setText(
                    ...
                    szText,
                    CvUtil.FONT_LEFT_JUSTIFY,
                    self.X_MISSIONS_LIST,
                    self.Y_MISSIONS_LIST - 40,
                    self.Z_CONTROLS,
                    FontTypes.GAME_FONT,
                    WidgetTypes.WIDGET_GENERAL,
                    -1,
            ...
            screen.setLabel(
                ...
                szText,
                CvUtil.FONT_LEFT_JUSTIFY,
                self.X_EFFECTS_COSTS_LIST,
                self.Y_EFFECTS_COSTS_LIST - 40,
                self.Z_CONTROLS,
                FontTypes.GAME_FONT,
                WidgetTypes.WIDGET_GENERAL,
                -1,
            ...
            screen.setLabel(
                ...
                szText,
                CvUtil.FONT_LEFT_JUSTIFY,
                self.X_MISSIONS_COSTS_LIST,
                self.Y_MISSIONS_COSTS_LIST - 40,
                self.Z_CONTROLS,
                FontTypes.GAME_FONT,
                WidgetTypes.WIDGET_GENERAL,
                -1,
    ...
    def drawMissionTab_LeftLeaderPanal(self, screen):
        ...
        if EspionageOpt.isEnabled():
            ...
            szText = (
                u"<font=2>"
                + localText.getText("TXT_KEY_ESPIONAGE_AI_SPENDING_TOGGLE", ())
                + "</font>"
            )
            ...
            screen.setText(
                ...
                self.X_LEFT_PANE + self.W_LEFT_PANE - 20,
                self.Y_LEFT_PANE + 8,
                self.Z_CONTROLS,
                FontTypes.GAME_FONT,
                WidgetTypes.WIDGET_GENERAL,
        ...
        for iPlayerID in self.aiKnownPlayers:
            ...
            szName = self.getNextWidgetName()
            self.LeaderImageWidgets[
                iPlayerID
            ] = szName  # updated by handle input so needs to be stored

            screen.addCheckBoxGFCAt(
                szLeaderPanel,
                szName,
                gc.getLeaderHeadInfo(gc.getPlayer(iPlayerID).getLeaderType()).getButton(),
                ArtFileMgr.getInterfaceArtInfo("BUTTON_HILITE_SQUARE").getPath(),
                self.MissionLeaderPanel_X_LeaderIcon,
                self.MissionLeaderPanelTopRow,
                32,
                32,
                WidgetTypes.WIDGET_GENERAL,
                self.iLeaderImagesID,
                iPlayerID,
            ...
            screen.attachPanelAt(
                ...
                False,
                PanelStyles.PANEL_STYLE_MAIN,
                self.MissionLeaderPanel_X_LeaderNamePanel,
                self.MissionLeaderPanelTopRow,
                self.W_NAME_PANEL,
                self.H_NAME_PANEL,
                WidgetTypes.WIDGET_GENERAL,
            ...
            if EspionageOpt.isEnabled():
                szTempBuffer = u"<color=%d,%d,%d,%d>%s</color>" % (
                    pTargetPlayer.getPlayerTextColorR(),
                    pTargetPlayer.getPlayerTextColorG(),
                    pTargetPlayer.getPlayerTextColorB(),
                    pTargetPlayer.getPlayerTextColorA(),
                    pTargetPlayer.getName(),
                )
            else:
                szMultiplier = self.getEspionageMultiplierText(self.iActivePlayer, iPlayerID)
                szTempBuffer = u"<color=%d,%d,%d,%d>%s (%s)</color>" % (
                    pTargetPlayer.getPlayerTextColorR(),
                    pTargetPlayer.getPlayerTextColorG(),
                    pTargetPlayer.getPlayerTextColorB(),
                    pTargetPlayer.getPlayerTextColorA(),
            ...
            screen.setLabelAt(
                ...
                szText,
                0,
                self.MissionLeaderPanel_X_LeaderName,
                self.MissionLeaderPanelTopRow,
                self.Z_CONTROLS,
            ...
            if EspionageOpt.isEnabled():
                ...
                screen.setLabelAt(
                    ...
                    szText,
                    CvUtil.FONT_RIGHT_JUSTIFY,
                    self.MissionLeaderPanel_X_Multiplier,
                    self.MissionLeaderPanelTopRow,
                    self.Z_CONTROLS,
                    FontTypes.TITLE_FONT,
                    WidgetTypes.WIDGET_GENERAL,
            ...
            if (
                ...
                screen.setLabelAt(
                    ...
                    CvUtil.FONT_RIGHT_JUSTIFY,
                    self.MissionLeaderPanel_X_Multiplier,
                    self.MissionLeaderPanelBottomRow,
                    self.Z_CONTROLS,
                    FontTypes.TITLE_FONT,
                    WidgetTypes.WIDGET_GENERAL,
                    -1,
            ...
            if EspionageOpt.isEnabled():
                ...
                self.showCounterEspionage(
                    screen, szLeaderPanel, iCounterEsp, self.MissionLeaderPanelTopRow
                )
                ...
                if self.bShowAISpending:
                    ...
                    self.showCounterEspionage(
                        screen, szLeaderPanel, iCounterEsp, self.MissionLeaderPanelBottomRow
                    )
            ...
            szText = (
                u"<font=2>"
                + localText.getText("TXT_KEY_ESPIONAGE_NUM_EPS", (iPlayerEPs,))
                + "</font>"
            )
            screen.setLabelAt(
                szName,
                ...
                szText,
                CvUtil.FONT_RIGHT_JUSTIFY,
                self.MissionLeaderPanel_X_EPoints,
                self.MissionLeaderPanelTopRow,
                self.Z_CONTROLS,
                FontTypes.TITLE_FONT,
                WidgetTypes.WIDGET_GENERAL,
            ...
            if EspionageOpt.isEnabled() and self.bShowAISpending:
                ...
                if iSpending is None or iSpending == 0:
                    szText = u""
                else:
                    if iSpending > 0:
                        szText = u"<font=2>(+%i)</font>" % (iSpending)
                        szText = localText.changeTextColor(
                            szText, gc.getInfoTypeForString("COLOR_GREEN")
                        )
                    else:
                        szText = u"<font=2>(%i)</font>" % (iSpending)
                        szText = localText.changeTextColor(
                ...
                screen.setLabelAt(
                    ...
                    szText,
                    CvUtil.FONT_LEFT_JUSTIFY,
                    self.MissionLeaderPanel_X_EPointsTurn,
                    self.MissionLeaderPanelBottomRow,
                    self.Z_CONTROLS,
                    FontTypes.TITLE_FONT,
                    WidgetTypes.WIDGET_GENERAL,
            ...
            screen.setImageButtonAt(
                ...
                self.MissionLeaderPanel_X_WghtInc,
                self.MissionLeaderPanelBottomRow,
                iSize,
                iSize,
                WidgetTypes.WIDGET_GENERAL,
                self.iIncreaseButtonID,
                iPlayerID,
            )
            szName = self.getNextWidgetName()
            screen.setImageButtonAt(
                ...
                self.MissionLeaderPanel_X_WghtDec,
                self.MissionLeaderPanelBottomRow,
                iSize,
                iSize,
                WidgetTypes.WIDGET_GENERAL,
                self.iDecreaseButtonID,
                iPlayerID,
            )
            ...
            if EspionageOpt.isEnabled():
                # Active Player
                iDemoCost = pActivePlayer.getEspionageMissionCost(
                    self.MissionSeeDemo, iPlayerID, None, -1
                )
                iTechCost = pActivePlayer.getEspionageMissionCost(
                    self.MissionSeeResearch, iPlayerID, None, -1
                )
                self.showPassiveMissionIcons(
                    screen,
                    szLeaderPanel,
                    iPlayerEPs,
                    iDemoCost,
                ...
                if EspionageOpt.isShowCalculatedInformation() and self.bShowAISpending:
                    iDemoCost = pTargetPlayer.getEspionageMissionCost(
                        self.MissionSeeDemo, self.iActivePlayer, None, -1
                    )
                    iTechCost = pTargetPlayer.getEspionageMissionCost(
                        self.MissionSeeResearch, self.iActivePlayer, None, -1
                    )
                    self.showPassiveMissionIcons(
                        screen,
                        szLeaderPanel,
    ...
    def showCounterEspionage(self, screen, szLeaderPanel, iCounterEspTurns, iRow):
        ...
        screen.setLabelAt(
            ...
            szText,
            CvUtil.FONT_RIGHT_JUSTIFY,
            self.MissionLeaderPanel_X_CounterEP,
            iRow,
            self.Z_CONTROLS,
            FontTypes.TITLE_FONT,
            WidgetTypes.WIDGET_GENERAL,
    ...
    def showPassiveMissionIcons(self, screen, szLeaderPanel, iEPoints, iDemoCost, iTechCost, iRow):
        ...
        screen.setLabelAt(
            ...
            szText,
            CvUtil.FONT_LEFT_JUSTIFY,
            self.MissionLeaderPanel_X_PassiveMissions,
            iRow,
            self.Z_CONTROLS,
            FontTypes.TITLE_FONT,
            WidgetTypes.WIDGET_GENERAL,
            ...
            if self.iTargetPlayer != -1:
                ...
                if self.CityMissionToggle == CITYMISSION_CITY:
                    ...
                    for pyCity in apCityList:
                        pCity = pyCity.GetCy()
                        szCityName = self.getCityNameText(
                            pCity, self.iActivePlayer, self.iTargetPlayer
                        )
                        ...
                        if (
                            ...
                            if (
                                self.iActiveCityID == -1
                                or pTargetPlayer.getCity(self.iActiveCityID).isNone()
                            ):
                ...
                screen.addTableControlGFCWithHelp(
                    self.EffectsTableWidget,
                    4,
                    self.X_EFFECTS_LIST,
                    self.Y_EFFECTS_LIST,
                    self.W_EFFECTS_LIST
                    + self.W_EFFECTS_COSTS_LIST
                    + self.W_TABLE_1
                    + self.W_TABLE_3,
                    self.H_EFFECTS_LIST,
                    False,
                ...
                if self.CityMissionToggle == CITYMISSION_CITY:
                    ...
                    szHelpText = ""
                screen.addTableControlGFCWithHelp(
                    self.MissionsTableWidget,
                    4,
                    self.X_MISSIONS_LIST,
                    self.Y_MISSIONS_LIST,
                    self.W_MISSIONS_LIST
                    + self.W_MISSIONS_COSTS_LIST
                    + self.W_TABLE_1
                    + self.W_TABLE_3,
                    self.H_MISSIONS_LIST,
                    False,
                    False,
                    32,
                    32,
    ...
    def refreshMissionTab_LeftLeaderPanel(self, screen, pActivePlayer, iPlayerID):
        ...
        szText = (
            ...
            + ": %d</font>" % (pActivePlayer.getEspionageSpendingWeightAgainstTeam(iTargetTeam))
        )
        screen.setLabelAt(
            szEPWeight,
            szLeaderPanel,
            szText,
            0,
            self.MissionLeaderPanel_X_Wght,
            self.MissionLeaderPanelBottomRow,
            self.Z_CONTROLS,
            FontTypes.TITLE_FONT,
            WidgetTypes.WIDGET_GENERAL,
        ...
        if EspionageOpt.isEnabled():
            ...
            if iSpending > 0:
                szText = u"<font=2><color=0,255,0,0>%s</color></font>" % (
                    localText.getText("TXT_KEY_ESPIONAGE_NUM_EPS_PER_TURN", (iSpending,))
                )
            else:
        ...
        screen.setLabelAt(
            ...
            szText,
            0,
            self.MissionLeaderPanel_X_EspionageIcon,
            self.MissionLeaderPanelMiddle,
            self.Z_CONTROLS,
            FontTypes.TITLE_FONT,
            WidgetTypes.WIDGET_GENERAL,
            -1,
    ...
    def getTableTextCost(self, iActivePlayer, iTargetPlayer, iMission, iCity):
        ...
        szCityName = ""
        bHideCost = False
        if iCity != -1 and pMission.isTargetsCity():
        ...
        if self.CityMissionToggle == CITYMISSION_CITY or (  # secondary list is mission names
            pMission.isPassive() and not pMission.isTargetsCity()
        ):
            szTechText = ""
    ...
    def drawSpyvSpyTab(self):
        ...
        for iLoop in range(gc.getMAX_PLAYERS()):
            pPlayer = gc.getPlayer(iLoop)
            if self.iActivePlayer != iLoop and not pPlayer.isBarbarian():
                if pPlayer.isAlive():
                    if pActiveTeam.isHasMet(pPlayer.getTeam()):
                        self.aiKnownPlayers.append(iLoop)
                        self.iNumEntries = self.iNumEntries + 1
        ...
        screen.addPanel(
            self.szLeftLeaderPanel,
            "",
            "",
            True,
            True,
            self.X_SvS_LEFT_LEADER,
            self.Y_SvS_LEFT_LEADER,
            self.W_SvS_LEFT_LEADER,
            self.H_SvS_LEFT_LEADER,
            PanelStyles.PANEL_STYLE_STANDARD,
        )
        ...
        screen.addPanel(
            self.szTopLeaderPanel,
            "",
            "",
            True,
            True,
            self.X_SvS_TOP_LEADER,
            self.Y_SvS_TOP_LEADER,
            self.W_SvS_TOP_LEADER,
            self.H_SvS_TOP_LEADER,
            PanelStyles.PANEL_STYLE_STANDARD,
        )
        ...
        for iRowPlayerID in self.aiKnownPlayers:
            ...
            sLeaderButton = gc.getLeaderHeadInfo(
                gc.getPlayer(iRowPlayerID).getLeaderType()
            ).getButton()
            ...
            screen.setImageButton(
                ...
                sLeaderButton,
                self.X_SvS_LEFT_LEADER + 2,
                self.Y_SvS_LEFT_LEADER + (iRow - 1) * self.H_SvS_CELL + 3,
                self.SvS_IconSize,
                self.SvS_IconSize,
            ...
            screen.setImageButton(
                ...
                sLeaderButton,
                self.X_SvS_TOP_LEADER
                + (iRow - 1) * self.W_SvS_CELL
                + self.W_SvS_CELL / 2
                - self.SvS_IconSize / 2,
                self.Y_SvS_TOP_LEADER + 3,
                self.SvS_IconSize,
                self.SvS_IconSize,
                WidgetTypes.WIDGET_LEADERHEAD,
                iRowPlayerID,
            ...
            for iColPlayerID in self.aiKnownPlayers:
                ...
                if (
                    pActiveTeam.isHasMet(pColPlayer.getTeam())
    ...
    def formatSpending(self, iSpending):
        if iSpending == 0:
            ...
            return localText.changeTextColor(
                u"<font=2>+%i</font>" % (iSpending), gc.getInfoTypeForString("COLOR_GREEN")
            )
        else:
            return localText.changeTextColor(
                u"<font=2>%i</font>" % (iSpending), gc.getInfoTypeForString("COLOR_YELLOW")
            )
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getNotifyCode() == NotifyCode.NOTIFY_CLICKED:
            if self.EPScreen.getActiveTab() == self.MissionsTabWidget:
                if (
                    "%s%d" % (icFunctionName, inputClass.getID()) == self.szMissionsTitleText
                    ...
                    if self.CityMissionToggle == CITYMISSION_MISSION:
                        ...
                        return 0
                if (
                    "%s%d" % (icFunctionName, inputClass.getID()) == self.ShowAISpendingWidget
                ):  # toggle show AI spending
        ...
        if self.iTargetPlayer != -1:
            ...
            ##### Decrease Button #####
                ...
                iTargetTeam = gc.getPlayer(iPlayerID).getTeam()
                if (
                    pActivePlayer.getEspionageSpendingWeightAgainstTeam(iTargetTeam) > 0
                ):  # Can't reduce weight below 0
                    CyMessageControl().sendEspionageSpendingWeightChange(iTargetTeam, -1)
                    CyInterface().setDirty(InterfaceDirtyBits.Espionage_Advisor_DIRTY_BIT, True)
                return 0
