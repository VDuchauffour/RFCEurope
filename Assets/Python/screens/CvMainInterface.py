...
class CvMainInterface:
    ...
    def initState(self, screen=None):
        ...
        self.pBarPopulationBar = ProgressBarUtil.ProgressBar(
            ...
            iCityCenterRow1X,
            iCityCenterRow1Y - 4,
            self.xResolution - (iCityCenterRow1X * 2),
            iStackBarHeight,
            gc.getYieldInfo(YieldTypes.YIELD_FOOD).getColorType(),
            ProgressBarUtil.SOLID_MARKS,
            True,
        )
        ...
        self.pBarProductionBar = ProgressBarUtil.ProgressBar(
            ...
            iCityCenterRow2X,
            iCityCenterRow2Y - 4,
            self.xResolution - (iCityCenterRow2X * 2),
            iStackBarHeight,
        ...
        self.m_iNumPlotListButtonsPerRow = (
            self.xResolution - (iMultiListXL + iMultiListXR) - 68
        ) / 34

        # BUG - BUG unit plot draw method - start
        # bug unit panel
        self.BupPanel = BugUnitPlot.BupPanel(
            screen,
            screen.getXResolution(),
            screen.getYResolution(),
            iMultiListXL + iMultiListXR,
            self.numPlotListButtonsPerRow(),
    ...
    def interfaceScreen(self):
        ...
        # Center Left
        screen.addPanel(
            "InterfaceCenterLeftBackgroundWidget",
            u"",
            u"",
            True,
            False,
        ...
        # Top Left
        screen.addPanel(
            "InterfaceTopLeftBackgroundWidget",
            u"",
            u"",
            True,
            False,
        ...
        # Center Right
        screen.addPanel(
            "InterfaceCenterRightBackgroundWidget",
            u"",
            u"",
            True,
            False,
        ...
        screen.addPanel(
            "InterfaceCenterBackgroundWidget",
            u"",
            u"",
            True,
            False,
        ...
        screen.addPanel(
            "InterfaceRightBackgroundWidget",
            u"",
            u"",
            True,
            False,
        ...
        screen.setImageButton(
            ...
            iBtnWidth,
            WidgetTypes.WIDGET_ACTION,
            gc.getControlInfo(ControlTypes.CONTROL_MERCENARIES_MANAGER).getActionInfoIndex(),
            -1,
        )
        ...
        screen.initMinimap(
            xResolution - 210, xResolution - 9, yResolution - 131, yResolution - 9, -0.1
        )
        ...
        for i in range(gc.getNumReligionInfos()):
            ...
            screen.setImageButton(
                ...
                32,
                WidgetTypes.WIDGET_RESEARCH,
                gc.getReligionInfo(i).getTechPrereq(),
                -1,
            )
            screen.hide(szName)
        ...
        for i in range(gc.getNumSpecialistInfos()):
            ...
            if gc.getSpecialistInfo(i).isVisible():
                ...
                screen.setImageButton(
                    ...
                    24,
                    24,
                    WidgetTypes.WIDGET_DISABLED_CITIZEN,
                    i,
                    -1,
                )
        ...
        screen.setStackedBarColors(
            "ResearchBar", InfoBarTypes.INFOBAR_RATE_EXTRA, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        screen.setStackedBarColors(
            "ResearchBar", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.setStackedBarColors(
            "GreatGeneralBar", InfoBarTypes.INFOBAR_RATE, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        screen.setStackedBarColors(
            "GreatGeneralBar",
            InfoBarTypes.INFOBAR_RATE_EXTRA,
            gc.getInfoTypeForString("COLOR_EMPTY"),
        )
        screen.setStackedBarColors(
            "GreatGeneralBar", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.setStackedBarColors(
            "GreatPersonBar", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.setStackedBarColors(
            "GreatGeneralBar-w", InfoBarTypes.INFOBAR_RATE, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        screen.setStackedBarColors(
            "GreatGeneralBar-w",
            InfoBarTypes.INFOBAR_RATE_EXTRA,
        ...
        screen.setStackedBarColors(
            "GreatGeneralBar-w", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.setStackedBarColors(
            "ResearchBar-w", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.setStackedBarColors(
            "GreatPersonBar-w", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.addStackedBarGFC(
            ...
            iCityCenterRow1X,
            iCityCenterRow1Y - 4,
            xResolution - (iCityCenterRow1X * 2),
            iStackBarHeight,
            InfoBarTypes.NUM_INFOBAR_TYPES,
            WidgetTypes.WIDGET_HELP_POPULATION,
            -1,
            -1,
        )
        screen.setStackedBarColors(
        ...
        screen.setStackedBarColorsAlpha(
            "PopulationBar",
            InfoBarTypes.INFOBAR_RATE,
            gc.getYieldInfo(YieldTypes.YIELD_FOOD).getColorType(),
            0.8,
        ...
        screen.setStackedBarColors(
            "PopulationBar", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.addStackedBarGFC(
            ...
            iCityCenterRow2X,
            iCityCenterRow2Y - 4,
            xResolution - (iCityCenterRow2X * 2),
            iStackBarHeight,
            InfoBarTypes.NUM_INFOBAR_TYPES,
            WidgetTypes.WIDGET_HELP_PRODUCTION,
            -1,
            -1,
        )
        screen.setStackedBarColors(
        ...
        screen.setStackedBarColors(
            "ProductionBar", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.setStackedBarColors(
            "GreatPeopleBar", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.addStackedBarGFC(
            ...
            iStackBarHeight,
            InfoBarTypes.NUM_INFOBAR_TYPES,
            WidgetTypes.WIDGET_HELP_CULTURE,
            -1,
            -1,
        )
        screen.setStackedBarColors(
        ...
        screen.setStackedBarColors(
            "CultureBar", InfoBarTypes.INFOBAR_RATE, gc.getInfoTypeForString("COLOR_CULTURE_RATE")
        )
        screen.setStackedBarColors(
            "CultureBar", InfoBarTypes.INFOBAR_RATE_EXTRA, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        screen.setStackedBarColors(
            "CultureBar", InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY")
        )
        ...
        screen.addStackedBarGFC(
            ...
            iStackBarHeight,
            InfoBarTypes.NUM_INFOBAR_TYPES,
            WidgetTypes.WIDGET_HELP_NATIONALITY,
            -1,
            -1,
        )
        ...
        screen.setButtonGFC(
            ...
            32,
            32,
            WidgetTypes.WIDGET_CITY_SCROLL,
            -1,
            -1,
        ...
        screen.setButtonGFC(
            ...
            u"",
            "",
            315 + (xResolution - (iMultiListXL + iMultiListXR) - 68),
            yResolution - 171,
            32,
            32,
            WidgetTypes.WIDGET_PLOT_LIST_SHIFT,
            -1,
            -1,
            ButtonStyles.BUTTON_STYLE_ARROW_LEFT,
        )
        ...
        screen.setButtonGFC(
            ...
            u"",
            "",
            298 + (xResolution - (iMultiListXL + iMultiListXR) - 34),
            yResolution - 171,
            32,
            32,
            WidgetTypes.WIDGET_PLOT_LIST_SHIFT,
        ...
        sBUGOptionsScreenButton = ArtFileMgr.getInterfaceArtInfo(
            "BUG_OPTIONS_SCREEN_BUTTON"
        ).getPath()
        screen.setImageButton(
        ...
        for i in range(gc.getNumPromotionInfos()):
            ...
            screen.addDDSGFC(
                ...
                24,
                WidgetTypes.WIDGET_ACTION,
                gc.getPromotionInfo(i).getActionInfoIndex(),
                -1,
            )
            screen.hide(szName)
            ...
            screen.addDDSGFC(
                ...
                180,
                yResolution - 18,
                self.PLE.CFG_INFOPANE_BUTTON_SIZE,
                self.PLE.CFG_INFOPANE_BUTTON_SIZE,
                WidgetTypes.WIDGET_ACTION,
                gc.getPromotionInfo(i).getActionInfoIndex(),
                -1,
        ...
        screen.addPanel(
            "ScoreBackground", u"", u"", True, False, 0, 0, 0, 0, PanelStyles.PANEL_STYLE_HUD_HELP
        )
        ...
        for i in range(gc.getMAX_PLAYERS()):
            ...
            screen.setText(
                ...
                -0.3,
                FontTypes.SMALL_FONT,
                WidgetTypes.WIDGET_CONTACT_CIV,
                i,
                -1,
            )
            screen.hide(szName)
                ...
                # BUG - Options - start
                    ...
                    if BugPath.isMac():
                        acOutput = localText.getText(
                            "TXT_KEY_BUG_OPTIONS_KEY_REMINDER_MAC", (BugPath.getModName(),)
                        )
                    else:
                        acOutput = localText.getText(
                            "TXT_KEY_BUG_OPTIONS_KEY_REMINDER", (BugPath.getModName(),)
                        )
                    # screen.modifyLabel( "EndTurnText", acOutput, CvUtil.FONT_CENTER_JUSTIFY )
                    screen.setEndTurnState("EndTurnText", acOutput)
                    bShow = True
    ...
    def updatePercentButtons(self):
        ...
        if (
            ...
            or (pHeadSelectedCity.getOwner() == gc.getGame().getActivePlayer())
            ...
            if (
                CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_HIDE_ALL
                and CyInterface().getShowInterface() != InterfaceVisibility.INTERFACE_MINIMAP_ONLY
                and CyInterface().getShowInterface()
                ...
                for iI in range(CommerceTypes.NUM_COMMERCE_TYPES):
                    ...
                    if gc.getActivePlayer().isCommerceFlexible(eCommerce) or (
                        CyInterface().isCityScreenUp()
                        and (eCommerce == CommerceTypes.COMMERCE_GOLD)
                    ):
                        # BUG - Min/Max Sliders - start
                        bEnable = gc.getActivePlayer().isCommerceFlexible(eCommerce)
                        if (
                            MainOpt.isShowMinMaxCommerceButtons()
    ...
    def updateEndTurnButton(self):
        ...
        if (
            CyInterface().shouldDisplayEndTurnButton()
    ...
    def updatePlotListButtons_Orig(self, screen):
        ...
        BugUtil.debug(
            "updatePlotListButtons_Orig - column %i, offset %i",
        ...
        if (
            ...
            BugUtil.debug(
                "updatePlotListButtons_Orig - iCount(%i), iSkipped(%i)", iCount, iSkipped
            )
            ...
            for i in range(CyInterface().getNumCachedInterfacePlotUnits()):
                ...
                if pLoopUnit:
                    ...
                    if (iCount == 0) and (CyInterface().getPlotListColumn() > 0):
                        ...
                        iCount == (self.numPlotListRows() * self.numPlotListButtonsPerRow() - 1)
                    ) and (
                    ...
                    if (iCount >= 0) and (
                        iCount < self.numPlotListButtons() * gc.getMAX_PLOT_LIST_ROWS()
                    ):
                        if (
                            pLoopUnit.getTeam() != gc.getGame().getActiveTeam()
                        ) or pLoopUnit.isWaiting():
                            szFileName = ArtFileMgr.getInterfaceArtInfo(
                                "OVERLAY_FORTIFY"
                            ).getPath()
                        ...
                        screen.changeImageButton(
                            szString, gc.getUnitInfo(pLoopUnit.getUnitType()).getButton()
                        )
                        ...
                        if bEnable:
                            ...
                            y = (
                                ...
                                - 169
                                + (
                                    iCount / self.numPlotListButtonsPerRow()
                                    - self.numPlotListRows()
                                    + 1
                                )
                                * 34
                            ...
                            self.PLE._displayUnitPlotList_Dot(
                                screen, pLoopUnit, szString, iCount, x, y + 4
                            )
                            self.PLE._displayUnitPlotList_Promo(screen, pLoopUnit, szString)
                            self.PLE._displayUnitPlotList_Upgrade(
                                screen, pLoopUnit, szString, iCount, x, y
                            )
                            self.PLE._displayUnitPlotList_Mission(
                                screen, pLoopUnit, szString, iCount, x, y - 22, 12
                            )
    ...
    def updateSelectionButtons(self):
        ...
        if not CyEngine().isGlobeviewUp() and pHeadSelectedCity:
            ...
            if (
                ...
                for i in range(g_NumUnitClassInfos):
                    ...
                    if pHeadSelectedCity.canTrain(eLoopUnit, False, True):
                        szButton = gc.getPlayer(pHeadSelectedCity.getOwner()).getUnitButton(
                            eLoopUnit
                        )
                        ...
                        if not pHeadSelectedCity.canTrain(eLoopUnit, False, False):
                            screen.disableMultiListButton(
                                "BottomButtonContainer", iRow, iCount, szButton
                            )
                ...
                screen.selectMultiList(
                    "BottomButtonContainer", CyInterface().getCityTabSelectionRow()
                )
            ...
            if CyInterface().getInterfaceMode() == InterfaceModeTypes.INTERFACEMODE_SELECTION:
                ...
                if (
                    pHeadSelectedUnit.getOwner() == gc.getGame().getActivePlayer()
                    ...
                    for i in actions:
                        ...
                        if pHeadSelectedUnit.isActionRecommended(
                            i
                    ...
                    if CyInterface().canCreateGroup():
                        screen.appendMultiListButton(
                            ...
                            ArtFileMgr.getInterfaceArtInfo(
                                "INTERFACE_BUTTONS_CREATEGROUP"
                            ).getPath(),
                            0,
                            WidgetTypes.WIDGET_CREATE_GROUP,
                            -1,
                            -1,
                            False,
                        )
                    ...
                    if CyInterface().canDeleteGroup():
                        screen.appendMultiListButton(
                            "BottomButtonContainer",
                            ArtFileMgr.getInterfaceArtInfo(
                                "INTERFACE_BUTTONS_SPLITGROUP"
                            ).getPath(),
                            0,
                            WidgetTypes.WIDGET_DELETE_GROUP,
                            -1,
                            -1,
                            False,
                        )
                    ...
                    iUnitInquisitor = CvUtil.findInfoTypeNum(
                        gc.getUnitInfo, gc.getNumUnitInfos(), "UNIT_PROSECUTOR"
                    )
                        ...
                        if pPlot.isCity():
                            ...
                            if pCity.getOwner() == pUnit.getOwner():
                                ...
                                for iReligionLoop in range(gc.getNumReligionInfos()):
                                    ...
                                    if pCity.isHasReligion(
                                        iReligionLoop
                                    ) and not pCity.isHolyCityByType(iReligionLoop):
                                        # City's religion is not player's state
                                        if pPlayer.getStateReligion() != iReligionLoop:
                                            screen.appendMultiListButton(
                                                "BottomButtonContainer",
                                                ArtFileMgr.getInterfaceArtInfo(
                                                    "INTERFACE_PERSECUTION"
                                                ).getPath(),
                                                0,
                                                WidgetTypes.WIDGET_GENERAL,
                                                666,
                    ...
                    # Great Saint
                    iUnitProphet = CvUtil.findInfoTypeNum(
                    ...
                    if iUnitProphet == pUnit.getUnitType():
                        ...
                        if pPlayer.getStateReligion() > -1:
                            screen.appendMultiListButton(
                                "BottomButtonContainer",
                                ArtFileMgr.getInterfaceArtInfo("INTERFACE_SAINT").getPath(),
                                0,
                                WidgetTypes.WIDGET_GENERAL,
                                1618,
                                1618,
    ...
    def updateResearchButtons(self):
        ...
        i = 0
        if (
            CyInterface().shouldShowResearchButtons()
            and CyInterface().getShowInterface() == InterfaceVisibility.INTERFACE_SHOW
        ):
            iCount = 0
    ...
    def updateGameDataStrings(self):
        ...
        if (
            ...
            if gc.getPlayer(ePlayer).isAlive():
                ...
                if ClockOpt.isEnabled() and ClockOpt.isShowEra():
                    ...
                    if ClockOpt.isUseEraColor():
                        iEraColor = ClockOpt.getEraColor(
                            gc.getEraInfo(gc.getPlayer(ePlayer).getCurrentEra()).getType()
                        )
                        if iEraColor >= 0:
                ...
                if (
                    not CyInterface().isCityScreenUp()
                    and gc.getPlayer(ePlayer).getCombatExperience() > 0
                ):
                    eCombatXPButton = u"<font=2>%c</font>" % (
                        CyGame().getSymbolID(FontSymbols.POWER_CHAR) + 11
                    )
                    eCombatXPText = (
                        ": "
                ...
                if (
                    ...
                    and not (gc.getPlayer(ePlayer).isAnarchy())
                ...
                if gc.getPlayer(ePlayer).isAnarchy():
                    ...
                    researchProgress = gc.getTeam(
                        gc.getPlayer(ePlayer).getTeam()
                    ).getResearchProgress(gc.getPlayer(ePlayer).getCurrentResearch())
                    overflowResearch = (
                        gc.getPlayer(ePlayer).getOverflowResearch()
                    ...
                    if iFirst == 1:
                        screen.setBarPercentage(
                            szResearchBar,
                            InfoBarTypes.INFOBAR_RATE,
                            (float(researchRate) / float(researchCost)),
                        )
                    else:
                        screen.setBarPercentage(
                            szResearchBar,
                            InfoBarTypes.INFOBAR_RATE,
                            ((float(researchRate) / float(researchCost))) / (1 - iFirst),
                        )
                    ...
                    if MainOpt.isShowpBarTickMarks():
                        if szResearchBar == "ResearchBar":
                            self.pBarResearchBar_n.drawTickMarks(
                                screen,
                                researchProgress + overflowResearch,
                                researchCost,
                                researchRate,
                                researchRate,
                                False,
                            ...
                            self.pBarResearchBar_w.drawTickMarks(
                                screen,
                                researchProgress + overflowResearch,
                                researchCost,
                                researchRate,
    ...
    def updateGreatPersonBar(self, screen):
        if not CyInterface().isCityScreenUp() and MainOpt.isShowGPProgressBar():
            ...
            szText = GPUtil.getGreatPeopleText(
                pGPCity,
                iGPTurns,
                GP_BAR_WIDTH,
            ...
            if pGPCity:
                ...
                if fFirst == 1:
                    screen.setBarPercentage(
                        szGreatPersonBar, InfoBarTypes.INFOBAR_RATE, fRate / fThreshold
                    )
                else:
                    screen.setBarPercentage(
                        szGreatPersonBar,
        ...
        if ClockOpt.isEnabled():
            ...
            if bShowPercentComplete:
                ...
                g_szTimeText += u"%2.2f%%" % (
                    100
                    * (
                        float(gc.getGame().getElapsedGameTurns())
            ...
            """
            g_szTimeText = (
                localText.getText("TXT_KEY_TIME_TURN", (CyGame().getGameTurn(),))
                + u" - "
    ...
    def updateCityScreen(self):
        ...
        if CyInterface().isCityScreenUp():
            if pHeadSelectedCity:
                ...
                iProductionDiffNoFood = pHeadSelectedCity.getCurrentProductionDifference(
                    True, True
                )
                iProductionDiffJustFood = (
                    pHeadSelectedCity.getCurrentProductionDifference(False, True)
                ...
                if (
                    CityUtil.willGrowThisTurn(pHeadSelectedCity)
                    or (iFoodDifference != 0)
                    or not (pHeadSelectedCity.isFoodProduction())
                ):
                    if CityUtil.willGrowThisTurn(pHeadSelectedCity):
                        szBuffer = text("INTERFACE_CITY_GROWING")
                        ...
                        if CityScreenOpt.isShowFoodAssist():
                            ...
                            if iTurnsToStarve > 1:
                                szBuffer = text("INTERFACE_CITY_SHRINKING", iTurnsToStarve)
                            else:
                    ...
                    if CityScreenOpt.isShowFoodAssist():
                        ...
                        if iFoodYield == iFoodEaten:
                            szBuffer = localText.getText(
                                "INTERFACE_CITY_FOOD_STAGNATE", (iFoodYield, iFoodEaten)
                            )
                        elif iFoodYield > iFoodEaten:
                            szBuffer = localText.getText(
                                "INTERFACE_CITY_FOOD_GROW",
                                (iFoodYield, iFoodEaten, iFoodYield - iFoodEaten),
                            )
                        else:
                            szBuffer = localText.getText(
                                "INTERFACE_CITY_FOOD_SHRINK",
                                (iFoodYield, iFoodEaten, iFoodYield - iFoodEaten),
                            )
                    else:
                        szBuffer = u"%d%c - %d%c" % (
                ...
                if (pHeadSelectedCity.badHealth(False) > 0) or (
                    ...
                    screen.setLabel(
                        ...
                        szBuffer,
                        CvUtil.FONT_LEFT_JUSTIFY,
                        xResolution - iCityCenterRow1X + 6,
                        iCityCenterRow1Y,
                        -0.3,
                        FontTypes.GAME_FONT,
                ...
                if iFoodDifference < 0:
                    ...
                    if iFirst == 1:
                        screen.setBarPercentage(
                            "PopulationBar",
                            InfoBarTypes.INFOBAR_RATE_EXTRA,
                            (float(iExtraFood) / float(pHeadSelectedCity.growthThreshold())),
                        )
                    else:
                        screen.setBarPercentage(
                            "PopulationBar",
                    ...
                    iFirst = float(pHeadSelectedCity.getFood()) / float(
                    ...
                    if iFirst == 1:
                        screen.setBarPercentage(
                            "PopulationBar",
                            InfoBarTypes.INFOBAR_RATE,
                            (float(iFoodDifference) / float(pHeadSelectedCity.growthThreshold())),
                        )
                    else:
                        screen.setBarPercentage(
                            "PopulationBar",
                ...
                # BUG - Progress Bar - Tick Marks - start
                if MainOpt.isShowpBarTickMarks():
                    self.pBarPopulationBar.drawTickMarks(
                        screen,
                        pHeadSelectedCity.getFood(),
                        pHeadSelectedCity.growthThreshold(),
                        iFoodDifference,
                        iFoodDifference,
                        False,
                ...
                if pHeadSelectedCity.getOrderQueueLength() > 0:
                    ...
                    # BUG - Whip Assist - start
                        ...
                        if CityScreenOpt.isShowWhipAssist() and pHeadSelectedCity.canHurry(
                            HURRY_WHIP, False
                        ):
                            iHurryPop = pHeadSelectedCity.hurryPopulation(HURRY_WHIP)
                            iOverflow = (
                                pHeadSelectedCity.hurryProduction(HURRY_WHIP)
                                - pHeadSelectedCity.productionLeft()
                            )
                            if CityScreenOpt.isWhipAssistOverflowCountCurrentProduction():
                                iOverflow += pHeadSelectedCity.getCurrentProductionDifference(
                                    False, True
                                )
                            iMaxOverflow = max(
                            ...
                            iBaseModifier = pHeadSelectedCity.getBaseYieldRateModifier(
                                YieldTypes.YIELD_PRODUCTION, 0
                            )
                            iTotalModifier = pHeadSelectedCity.getBaseYieldRateModifier(
                                YieldTypes.YIELD_PRODUCTION, iItemModifier
                            )
                            iLost *= iBaseModifier
                        ...
                        elif CityScreenOpt.isShowWhipAssist() and pHeadSelectedCity.canHurry(
                            HURRY_BUY, False
                        ):
                ...
                if pHeadSelectedCity.isProductionProcess():
                    szBuffer = u"%d%c" % (
                        pHeadSelectedCity.getYieldRate(YieldTypes.YIELD_PRODUCTION),
                ...
                if (pHeadSelectedCity.happyLevel() >= 0) or (
                    ...
                    if (
                        CityScreenOpt.isShowAngerCounter()
                        and pHeadSelectedCity.getTeam() == gc.getGame().getActiveTeam()
                    ):
                        iAngerTimer = max(
                            pHeadSelectedCity.getHurryAngerTimer(),
                ...
                if not (pHeadSelectedCity.isProductionProcess()):
                    ...
                    screen.setBarPercentage(
                        "ProductionBar", InfoBarTypes.INFOBAR_STORED, float(iStored) / iNeeded
                    )
                    if iNeeded > iStored:
                        screen.setBarPercentage(
                            "ProductionBar",
                    ...
                    if iNeeded > iStored + iProductionDiffNoFood:
                        ...
                        screen.setBarPercentage(
                            "ProductionBar", InfoBarTypes.INFOBAR_RATE_EXTRA, 0.0
                        )
                    ...
                    if MainOpt.isShowpBarTickMarks():
                        ...
                        self.pBarProductionBar.drawTickMarks(
                            screen,
                        ...
                        if pHeadSelectedCity.canHurry(HURRY_WHIP, False):
                            iRate = pHeadSelectedCity.hurryProduction(
                                HURRY_WHIP
                            ) / pHeadSelectedCity.hurryPopulation(HURRY_WHIP)
                            self.pBarProductionBar_Whip.drawTickMarks(
                                screen,
                                pHeadSelectedCity.getProduction(),
                                pHeadSelectedCity.getProductionNeeded(),
                                iFirst,
                ...
                for i in range(CommerceTypes.NUM_COMMERCE_TYPES):
                    ...
                    if (
                        gc.getPlayer(pHeadSelectedCity.getOwner()).isCommerceFlexible(eCommerce)
                    ) or (eCommerce == CommerceTypes.COMMERCE_GOLD):
                        szBuffer = u"%d.%02d %c" % (
                            pHeadSelectedCity.getCommerceRate(eCommerce),
                        ...
                        screen.setLabel(
                            ...
                            -0.3,
                            FontTypes.SMALL_FONT,
                            WidgetTypes.WIDGET_COMMERCE_MOD_HELP,
                            eCommerce,
                            -1,
                        )
                        screen.show(szName)
                ...
                if CityScreenOpt.isShowRawYields():
                    ...
                    screen.setState(
                        "RawYieldsFood1", g_bYieldView and g_iYieldType == YieldTypes.YIELD_FOOD
                    )
                    ...
                    screen.setState(
                        "RawYieldsWorkedTiles4", g_iYieldTiles == RawYields.WORKED_TILES
                    )
                ...
                for i in range(gc.getNumBuildingInfos()):
                    ...
                    if gc.getBuildingInfo(i).isGraphicalOnly():
                        continue  # Absinthe: do not display hidden buildings - plague for example
                        ...
                        for k in range(pHeadSelectedCity.getNumBuilding(i)):
                            ...
                            if pHeadSelectedCity.getNumActiveBuilding(i) > 0:
                                ...
                                for j in range(YieldTypes.NUM_YIELD_TYPES):
                                    iYield = gc.getBuildingInfo(i).getYieldChange(
                                        j
                                    ) + pHeadSelectedCity.getNumBuilding(
                                        i
                            ...
                            for j in range(CommerceTypes.NUM_COMMERCE_TYPES):
                                iCommerce = pHeadSelectedCity.getBuildingCommerceByBuilding(
                                    j, i
                ...
                for i in range(gc.getDefineINT("MAX_TRADE_ROUTES")):
                    ...
                    if pLoopCity and pLoopCity.getOwner() >= 0:
                        ...
                        szLeftBuffer = u"<color=%d,%d,%d,%d>%s</color>" % (
                            player.getPlayerTextColorR(),
                            player.getPlayerTextColorG(),
                            player.getPlayerTextColorB(),
                            player.getPlayerTextColorA(),
                            pLoopCity.getName(),
                        )
                        szRightBuffer = u""
                        ...
                        if not bShowRawYields:
                            ...
                            screen.setTableText(
                                ...
                                "<font=1>" + szLeftBuffer + "</font>",
                                "",
                                WidgetTypes.WIDGET_HELP_TRADE_ROUTE_CITY,
                                i,
                                -1,
                                CvUtil.FONT_LEFT_JUSTIFY,
                            )
                ...
                if CityScreenOpt.isShowOnlyPresentReligions():
                    ...
                    # iButtonSpace = 0
                        ...
                        iMaxWidth = 240
                        iMaxButtons = int(
                            round(iCountReligions / 2.0, 0)
                        )  # int(round(gc.getNumReligionInfos() / 2.0, 0))
                        iButtonSize = iMaxWidth / iMaxButtons
                        iButtonSpace = (iMaxWidth - (iButtonSize * iMaxButtons)) // (
                            iMaxButtons - 1
                        )
                    else:
                        iMaxButtons = int(
                    ...
                    for ii in range(iCountReligions):
                        ...
                        screen.setImageButton(
                            ...
                            iButtonSize,
                            iButtonSize,
                            WidgetTypes.WIDGET_HELP_RELIGION_CITY,
                            i,
                            -1,
                        )
                ...
                if CityScreenOpt.isShowOnlyPresentCorporations():
                    ...
                    # iButtonSpace = 0
                        ...
                        iMaxWidth = 240
                        iMaxButtons = int(
                            round(iCountCorporations / 2.0, 0)
                        )  # int(round(gc.getNumCorporationInfos() / 2.0, 0))
                        iButtonSize = iMaxWidth / iMaxButtons
                        iButtonSpace = (iMaxWidth - (iButtonSize * iMaxButtons)) // (
                            iMaxButtons - 1
                        )
                    ...
                    for ii in range(iCountCorporations):
                        ...
                        screen.setImageButton(
                            ...
                            iButtonSize,
                            iButtonSize,
                            WidgetTypes.WIDGET_HELP_CORPORATION_CITY,
                            i,
                            -1,
                        )
                        screen.enable(szName, bEnable)
                    ...
                    for i in range(gc.getNumCorporationInfos()):
                        ...
                        if pHeadSelectedCity.isHasCorporation(i):
                            if pHeadSelectedCity.isHeadquartersByType(i):
                                szTempBuffer = u"%c" % (
                                    gc.getCorporationInfo(i).getHeadquarterChar()
                                )
                                szName = "CorporationHeadquarterDDS" + str(i)
                                screen.show(szName)
                            else:
                            ...
                            for j in range(CommerceTypes.NUM_COMMERCE_TYPES):
                                iCommerce = pHeadSelectedCity.getCorporationCommerceByCorporation(
                                    j, i
                                )
                    ...
                    if gc.getPlayer(h).isAlive():
                        ...
                        if fPercent != 0:
                            ...
                            if iRemainder == 1:
                                ...
                                screen.setBarPercentage(
                                    "NationalityBar", iWhichBar, fPercent / (1 - iRemainder)
                                )
                            iRemainder += fPercent
                            iWhichBar += 1
                        ...
                        szTempBuffer = u" (%d%%)" % (
                            (
                                (
                                    ...
                                    - pHeadSelectedCity.getDefenseDamage()
                                )
                                * 100
                            )
                            / gc.getMAX_CITY_DEFENSE_DAMAGE()
                ...
                if pHeadSelectedCity.getCultureLevel != CultureLevelTypes.NO_CULTURELEVEL:
                    iRate = pHeadSelectedCity.getCommerceRateTimes100(
                ...
                if (pHeadSelectedCity.getGreatPeopleProgress() > 0) or (
                    ...
                    iFirst = float(pHeadSelectedCity.getGreatPeopleProgress()) / float(
                        gc.getPlayer(pHeadSelectedCity.getOwner()).greatPeopleThreshold(False)
                    )
                    ...
                    if iFirst == 1:
                        screen.setBarPercentage(
                            ...
                            InfoBarTypes.INFOBAR_RATE,
                            (
                                float(pHeadSelectedCity.getGreatPeopleRate())
                                / float(
                                    gc.getPlayer(
                                        pHeadSelectedCity.getOwner()
                                    ).greatPeopleThreshold(False)
                                )
                            ),
                        )
                    else:
                ...
                iFirst = float(
                    pHeadSelectedCity.getCultureTimes100(pHeadSelectedCity.getOwner())
                ) / float(100 * pHeadSelectedCity.getCultureThreshold())
                ...
                if iFirst == 1:
                    screen.setBarPercentage(
                        ...
                        (
                            ...
                            / float(pHeadSelectedCity.getCultureThreshold())
                        ),
                    )
                else:
                    screen.setBarPercentage(
                        ...
                        (
                            (
                                float(
                                    pHeadSelectedCity.getCommerceRate(
                                        CommerceTypes.COMMERCE_CULTURE
                                    )
                                )
                                / float(pHeadSelectedCity.getCultureThreshold())
            ...
            for i in range(iOrders):
                ...
                if CyInterface().getOrderNodeType(i) == OrderTypes.ORDER_TRAIN:
                    ...
                    szRightBuffer = (
                        "("
                        + str(
                            pHeadSelectedCity.getUnitProductionTurnsLeft(
                ...
                # BUG - Production Decay - end
                    ...
                    szRightBuffer = (
                        "("
                        + str(
                            pHeadSelectedCity.getBuildingProductionTurnsLeft(
                                CyInterface().getOrderNodeData1(i), i
                            )
                        )
                        + ")"
                ...
                # BUG - Production Decay - end
                    ...
                    szRightBuffer = (
                        "("
                        + str(
                            pHeadSelectedCity.getProjectProductionTurnsLeft(
                                CyInterface().getOrderNodeData1(i), i
                            )
                        )
                        + ")"
                ...
                if iNodeCount > 1:
                    for i in range(iNodeCount):
                        ...
                        if gc.getMissionInfo(pSelectedGroup.getMissionType(i)).isBuild():
                            ...
                            szLeftBuffer = u"%s..." % (
                                gc.getMissionInfo(
                                    pSelectedGroup.getMissionType(i)
                                ).getDescription()
                            )
                ...
                while i > -1:
                    ...
                    if (
                        ...
                        while j > -1:
                            ...
                            if (
                                not CyInterface().isScoresMinimized()
            ...
            if bHasOptions:
                ...
                for iTmp in range(iNumOptions):
                    ...
                    screen.setText(
                        ...
                        -0.3,
                        FontTypes.SMALL_FONT,
                        WidgetTypes.WIDGET_GLOBELAYER_OPTION,
                        iOption,
                        -1,
                    )
                    screen.show(szName)
    ...
    def createMinimapButtons(self):
        ...
        screen.addCheckBoxGFC(
            ...
            28,
            WidgetTypes.WIDGET_ACTION,
            gc.getControlInfo(ControlTypes.CONTROL_STABILITY_OVERLAY).getActionInfoIndex(),
            -1,
            ButtonStyles.BUTTON_STYLE_LABEL,
        )
