...
class CvPediaCivic:
    ...
    def interfaceScreen(self, iCivic):
        ...
        # Header...
        szHeader = (
            u"<font=4b>" + gc.getCivicInfo(self.iCivic).getDescription().upper() + u"</font>"
        )
        ...
        screen.setText(
            ...
            CivilopediaPageTypes.CIVILOPEDIA_PAGE_CIVIC,
            -1,
        )
        ...
        screen.addDDSGFC(
            self.top.getNextWidgetName(),
            gc.getCivicInfo(self.iCivic).getButton(),
    ...
    def placeStats(self):
        ...
        if iCivicOptionType != -1:
            screen.appendListBoxString(
                panelName,
                u"<font=3>"
                + gc.getCivicOptionInfo(iCivicOptionType).getDescription().upper()
                + u"</font>",
                WidgetTypes.WIDGET_GENERAL,
                0,
                0,
        ...
        if pUpkeepInfo:
            screen.appendListBoxString(
                panelName,
                u"<font=3>" + pUpkeepInfo.getDescription().upper() + u"</font>",
                WidgetTypes.WIDGET_GENERAL,
                0,
                0,
                CvUtil.FONT_LEFT_JUSTIFY,
