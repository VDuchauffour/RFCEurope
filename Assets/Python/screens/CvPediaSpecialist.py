...
class CvPediaSpecialist:
    ...
    def interfaceScreen(self, iSpecialist):
        ...
        szHeader = (
            u"<font=4b>"
            + gc.getSpecialistInfo(self.iSpecialist).getDescription().upper()
            + u"</font>"
        )
        ...
        screen.setText(
            ...
            CivilopediaPageTypes.CIVILOPEDIA_PAGE_SPECIALIST,
            -1,
        )
        ...
        screen.addDDSGFC(
            self.top.getNextWidgetName(),
            gc.getSpecialistInfo(self.iSpecialist).getButton(),
    ...
    def placeSpecial(self):
        ...
        screen.addPanel(
            panelName,
            localText.getText("TXT_KEY_PEDIA_YIELDS", ()),
            "",
            True,
            False,
            self.X_SPECIAL,
