...
class CvPediaUnit:
    ...
    def interfaceScreen(self, iUnit):
        ...
        screen.setText(
            ...
            CivilopediaPageTypes.CIVILOPEDIA_PAGE_UNIT,
            iUnit,
        )
        ...
        screen.addDDSGFC(
            self.top.getNextWidgetName(),
            gc.getUnitInfo(self.iUnit).getButton(),
        ...
        screen.addUnitGraphicGFC(
            ...
            -1,
            -1,
            self.X_ROTATION_UNIT_ANIMATION,
            self.Z_ROTATION_UNIT_ANIMATION,
    ...
    def placeStats(self):
        ...
        if iCombatType != -1:
            ...
            screen.setText(
                self.top.getNextWidgetName(),
                "",
                u"<font=3>" + gc.getUnitCombatInfo(iCombatType).getDescription() + u"</font>",
                CvUtil.FONT_LEFT_JUSTIFY,
                self.X_STATS_PANE + 37,
                self.Y_STATS_PANE - 35,
                0,
                FontTypes.TITLE_FONT,
                WidgetTypes.WIDGET_PEDIA_JUMP_TO_UNIT_COMBAT,
                iCombatType,
        ...
        if (
            gc.getUnitInfo(self.iUnit).getAirCombat() > 0
            and gc.getUnitInfo(self.iUnit).getCombat() == 0
        ):
        ...
        if (
            gc.getUnitInfo(self.iUnit).getProductionCost() >= 0
            and not gc.getUnitInfo(self.iUnit).isFound()
        ):
            szName = self.top.getNextWidgetName()
    ...
    def placeRequires(self):
        ...
        if iPrereq >= 0:
            screen.attachImageButton(
                panelName,
                "",
                gc.getTechInfo(iPrereq).getButton(),
        ...
        if iPrereq >= 0:
            ...
            screen.attachImageButton(
                panelName,
                "",
                gc.getBonusInfo(iPrereq).getButton(),
                GenericButtonSizes.BUTTON_SIZE_CUSTOM,
        ...
        for j in range(gc.getNUM_UNIT_PREREQ_OR_BONUSES()):
            ...
            if eBonus > -1:
                ...
                screen.attachImageButton(
                    panelName,
                    "",
                    gc.getBonusInfo(eBonus).getButton(),
                    GenericButtonSizes.BUTTON_SIZE_CUSTOM,
                    WidgetTypes.WIDGET_PEDIA_JUMP_TO_BONUS,
                    eBonus,
                    -1,
        ...
        if iPrereq >= 0:
            screen.attachImageButton(
                panelName,
                "",
                gc.getReligionInfo(iPrereq).getButton(),
                GenericButtonSizes.BUTTON_SIZE_CUSTOM,
        ...
        if iPrereq >= 0:
            screen.attachImageButton(
                panelName,
                "",
                gc.getBuildingInfo(iPrereq).getButton(),
                GenericButtonSizes.BUTTON_SIZE_CUSTOM,
        ...
        if iPrereq >= 0:
            screen.attachImageButton(
                panelName,
                "",
                gc.getCorporationInfo(iPrereq).getButton(),
                GenericButtonSizes.BUTTON_SIZE_CUSTOM,
                WidgetTypes.WIDGET_PEDIA_JUMP_TO_CORPORATION,
                iPrereq,
                -1,
                False,
            )
    ...
    def placeUpgradesTo(self):
        ...
        screen.addPanel(
            ...
            False,
            True,
            self.X_UPGRADES_TO_PANE,
            self.Y_UPGRADES_TO_PANE,
            self.W_UPGRADES_TO_PANE,
            self.H_UPGRADES_TO_PANE,
            PanelStyles.PANEL_STYLE_BLUE50,
        )
    ...
    def placeSpecial(self):
        ...
        screen.addMultilineText(
            listName,
            szSpecialText,
            self.X_SPECIAL_PANE + 5,
            self.Y_SPECIAL_PANE + 30,
            self.W_SPECIAL_PANE - 10,
            self.H_SPECIAL_PANE - 35,
            WidgetTypes.WIDGET_GENERAL,
            -1,
            -1,
            CvUtil.FONT_LEFT_JUSTIFY,
    ...
    def placeHistory(self):
        ...
        screen.addMultilineText(
            textName,
            gc.getUnitInfo(self.iUnit).getCivilopedia(),
            self.X_HISTORY_PANE + 15,
            self.Y_HISTORY_PANE + 40,
            self.W_HISTORY_PANE - (15 * 2),
    ...
    def placePromotions(self):
        ...
        screen.addMultiListControlGFC(
            rowListName,
            "",
            self.X_PROMO_PANE + 15,
            self.Y_PROMO_PANE + 40,
            self.W_PROMO_PANE - 20,
            self.H_PROMO_PANE - 40,
            1,
            self.PROMOTION_ICON_SIZE,
            self.PROMOTION_ICON_SIZE,
        ...
        for k in range(gc.getNumPromotionInfos()):
            if (
                isPromotionValid(k, self.iUnit, False)
                and not gc.getPromotionInfo(k).isGraphicalOnly()
            ):
                screen.appendMultiListButton(
                    rowListName,
                    gc.getPromotionInfo(k).getButton(),
                    0,
