...
class CvTopCivs:
    ...
    def __init__(self):
        ...
        self.X_LEADER_TITLE_TEXT = (
            500  # iXHeaderPanelRemainingAfterLeader + (iWHeaderPanelRemainingAfterLeader / 2)
        )
    ...
    def showScreen(self):
        ...
        self.screen.setDimensions(
            self.screen.centerX(self.X_SCREEN),
        ...
        # 1 Text
        self.X_INFO_TEXT = (
            self.X_TITLE_TEXT - 260
        )  # self.X_HEADER_PANEL + (self.W_HEADER_PANEL / 2)
            ...
            if gc.getPlayer(iPlayerLoop).isAlive():
                ...
                if szType == text("TXT_KEY_TOPCIVS_TECH"):
                    ...
                    for iTechLoop in range(iNumTotalTechs):
                        ...
                        bPlayerHasTech = gc.getTeam(gc.getPlayer(iPlayerLoop).getTeam()).isHasTech(
                            iTechLoop
                        )
    ...
    def handleInput(self, inputClass):
        ...
        if (
            inputClass.getFunctionName() == "Exit"
