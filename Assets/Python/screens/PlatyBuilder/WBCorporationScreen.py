...
class WBCorporationScreen:
    ...
    def interfaceScreen(self, iPlayerX):
        ...
        screen.setLabel(
            "CorporationHeader",
            "Background",
            "<font=4b>" + CyTranslator().getText("TXT_KEY_CONCEPT_CORPORATIONS", ()) + "</font>",
        ...
        screen.setLabel(
            ...
            "Background",
            "<font=3b>"
            + CyTranslator().getText("TXT_KEY_CORPORATION_HEADQUARTERS", ())
            + "</font>",
            CvUtil.FONT_CENTER_JUSTIFY,
        ...
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_CONCEPT_CORPORATIONS", ()), 9, 9, True
        )
        screen.addPullDownString(
            "CurrentPage",
        ...
        for i in xrange(gc.getNumCorporationInfos()):  # type: ignore
            ...
            if not pHeadquarter.isNone():
                ...
                screen.setTableText(
                    ...
                    2,
                    iRow,
                    "<font=3>" + sColor + pHeadquarter.getName() + "</color></font>",
                    gc.getCivilizationInfo(pHeadquarter.getCivilizationType()).getButton(),
                    WidgetTypes.WIDGET_PYTHON,
                    7200 + iPlayerX,
                    pHeadquarter.getID(),
                    CvUtil.FONT_LEFT_JUSTIFY,
    ...
    def handleInput(self, inputClass):
        ...
        if inputClass.getFunctionName() == "CurrentPage":
            ...
            if inputClass.getButtonType() == WidgetTypes.WIDGET_PYTHON:
                for (loopCity, iPlayerX) in lCities:
                    self.editCorporation(
                        inputClass.getData2(), loopCity, inputClass.getData1() == 8201
                    )
                self.placeCityTable()
