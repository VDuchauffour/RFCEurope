...
class WBPlayerUnits:
    ...
    def interfaceScreen(self, iPlayerX):
        ...
        iX += iWidth
        screen.addDropDownBoxGFC(
            "OwnerType", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        ...
        iX += iWidth
        screen.addDropDownBoxGFC(
            "PlotType", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
        ...
        iX += iWidth
        screen.addDropDownBoxGFC(
            "CopyType", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
        ...
        screen.addPullDownString(
            "CopyType", CyTranslator().getText("TXT_KEY_WB_ACTIVITY", ()), 5, 5, 5 == iCopyType
        )
        ...
        screen.setImageButton(
            "DeleteCurrentCity", sKillButton, 20, iY, 28, 28, WidgetTypes.WIDGET_PYTHON, 1041, -1
        )
        screen.setLabel(
            "DeleteCitiesText",
            "Background",
            "<font=4b>" + CyTranslator().getText("TXT_KEY_WB_CITY_ALL", ()) + "</font>",
            CvUtil.FONT_RIGHT_JUSTIFY,
            screen.getXResolution() / 2 - 35,
            iY,
            -0.1,
            FontTypes.GAME_FONT,
            WidgetTypes.WIDGET_GENERAL,
    ...
    def sortUnits(self):
        ...
        for iPlayerX in xrange(gc.getMAX_PLAYERS()):
            ...
            if iOwnerType == 1 and iPlayerX != iPlayer:
                continue
            if iOwnerType == 2 and pPlayerX.getTeam() != pPlayer.getTeam():
                continue
            if pPlayerX.isAlive():
                ...
                while loopUnit:
                    ...
                    if iCopyType == 1:
                        ...
                        if (
                            loopUnit.getGroupID() != pUnit.getGroupID()
                            or loopUnit.getOwner() != pUnit.getOwner()
                        ):
                            bCopy = False
                    elif iCopyType == 5:
    ...
    def placeCurrentUnit(self):
        ...
        lStatus = [
            ...
            gc.getMissionInfo(MissionTypes.MISSION_SKIP).getButton(),
        ]
        ...
        screen.setTableColumnHeader(
            "WBUnitList", 4, CyTranslator().getText("TXT_KEY_WB_XLEVEL", ()), iColWidth * 1
        )
        screen.setTableColumnHeader(
            "WBUnitList", 5, CyTranslator().getText("[ICON_STRENGTH]", ()), iColWidth * 1
        )
        screen.setTableColumnHeader(
            "WBUnitList", 6, CyTranslator().getText("[ICON_MOVES]", ()), iColWidth * 1
        )
        ...
        for i in lUnits:
            ...
            screen.setTableText(
                ...
                2,
                iRow,
                "<font=3>" + sColor + loopUnit.getName() + "</color></font>",
                loopUnit.getButton(),
                WidgetTypes.WIDGET_PYTHON,
                8300 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                3,
                iRow,
                "<font=3>" + str(loopUnit.getID()) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                8300 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                4,
                iRow,
                "<font=3>" + str(loopUnit.getLevel()) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                8300 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                5,
                iRow,
                "<font=3>" + str(loopUnit.baseCombatStr()) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                8300 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                6,
                iRow,
                "<font=3>" + str(loopUnit.baseMoves()) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                8300 + i[0],
                i[1],
    ...
    def placeCurrentCity(self):
        ...
        screen.setTableColumnHeader(
            "WBCityList", 1, CyTranslator().getText("TXT_KEY_CONCEPT_CITIES", ()), iColWidth * 3
        )
        screen.setTableColumnHeader("WBCityList", 2, "ID", iColWidth * 2)
        screen.setTableColumnHeader(
            "WBCityList", 3, CyTranslator().getText("[ICON_CULTURE]", ()), iColWidth * 2
        )
        screen.setTableColumnHeader(
            "WBCityList", 4, CyTranslator().getText("[ICON_ANGRYPOP]", ()), iColWidth * 1
        )
        screen.setTableColumnHeader(
            "WBCityList", 5, CyTranslator().getText("[ICON_HAPPY]", ()), iColWidth * 1
        )
        screen.setTableColumnHeader(
            "WBCityList", 6, CyTranslator().getText("[ICON_HEALTHY]", ()), iColWidth * 1
        )
        ...
        for i in lCities:
            ...
            screen.setTableText(
                ...
                1,
                iRow,
                "<font=3>" + sColor + loopCity.getName() + "</color></font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                7200 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                2,
                iRow,
                "<font=3>" + str(loopCity.getID()) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                7200 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                iRow,
                "<font=3>"
                + CvPlatyBuilderScreen.CvWorldBuilderScreen().addComma(loopCity.getCulture(i[0]))
                + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                7200 + i[0],
            ...
            screen.setTableInt(
                ...
                4,
                iRow,
                "<font=3>" + str(loopCity.getPopulation()) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                7200 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                5,
                iRow,
                "<font=3>" + str(loopCity.happyLevel() - loopCity.unhappyLevel(0)) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                7200 + i[0],
                i[1],
            ...
            screen.setTableInt(
                ...
                6,
                iRow,
                "<font=3>" + str(loopCity.goodHealth() - loopCity.badHealth(0)) + "</font>",
                "",
                WidgetTypes.WIDGET_PYTHON,
                7200 + i[0],
                i[1],
    ...
    def getCityData(self, pCity):
        ...
        sText += u"\n%s: %d/%d" % (
            CyTranslator().getText("[ICON_FOOD]", ()),
            pCity.getFood(),
        ...
        if iGPRate > 0 or iProgress > 0:
            sText += u"\n%s: %d/%d %+d" % (
                CyTranslator().getText("[ICON_GREATPEOPLE]", ()),
                iProgress,
        ...
        if iMaintenance != 0:
            sText += (
                "\n"
                + CyTranslator().getText("[COLOR_WARNING_TEXT]", ())
                + CyTranslator().getText("INTERFACE_CITY_MAINTENANCE", ())
                + " </color>"
            )
            sText += u"-%d.%02d%c" % (
                iMaintenance / 100,
    ...
    def addPageSwitch(self):
        ...
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_PLAYER_DATA", ()), 0, 0, False
        )
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_TEAM_DATA", ()), 1, 1, False
        )
        screen.addPullDownString(
            "CurrentPage",
            CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_PROJECT", ()),
            2,
            2,
            False,
        )
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_TECH", ()), 3, 3, False
        )
        screen.addPullDownString(
            "CurrentPage",
            CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ())
        ...
        if pCityOwner:
            ...
            if not pCity.isNone():
                screen.addPullDownString(
                    "CurrentPage", CyTranslator().getText("TXT_KEY_WB_CITY_DATA", ()), 9, 9, False
                )
                screen.addPullDownString(
                    "CurrentPage",
                    CyTranslator().getText("TXT_KEY_WB_CITY_DATA2", ()),
                    10,
                    10,
                    False,
                )
                ...
                screen.addPullDownString(
                    ...
                    + " "
                    + CyTranslator().getText("TXT_KEY_WB_PLOT_DATA", ()),
                    12,
                    12,
                    False,
                )
                screen.addPullDownString(
                    ...
                    CyTranslator().getText("TXT_KEY_WB_CITY", ())
                    + " "
                    + CyTranslator().getText("TXT_KEY_CONCEPT_EVENTS", ()),
                    13,
                    13,
                    False,
                )
    ...
    def handleInput(self, inputClass):
        ...
        if sName == "CurrentPage":
            ...
            if iIndex == 0:
                ...
                ).interfaceScreen(pUnitOwner.getUnit(iUnitID))
            elif iIndex == 6:
                ...
                WBCityEditScreen.WBCityEditScreen(
                    CvPlatyBuilderScreen.CvWorldBuilderScreen()
                ).interfaceScreen(pCityOwner.getCity(iCityID))
            elif iIndex == 10:
            ...
            WBUnitScreen.WBUnitScreen(CvPlatyBuilderScreen.CvWorldBuilderScreen()).interfaceScreen(
