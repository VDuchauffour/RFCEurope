...
class WBPromotionScreen:
    ...
    def interfaceScreen(self, pUnitX):
        ...
        screen.addDropDownBoxGFC(
            "OwnerType", 20, 20, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        ...
        screen.addDropDownBoxGFC(
            "CopyType", 20, 50, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
        ...
        screen.addDropDownBoxGFC(
            "PlotType", 20, 80, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
        ...
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_UNIT_DATA", ()), 0, 0, False
        )
        screen.addPullDownString(
            "CurrentPage",
        ...
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_MODIFY", ("",)),
            2,
            2,
            2 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType", CyTranslator().getText("TXT_KEY_WB_CITY_ADD", ()), 1, 1, 1 == iChangeType
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_CITY_REMOVE", ()),
            0,
            0,
            0 == iChangeType,
        )
