...
class WBReligionScreen:
    ...
    def interfaceScreen(self, iPlayerX):
        ...
        screen.setLabel(
            ...
            "Background",
            "<font=3b>"
            + CyTranslator().getText("TXT_KEY_RELIGION_SCREEN_HOLY_CITY", ())[:-1]
            + "</font>",
            CvUtil.FONT_CENTER_JUSTIFY,
            screen.getXResolution() / 8,
            self.iTable_Y - 30,
            -0.1,
            FontTypes.TITLE_FONT,
            WidgetTypes.WIDGET_GENERAL,
        ...
        screen.setLabel(
            "StateReligionHeader",
            "Background",
            "<font=3b>" + CyTranslator().getText("TXT_KEY_WB_STATE_RELIGION", ()) + "</font>",
            CvUtil.FONT_CENTER_JUSTIFY,
            screen.getXResolution() / 8,
        ...
        screen.addPullDownString(
            "CurrentPage",
            CyTranslator().getText("TXT_KEY_PITBOSS_GAME_OPTIONS", ()),
            10,
            10,
            False,
        )
    ...
    def sortCities(self):
        ...
        for iPlayerX in xrange(gc.getMAX_PLAYERS()):  # type: ignore
            ...
            if iOwnerType == 1 and iPlayerX != iSelectedPlayer:
                continue
            if iOwnerType == 2 and pPlayerX.getTeam() != iSelectedTeam:
                continue
    ...
    def placeHolyCities(self):
        ...
        for i in xrange(gc.getNumReligionInfos()):  # type: ignore
            ...
            screen.setTableText(
                ...
                iRow,
                "",
                gc.getReligionInfo(i).getButton(),
                WidgetTypes.WIDGET_HELP_RELIGION,
                i,
                1,
                CvUtil.FONT_LEFT_JUSTIFY,
            ...
            if not pHolyCity.isNone():
                ...
                screen.setTableText(
                    ...
                    2,
                    iRow,
                    "<font=3>" + sColor + pHolyCity.getName() + "</color></font>",
                    gc.getCivilizationInfo(pHolyCity.getCivilizationType()).getButton(),
                    WidgetTypes.WIDGET_PYTHON,
                    7200 + iPlayerX,
                    pHolyCity.getID(),
                    CvUtil.FONT_LEFT_JUSTIFY,
    ...
    def placeStateReligion(self):
        ...
        for iPlayerX in xrange(gc.getMAX_PLAYERS()):  # type: ignore
            ...
            screen.setTableText(
                ...
                2,
                iRow,
                "<font=3>" + sColor + pPlayerX.getName() + "</font></color>",
                gc.getLeaderHeadInfo(iLeader).getButton(),
                WidgetTypes.WIDGET_PYTHON,
                7876,
                iPlayerX * 10000 + iLeader,
