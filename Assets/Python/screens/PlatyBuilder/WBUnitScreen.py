...
class WBUnitScreen:
    ...
    def interfaceScreen(self, pUnitX):
        ...
        screen.addPanel(
            ...
            -10,
            -10,
            screen.getXResolution() + 20,
            screen.getYResolution() + 20,
        ...
        screen.setText(
            ...
            screen.getXResolution() - 30,
            screen.getYResolution() - 42,
            -0.1,
        ...
        screen.addPullDownString(
            "OwnerType", CyTranslator().getText("TXT_KEY_WB_CITY_ALL", ()), 0, 0, 0 == iOwnerType
        )
        screen.addPullDownString(
            "OwnerType", CyTranslator().getText("TXT_KEY_PITBOSS_TEAM", ()), 2, 2, 2 == iOwnerType
        )
        screen.addPullDownString(
            "OwnerType",
            CyTranslator().getText("TXT_KEY_MAIN_MENU_PLAYER", ()),
            1,
            1,
            1 == iOwnerType,
        )
        ...
        screen.addPullDownString(
            "CopyType", CyTranslator().getText("TXT_KEY_WB_CITY_ALL", ()), 0, 0, 0 == iCopyType
        )
        screen.addPullDownString(
            "CopyType",
            CyTranslator().getText("TXT_KEY_SPACE_SHIP_SCREEN_TYPE_BUTTON", ()),
            1,
            1,
            1 == iCopyType,
        )
        screen.addPullDownString(
            "CopyType",
            CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_UNIT_COMBAT", ()),
            2,
            2,
            2 == iCopyType,
        )
        screen.addPullDownString(
            "CopyType", CyTranslator().getText("TXT_KEY_PEDIA_DOMAIN", ()), 3, 3, 3 == iCopyType
        )
        screen.addPullDownString(
            "CopyType", CyTranslator().getText("TXT_KEY_WB_GROUP", ()), 4, 4, 4 == iCopyType
        )
        ...
        screen.addPullDownString(
            "PlotType", CyTranslator().getText("TXT_KEY_WB_SINGLE_PLOT", ()), 0, 0, iPlotType == 0
        )
        screen.addPullDownString(
            "PlotType", CyTranslator().getText("TXT_KEY_WB_AREA_PLOTS", ()), 1, 1, iPlotType == 1
        )
        screen.addPullDownString(
            "PlotType", CyTranslator().getText("TXT_KEY_WB_ALL_PLOTS", ()), 2, 2, iPlotType == 2
        )
        ...
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_UNIT_DATA", ()), 0, 0, True
        )
        screen.addPullDownString(
            "CurrentPage",
            CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_PROMOTION", ()),
            1,
            1,
            False,
        )
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_PLAYER_DATA", ()), 2, 2, False
        )
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_TEAM_DATA", ()), 3, 3, False
        )
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_WB_PLOT_DATA", ()), 4, 4, False
        )
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_CONCEPT_EVENTS", ()), 5, 5, False
        )
        screen.addPullDownString(
            "CurrentPage",
        ...
        screen.addPullDownString(
            "CurrentPage", CyTranslator().getText("TXT_KEY_INFO_SCREEN", ()), 11, 11, False
        )
        ...
        screen.addPullDownString(
            "ChangeType", CyTranslator().getText("TXT_KEY_WB_XLEVEL", ()), 0, 0, 0 == iChangeType
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("INTERFACE_PANE_EXPERIENCE", ()),
            1,
            1,
            1 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_DEMO_SCREEN_STRENGTH_TEXT", ()),
            2,
            2,
            2 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType", CyTranslator().getText("TXT_KEY_WB_DAMAGE", ()), 3, 3, 3 == iChangeType
        )
        screen.addPullDownString(
            "ChangeType", CyTranslator().getText("TXT_KEY_WB_MOVES", ()), 4, 4, 4 == iChangeType
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_IMMOBILE_TIMER", ()),
            5,
            5,
            5 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_PROMOTION_READY", ()),
            6,
            6,
            6 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_MADE_ATTACK", ()),
            7,
            7,
            7 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_MADE_INTERCEPT", ()),
            8,
            8,
            8 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_DIRECTION", ()),
            9,
            9,
            9 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_UNIT_AI", ()),
            10,
            10,
            10 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_CARGO_SPACE", ()),
            11,
            11,
            11 == iChangeType,
        )
        screen.addPullDownString(
            "ChangeType",
            CyTranslator().getText("TXT_KEY_WB_SCRIPT_DATA", ()),
            12,
            12,
            12 == iChangeType,
        )
        ...
        iX += iWidth
        sText = (
            CyTranslator().getText("[COLOR_SELECTED_TEXT]", ())
            + "<font=3b>"
            + CyTranslator().getText(
                "TXT_KEY_WB_COPY_ALL", (CyTranslator().getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ()),)
            )
            + "</color></font>"
        )
        screen.setText(
    ...
    def placeMap(self):
        ...
        screen.addPlotGraphicGFC(
            "PlotView",
            screen.getXResolution() / 2 - iMapWidth / 2,
            iY,
            iMapWidth,
            iMapHeight,
            pUnit.plot(),
    ...
    def placeMissions(self):
        ...
        screen.setText(
            ...
            "<font=3b>"
            + CyTranslator().getText("[COLOR_SELECTED_TEXT]", ())
            + CyTranslator().getText("TXT_KEY_WB_PUSH_MISSION", ())
            + "</color></font>",
            CvUtil.FONT_CENTER_JUSTIFY,
            screen.getXResolution() * 7 / 10,
            iY - 30,
            -0.1,
            FontTypes.TITLE_FONT,
            WidgetTypes.WIDGET_GENERAL,
        ...
        sText = (
            CyTranslator().getText("[COLOR_SELECTED_TEXT]", ())
            + "<font=3>"
            + CyTranslator().getText("TXT_KEY_WB_TARGET_PLOT", ())
            + ": "
            + "(%d,%d)"
            + "</color></font>"
        ) % (self.top.iTargetPlotX, self.top.iTargetPlotY)
        screen.setText(
            "TargetPlot",
            "Background",
            sText,
        ...
        iY += 30
        screen.addDropDownBoxGFC(
            "Missions", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        ...
        for i in xrange(gc.getNumMissionInfos()):
            ...
            for iData1 in lData1:
                if pUnit.getGroup().canStartMission(i, iData1, iData2, pPlot, True):
                    screen.addPullDownString(
                        "Missions", MissionInfo.getDescription(), i, i, i == iMissionType
                    )
                    bCanDoMission = True
                    if iFirstMission == -1:
                        iFirstMission = i
        ...
        if sMissionType in self.lSelectableMissions:
            ...
            for i in xrange(len(lMissionData)):
                ...
                if pUnit.getGroup().canStartMission(iMissionType, iData1, -1, pPlot, True):
                    ...
                    screen.setTableText(
                        ...
                        0,
                        iRow,
                        "<font=3>" + sColor + sDescription + "</font></color>",
                        ItemInfo.getButton(),
                        WidgetTypes.WIDGET_PYTHON,
                        self.lSelectableMissions[sMissionType][1],
                        iData1,
                        CvUtil.FONT_LEFT_JUSTIFY,
                    )
            ...
            if iTech > -1:
                ...
                screen.setTableText(
                    ...
                    0,
                    iRow,
                    "<font=3>" + gc.getTechInfo(iTech).getDescription() + "</font>",
                ...
                iRow = screen.appendTableRow("MissionInput")
                sText = u"%c %d / %d" % (
                    gc.getCommerceInfo(CommerceTypes.COMMERCE_RESEARCH).getChar(),
                    gc.getTeam(pUnit.getTeam()).getResearchProgress(iTech),
                    gc.getTeam(pUnit.getTeam()).getResearchCost(iTech),
                )
                screen.setTableText(
                    "MissionInput",
                    0,
                ...
                sText = u"%c %s%+d</color>" % (
                    gc.getCommerceInfo(CommerceTypes.COMMERCE_RESEARCH).getChar(),
                    CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ()),
                    pUnit.getDiscoverResearch(iTech),
                )
                screen.setTableText(
                    "MissionInput",
                    0,
            ...
            if pPlot.isCity():
                ...
                sText = u"%c %s%+d</color>" % (
                    gc.getCommerceInfo(CommerceTypes.COMMERCE_CULTURE).getChar(),
                    CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ()),
                    pUnit.getGreatWorkCulture(pPlot),
                )
                screen.setTableText(
                    "MissionInput",
                    0,
            ...
            if pPlot.isCity():
                ...
                if pCity.isProductionBuilding():
                    ...
                    screen.setTableText(
                        ...
                        0,
                        iRow,
                        "<font=3>" + gc.getBuildingInfo(iBuilding).getDescription() + "</font>",
                    ...
                    screen.setTableText(
                        ...
                        0,
                        iRow,
                        "<font=3>" + gc.getProjectInfo(iProject).getDescription() + "</font>",
                        gc.getProjectInfo(iProject).getButton(),
                        WidgetTypes.WIDGET_PYTHON,
                        6785,
                        iProject,
                        CvUtil.FONT_LEFT_JUSTIFY,
                    ...
                    screen.setTableText(
                        ...
                        0,
                        iRow,
                        "<font=3>" + gc.getUnitInfo(iUnit).getDescription() + "</font>",
                ...
                sText = u"%c %s%+d</color>" % (
                    gc.getYieldInfo(YieldTypes.YIELD_PRODUCTION).getChar(),
                    CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ()),
                    pUnit.getHurryProduction(pPlot),
                )
                screen.setTableText(
                    "MissionInput",
                    0,
    ...
    def placeDirection(self):
        ...
        screen.setLabel(
            "UnitDirectionText",
            "Background",
            "<font=3b>" + CyTranslator().getText("TXT_KEY_WB_DIRECTION", ()) + "</font>",
            CvUtil.FONT_CENTER_JUSTIFY,
        ...
        screen.addTableControlGFC(
            "WBUnitDirection",
            3,
            screen.getXResolution() / 2 - iHeight / 2,
            iY,
            iHeight,
            iHeight,
            False,
        ...
        iY += iHeight
        screen.addDropDownBoxGFC(
            "UnitAIType", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        for item in lUnitAI:
            screen.addPullDownString(
                "UnitAIType", item[0], item[1], item[1], item[1] == pUnit.getUnitAIType()
            )
        ...
        screen.setText(
            "PromotionReadyText",
            "Background",
            "<font=3>" + sColor + sText + "</color></font>",
            CvUtil.FONT_CENTER_JUSTIFY,
            screen.getXResolution() / 2,
            iY + 1,
            -0.1,
    ...
    def placeStats(self):
        ...
        sText = u"<font=3b>%s ID: %d, %s ID: %d</font>" % (
            CyTranslator().getText("TXT_KEY_WB_UNIT", ()),
            pUnit.getID(),
            CyTranslator().getText("TXT_KEY_WB_GROUP", ()),
            pUnit.getGroupID(),
        )
        screen.setLabel(
            "UnitScreenHeaderB",
        ...
        sText = "<font=3b>%s, X: %d, Y: %d</font>" % (
            CyTranslator().getText("TXT_KEY_WB_LATITUDE", (pPlot.getLatitude(),)),
            pPlot.getX(),
            pPlot.getY(),
        )
        screen.setLabel(
        ...
        for iPlayerX in xrange(gc.getMAX_PLAYERS()):
            ...
            if pPlayerX.isEverAlive():
                ...
                if pPlayerX.isTurnActive():
                    sText = "[" + sText + "]"
                screen.addPullDownString(
                    "UnitOwner", sName, iPlayerX, iPlayerX, iPlayerX == pUnit.getOwner()
                )

        iY += 30
        screen.addDropDownBoxGFC(
            "ChangeBy", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        i = 1
        while i < 100001:
        ...
        iY += 30
        screen.addDropDownBoxGFC(
            "CommandUnits", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
            "CommandUnits",
            CyTranslator().getText("TXT_KEY_WB_UNIT", ()),
        ...
        screen.addPullDownString(
            "CommandUnits",
            CyTranslator().getText("TXT_KEY_PEDIA_DOMAIN", ()),
            3,
            3,
            3 == iCommandUnitType == 3,
        )
        screen.addPullDownString(
            "CommandUnits",
            CyTranslator().getText("TXT_KEY_WB_GROUP", ()),
        ...
        iY += 30
        screen.addDropDownBoxGFC(
            "Commands", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
            "Commands", CyTranslator().getText("TXT_KEY_WB_COMMANDS", ()), 0, 0, True
        )
        screen.addPullDownString(
            "Commands", CyTranslator().getText("TXT_KEY_OPTIONS_RESET", ()), 1, 1, False
        )
        screen.addPullDownString(
            "Commands", CyTranslator().getText("TXT_KEY_MISSION_MOVE_TO", ()), 2, 2, False
        )
        screen.addPullDownString(
            "Commands", CyTranslator().getText("TXT_KEY_MAP_SCRIPT_COPY", ()), 3, 3, False
        )
        screen.addPullDownString(
            "Commands", CyTranslator().getText("TXT_KEY_ESPIONAGE_DESTROY_UNIT", ()), 4, 4, False
        )
        ...
        sText = (
            CyTranslator().getText("INTERFACE_PANE_STRENGTH", ())
            + " "
            + str(pUnit.baseCombatStr())
        ...
        iY += 30
        sText = (
            CyTranslator().getText("INTERFACE_PANE_AIR_STRENGTH", ())
            + " "
            + str(pUnit.airBaseCombatStr())
        )
        screen.setLabel(
            "UnitAirStrText",
            "Background",
        ...
        sText = u"%s: %.2f" % (
            CyTranslator().getText("TXT_KEY_WB_MOVES", ()),
            float(pUnit.movesLeft()) / gc.getDefineINT("MOVE_DENOMINATOR"),
        ) + CyTranslator().getText("[ICON_MOVES]", ())
        screen.setLabel(
            "UnitMovesLeftText",
            "Background",
            "<font=3>" + sText + "</font>",
    ...
    def placeUnitType(self):
        ...
        iY += 30
        screen.addDropDownBoxGFC(
            "LeaderType", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
            "LeaderType",
            CyTranslator().getText("TXT_KEY_FOREIGN_ADVISOR_LEADER", ()),
            0,
            0,
            not bUnitType,
        )
        ...
        iY += 30
        screen.addDropDownBoxGFC(
            "CombatClass", iX, iY, iWidth, WidgetTypes.WIDGET_GENERAL, -1, -1, FontTypes.GAME_FONT
        )
        screen.addPullDownString(
            "CombatClass",
            CyTranslator().getText("TXT_KEY_WB_CITY_ALL", ()),
        ...
        for i in xrange(gc.getNumUnitInfos()):
            ...
            if CvPlatyBuilderScreen.bHideInactive:
                ...
                if (
                    gc.getCivilizationInfo(iCivilization).getCivilizationUnits(
                        UnitInfo.getUnitClassType()
                    )
                    != i
                ):
                    continue
        ...
        for item in lUnitType:
            ...
            screen.setTableText(
                ...
                0,
                iRow,
                "<font=3>" + sColor + item[0] + "</font></color>",
    ...
    def sortUnits(self):
        ...
        for iPlayerX in xrange(gc.getMAX_PLAYERS()):
            ...
            if iOwnerType == 1 and iPlayerX != pUnit.getOwner():
                continue
            if iOwnerType == 2 and pPlayerX.getTeam() != pUnit.getTeam():
                continue
            if pPlayerX.isAlive():
    ...
    def placeCurrentUnit(self):
        ...
        for i in lUnits:
            ...
            screen.setTableText(
                ...
                iRow,
                "",
                gc.getCivilizationInfo(iCiv).getButton(),
                WidgetTypes.WIDGET_PYTHON,
                7872,
                iCiv,
                CvUtil.FONT_LEFT_JUSTIFY,
    ...
    def placeCargo(self):
        ...
        screen.addPullDownString(
            "CargoType", CyTranslator().getText("TXT_KEY_UNIT_TRANSPORT", ()), 0, 0, not bCargo
        )
        screen.addPullDownString(
            "CargoType", CyTranslator().getText("TXT_KEY_WB_CARGO_SPACE", ()), 1, 1, bCargo
        )
    ...
    def handleInput(self, inputClass):
        ...
        if sName == "ChangeBy":
            ...
            self.changeOwner(
                screen.getPullDownData("UnitOwner", screen.getSelectedPullDownID("UnitOwner"))
            )
            ...
            if inputClass.getData1() == 1030:
                ...
                pUnit.changeExperience(
                    -min(iChange, pUnit.getExperience()), -1, False, False, False
                )
            self.placeStats()
            ...
            if inputClass.getData1() == 1030:
                ...
                pUnit.changeMoves(
                    min(iChange * gc.getDefineINT("MOVE_DENOMINATOR"), pUnit.movesLeft())
                )
            self.placeStats()
            ...
            pUnit.setUnitAIType(
                screen.getPullDownData("UnitAIType", screen.getSelectedPullDownID("UnitAIType"))
            )
            ...
            iCommandUnitType = screen.getPullDownData(
                "CommandUnits", screen.getSelectedPullDownID("CommandUnits")
            )
            ...
            iMissionType = screen.getPullDownData(
                "Missions", screen.getSelectedPullDownID("Missions")
            )
            iMissionData1 = -1
            self.placeMissions()
        ...
        if (
            inputClass.getNotifyCode() == NotifyCode.NOTIFY_CHARACTER
        ) and inputClass.getData() == int(InputTypes.KB_ESCAPE):
            self.top.iTargetPlotX = -1
            self.top.iTargetPlotY = -1
        return 1
    ...
    def changeOwner(self, iPlayer):
        pNewUnit = gc.getPlayer(iPlayer).initUnit(
            pUnit.getUnitType(),
            pUnit.getX(),
            pUnit.getY(),
            UnitAITypes.NO_UNITAI,
    ...
    def changeUnitType(self, pUnit, iUnitType, bUnitType):
        if bUnitType:
            pNewUnit = gc.getPlayer(pUnit.getOwner()).initUnit(
                iUnitType,
                pUnit.getX(),
                pUnit.getY(),
                UnitAITypes.NO_UNITAI,
