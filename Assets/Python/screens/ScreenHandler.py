...
events.setPopupHandlers(
    CvUtil.EventEditCityName, "EditCityName", __eventEditCityNameApply, __eventEditCityNameBegin
)
events.setPopupHandlers(
    CvUtil.EventPlaceObject, "PlaceObject", __eventPlaceObjectApply, __eventPlaceObjectBegin
)
events.setPopupHandlers(
...
events.setPopupHandlers(
    CvUtil.EventEditUnitName, "EditUnitName", __eventEditUnitNameApply, __eventEditUnitNameBegin
)
...
events.setPopupHandlers(
    CvUtil.EventShowWonder, "ShowWonder", __eventShowWonderApply, __eventShowWonderBegin
)
events.setPopupHandlers(
    1111, "WBPlayerScript", __eventWBPlayerScriptPopupApply, __eventWBScriptPopupBegin
)
events.setPopupHandlers(
    2222, "WBCityScript", __eventWBCityScriptPopupApply, __eventWBScriptPopupBegin
)
events.setPopupHandlers(
    3333, "WBUnitScript", __eventWBUnitScriptPopupApply, __eventWBScriptPopupBegin
)
events.setPopupHandlers(
    4444, "WBGameScript", __eventWBGameScriptPopupApply, __eventWBScriptPopupBegin
)
events.setPopupHandlers(
    5555, "WBPlotScript", __eventWBPlotScriptPopupApply, __eventWBScriptPopupBegin
)
## Platy Builder ##
