...
{
public:
  virtual void removeEntity(CvEntity *)
  {
  ...
  virtual void setup(CvEntity *)
  {
    FAssertMsg(false, "can't get here");
  }
  virtual void setVisible(CvEntity *, bool)
  {
    FAssertMsg(false, "can't get here");
  }
  virtual void createCityEntity(CvCity *)
  {
    FAssertMsg(false, "can't get here");
  }
  virtual void createUnitEntity(CvUnit *)
  {
    FAssertMsg(false, "can't get here");
  }
  ...
  virtual void setupFloodPlains(CvRiver *river)
  {
    FAssertMsg(false, "can't get here");
  }
  ...
  virtual void PlayAnimation(CvEntity *, AnimationTypes eAnim, float fSpeed = 1.0f, bool bQueue = false, int iLayer = 0,
  ...
  virtual void StopAnimation(CvEntity *)
  {
    FAssertMsg(false, "can't get here");
  }
  ...
  virtual void ExecuteMove(CvUnitEntity *, float fTimeToExecute, bool bCombat)
  {
    FAssertMsg(false, "can't get here");
  }
  ...
  virtual void updateGraphicEra(CvUnitEntity *pEntity, EraTypes eOldEra = NO_ERA)
  {
    FAssertMsg(false, "can't get here");
  };
