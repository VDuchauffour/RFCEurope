...
public:
  ...
  virtual void playerChangeAllCivics(PlayerTypes ePlayerID, CivicTypes *paeNewCivics,
                                     CivicTypes *paeOldCivics) = 0; // Absinthe: Python Event for civic changes
  virtual void playerChangeSingleCivic(PlayerTypes ePlayerID, CivicTypes eNewCivic,
                                       CivicTypes eOldCivic) = 0; // Absinthe: Python Event for civic changes
  virtual void playerChangeStateReligion(PlayerTypes ePlayerID, ReligionTypes eNewReligion,
                                         ReligionTypes eOldReligion) = 0;
