...
public:
  ...
  void parseFinanceMercenaryMaintenance(CvWidgetDataStruct &widgetDataStruct,
                                        CvWStringBuffer &szBuffer); // Absinthe: mercenary upkeep
  void parseFinanceColonyUpkeep(CvWidgetDataStruct &widgetDataStruct,
                                CvWStringBuffer &szBuffer); // Absinthe: colony upkeep
