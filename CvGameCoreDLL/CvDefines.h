...
#define MAX_CIV_PLAYERS                                                                                                \
  (33) // Absinthe: 28 playable civs (with Prussia, Novgorod, Norway, Scotland, Aragon, Morocco) + Pope + 4 Indies
#else
...
#define TEXT_COLOR(szColor)                                                                                            \
  ((int)(GC.getColorInfo((ColorTypes)GC.getInfoTypeForString(szColor)).getColor().r * 255)),                           \
      ...
      ((int)(GC.getColorInfo((ColorTypes)GC.getInfoTypeForString(szColor)).getColor().b * 255)),                       \
      ((int)(GC.getColorInfo((ColorTypes)GC.getInfoTypeForString(szColor)).getColor().a * 255))
