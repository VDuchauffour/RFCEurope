...
CvDiploParameters::CvDiploParameters(PlayerTypes ePlayer)
    : m_eWhoTalkingTo(ePlayer), m_eCommentType(NO_DIPLOCOMMENT), m_bRenegotiate(false), m_bAIContact(false),
      m_bPendingDelete(false), m_iData(-1), m_bHumanDiplo(false), m_bOurOffering(false), m_bTheirOffering(false)
{
  m_ourOffer.clear();
  m_theirOffer.clear();
}
...
void CvDiploParameters::setDiploComment(DiploCommentTypes eCommentType, CvWString arg1, CvWString arg2,
                                        CvWString arg3) SET_DIPLO_COMMENT_ARGS

    void CvDiploParameters::setDiploComment(DiploCommentTypes eCommentType, CvWString arg1, CvWString arg2,
                                            int arg3) SET_DIPLO_COMMENT_ARGS

    void CvDiploParameters::setDiploComment(DiploCommentTypes eCommentType, CvWString arg1, int arg2,
                                            CvWString arg3) SET_DIPLO_COMMENT_ARGS

    void CvDiploParameters::setDiploComment(DiploCommentTypes eCommentType, CvWString arg1, int arg2,
                                            int arg3) SET_DIPLO_COMMENT_ARGS

    void CvDiploParameters::setDiploComment(DiploCommentTypes eCommentType, int arg1, CvWString arg2,
                                            CvWString arg3) SET_DIPLO_COMMENT_ARGS

    void CvDiploParameters::setDiploComment(DiploCommentTypes eCommentType, int arg1, CvWString arg2,
                                            int arg3) SET_DIPLO_COMMENT_ARGS

    void CvDiploParameters::setDiploComment(DiploCommentTypes eCommentType, int arg1, int arg2,
                                            CvWString arg3) SET_DIPLO_COMMENT_ARGS
