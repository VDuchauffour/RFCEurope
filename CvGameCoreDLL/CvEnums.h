...
enum FeatTypes // Exposed to Python
{
  ...
  FEAT_UNITCOMBAT_LIGHT_CAVALRY,
  FEAT_UNITCOMBAT_HEAVY_CAVALRY,
  FEAT_UNITCOMBAT_POLEARM,
  FEAT_UNITCOMBAT_HEAVY_INFANTRY,
  ...
  FEAT_FOOD_CONNECTED,
  FEAT_POPULATION_100_THOUSAND,
  FEAT_POPULATION_200_THOUSAND,
  FEAT_POPULATION_500_THOUSAND,
