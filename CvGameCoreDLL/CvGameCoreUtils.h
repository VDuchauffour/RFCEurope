...
{
  return GC.getMapINLINE().plotINLINE((iX + GC.getPlotCardinalDirectionX()[eCardinalDirection]),
...
{
  return directionXY(dxWrap(pToPlot->getX_INLINE() - pFromPlot->getX_INLINE()),
...
// 3MiroProjects: Score
int getProjectScore(ProjectTypes eProjectClass); // Exposed to Python
