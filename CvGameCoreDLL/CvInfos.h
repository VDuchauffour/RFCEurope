...
public:
	...
	std::wstring pyGetUP2() { return getUP2(); }				// Exposed to Python
	DllExport const wchar* getUHV1() const;				// Exposed to Python
	std::wstring pyGetUHV1() { return getUHV1(); }				// Exposed to Python
	DllExport const wchar* getUHV2() const;				// Exposed to Python
	std::wstring pyGetUHV2() { return getUHV2(); }				// Exposed to Python
	DllExport const wchar* getUHV3() const;				// Exposed to Python
	std::wstring pyGetUHV3() { return getUHV3(); }				// Exposed to Python
	DllExport const wchar* getSTrade() const;				// Exposed to Python
	std::wstring pyGetSTrade() { return getSTrade(); }				// Exposed to Python
	DllExport const wchar* getSProduction() const;				// Exposed to Python
	std::wstring pyGetSProduction() { return getSProduction(); }				// Exposed to Python
	DllExport const wchar* getSCulture() const;				// Exposed to Python
	std::wstring pyGetSCulture() { return getSCulture(); }				// Exposed to Python
	DllExport const wchar* getSGrowth() const;				// Exposed to Python
	std::wstring pyGetSGrowth() { return getSGrowth(); }				// Exposed to Python
