...
public:
  CvNetDoTask();
  CvNetDoTask(PlayerTypes ePlayer, int iCityID, TaskTypes eTask, int iData1, int iData2, bool bOption, bool bAlt,
...
{
public:
  CvNetAdvancedStartAction(AdvancedStartActionTypes eAction = NO_ADVANCEDSTARTACTION, PlayerTypes ePlayer = NO_PLAYER,
                           int iX = -1, int iY = -1, int iData = -1, bool bAdd = true);
  DllExport virtual void Debug(char *szAddendum);
  DllExport virtual void Execute();
  DllExport virtual void PutInBuffer(FDataStreamBase *pStream);
  DllExport virtual void SetFromBuffer(FDataStreamBase *pStream);
...
{
public:
  CvNetFoundReligion(PlayerTypes ePlayer = NO_PLAYER, ReligionTypes eReligion = NO_RELIGION,
                     ReligionTypes eSlotReligion = NO_RELIGION);
  DllExport virtual void Debug(char *szAddendum);
  DllExport virtual void Execute();
  DllExport virtual void PutInBuffer(FDataStreamBase *pStream);
  DllExport virtual void SetFromBuffer(FDataStreamBase *pStream);
...
public:
  CvNetPushMission();
  CvNetPushMission(PlayerTypes ePlayer, int iUnitID, MissionTypes eMission, int iData1, int iData2, int iFlags,
                   bool bShift);
  DllExport virtual void Debug(char *szAddendum);
  DllExport virtual void Execute();
  DllExport virtual void PutInBuffer(FDataStreamBase *pStream);
