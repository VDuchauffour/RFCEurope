...
void CyAreaPythonInterface()
{
  ...
  python::class_<CyArea>("CyArea")
      ...
      .def("countHasReligion", &CyArea::countHasReligion,
           "int (int /*ReligionTypes*/ eReligion, int /*PlayerTypes*/ eOwner)")
      .def("countHasCorporation", &CyArea::countHasCorporation,
      ...
      .def("getNumUnownedTiles", &CyArea::getNumUnownedTiles,
      ...
      .def("getAnimalsPerPlayer", &CyArea::getAnimalsPerPlayer,
      ...
      .def("getPopulationPerPlayer", &CyArea::getPopulationPerPlayer,
      ...
      .def("getNumRevealedTiles", &CyArea::getNumRevealedTiles,
           "int (int (TeamTypes) iIndex) - Returns the number of revealed tiles for this team")
      .def("getNumUnrevealedTiles", &CyArea::getNumUnrevealedTiles,
      ...
      .def("getAreaAIType", &CyArea::getAreaAIType,
           "int (AreaAITypes) (int (TeamTypes) eIndex) - Returns the AreaAIType for this team in this area")
      .def("getTargetCity", &CyArea::getTargetCity, python::return_value_policy<python::reference_existing_object>(),
           "CyCity* (int (PlayerTypes) eIndex) - Returns ?")
      .def("getYieldRateModifier", &CyArea::getYieldRateModifier,
           "int (int (PlayerTypes) iPlayer, int (YieldTypes) iIndex2 - Returns ?")
      .def("getNumTrainAIUnits", &CyArea::getNumTrainAIUnits,
           "int (int (PlayerTypes) iPlayer, int (UnitAITypes) iIndex2) - Returns ?")
      .def("getNumAIUnits", &CyArea::getNumAIUnits,
           "int (int (PlayerTypes) iPlayer, int (UnitAITypes) iIndex2) - Returns the number of units for this AI which "
           "have this AI type")
