...
public:
  ...
  void chooseProduction(int /*UnitTypes*/ eTrainUnit, int /*BuildingTypes*/ eConstructBuilding,
  ...
  bool isHasBuilding(
      int          /*BuildingTypes*/
          iIndex); // This is a function to help modders out, since it was replaced with getNumBuildings() in the C++
  ...
  void setWallOverridePoints(
      const python::tuple &kPoints); /* points are given in world space ... i.e. PlotXToPointX, etc */
  ...
  void setBuildingCommerceChange(int /*BuildingClassTypes*/ eBuildingClass, int /*CommerceTypes*/ eCommerce,
                                 int iChange);
