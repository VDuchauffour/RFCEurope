...
void CyEnumsPythonInterface()
{
  ...
  python::enum_<BuildingClassTypes>("BuildingClassTypes").value("NO_BUILDINGCLASS", NO_BUILDINGCLASS);
  ...
  python::enum_<UnitClassTypes>("UnitClassTypes").value("NO_UNITCLASS", NO_UNITCLASS);
  ...
  python::enum_<ControlTypes>("ControlTypes")
      ...
      .value("CONTROL_MERCENARIES_MANAGER", CONTROL_MERCENARIES_MANAGER) // Absinthe
      .value("CONTROL_STABILITY_OVERLAY", CONTROL_STABILITY_OVERLAY)     // Absinthe
  ...
  python::enum_<DiploCommentTypes>("DiploCommentTypes").value("NO_DIPLOCOMMENT", NO_DIPLOCOMMENT);
  ...
  python::enum_<FeatTypes>("FeatTypes")
      ...
      .value("FEAT_UNITCOMBAT_LIGHT_CAVALRY", FEAT_UNITCOMBAT_LIGHT_CAVALRY)
      .value("FEAT_UNITCOMBAT_HEAVY_CAVALRY", FEAT_UNITCOMBAT_HEAVY_CAVALRY)
      .value("FEAT_UNITCOMBAT_POLEARM", FEAT_UNITCOMBAT_POLEARM)
      .value("FEAT_UNITCOMBAT_HEAVY_INFANTRY", FEAT_UNITCOMBAT_HEAVY_INFANTRY)
      ...
      .value("FEAT_POPULATION_100_THOUSAND", FEAT_POPULATION_100_THOUSAND)
      .value("FEAT_POPULATION_200_THOUSAND", FEAT_POPULATION_200_THOUSAND)
      .value("FEAT_POPULATION_500_THOUSAND", FEAT_POPULATION_500_THOUSAND)
