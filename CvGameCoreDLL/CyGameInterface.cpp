...
void CyGamePythonInterface()
{
  ...
  python::class_<CyGame>("CyGame")
      ...
      .def("setVoteSourceReligion", &CyGame::setVoteSourceReligion,
      ...
      .def("getUnitClassCreatedCount", &CyGame::getUnitClassCreatedCount,
           "int (eIndex) - returns number of this unit class type created (?)")
      .def("isUnitClassMaxedOut", &CyGame::isUnitClassMaxedOut,
           "bool (eIndex, iExtra) - returns whether or not this unit class is maxed out (e.g. spies)")
      .def("getBuildingClassCreatedCount", &CyGame::getBuildingClassCreatedCount,
      ...
      // Rhye - start (jdog)
      .def("changePlayer", &CyGame::changePlayer,
           "bool ( int playerIdx, int newCivType, int newLeader, int teamIdx, bool bIsHuman, bool bChangeGraphics ) - "
           "change player civ or leader")
      ...
      .def("setPlotExtraYield", &CyGame::setPlotExtraYield,
...
// BUFFY - Security Checks - start
  ...
  python::class_<CyDeal>("CyDeal")
      ...
      .def("isCancelable", &CyDeal::isCancelable,
           "bool isCancelable(int /*PlayerTypes*/ eByPlayer, bool bIgnoreWaitingPeriod)")
      .def("getCannotCancelReason", &CyDeal::getCannotCancelReason,
           "string getCannotCancelReason(int /*PlayerTypes*/ eByPlayer)")
