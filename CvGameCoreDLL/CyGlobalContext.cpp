...
{
  return (i >= 0 && i < GC.getNumEspionageMissionInfos()) ? &GC.getEspionageMissionInfo((EspionageMissionTypes)i)
                                                          : NULL;
}
...
void CyGlobalContext::setSizeNPlayers(int iMaxX, int iMaxY, int iNumPlayers, int iAllPlayers, int iNumTechs,
                                      int iNumBuildings, int iNumReligions)
{
  EARTH_X = iMaxX;
  EARTH_Y = iMaxY;
  ...
  for (i = 0; i < EARTH_X * EARTH_Y; i++)
  {
    provinceMap[i] = MAX_NUM_PROVINCES + 1;
  }; // no provinces
  provinceRegionMap = new int[MAX_NUM_PROVINCES];
  for (i = 0; i < MAX_NUM_PROVINCES; i++)
  {
    provinceRegionMap[i] = 0;
  }; // all is one region
  ...
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    growthThresholdAI[i] = 100;
  productionModifierUnitsAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    productionModifierUnitsAI[i] = 100;
  productionModifierBuildingsAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    productionModifierBuildingsAI[i] = 100;
  productionModifierWondersAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    productionModifierWondersAI[i] = 100;
  inflationModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    inflationModifierAI[i] = 100;
  gpModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    gpModifierAI[i] = 100;
  unitSupportModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    unitSupportModifierAI[i] = 100;
  cityDistanceSupportAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cityDistanceSupportAI[i] = 100;
  cityNumberSupportAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cityNumberSupportAI[i] = 100;
  civicSupportModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    civicSupportModifierAI[i] = 100;
  researchModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    researchModifierAI[i] = 100;
  healthModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    healthModifierAI[i] = 100;
  workerModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    workerModifierAI[i] = 100;
  cultureModifierAI = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cultureModifierAI[i] = 100;

  growthThresholdHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    growthThresholdHu[i] = 100;
  productionModifierUnitsHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    productionModifierUnitsHu[i] = 100;
  productionModifierBuildingsHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    productionModifierBuildingsHu[i] = 100;
  productionModifierWondersHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    productionModifierWondersHu[i] = 100;
  inflationModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    inflationModifierHu[i] = 100;
  gpModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    gpModifierHu[i] = 100;
  unitSupportModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    unitSupportModifierHu[i] = 100;
  cityDistanceSupportHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cityDistanceSupportHu[i] = 100;
  cityNumberSupportHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cityNumberSupportHu[i] = 100;
  civicSupportModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    civicSupportModifierHu[i] = 100;
  researchModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    researchModifierHu[i] = 100;
  healthModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    healthModifierHu[i] = 100;
  workerModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    workerModifierHu[i] = 100;
  cultureModifierHu = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cultureModifierHu[i] = 100;

  cityInitPop = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cityInitPop[i] = 1;
  ...
  techPreferences = new int *[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    techPreferences[i] = new int[MAX_NUM_TECHS];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    for (int j = 0; j < MAX_NUM_TECHS; j++)
      techPreferences[i][j] = 100;
  ...
  diplomacyModifiers = new int *[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    diplomacyModifiers[i] = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    for (int j = 0; j < NUM_ALL_PLAYERS_B; j++)
      diplomacyModifiers[i][j] = 0;
  ...
  for (int i = 0; i < NUM_ALL_PLAYERS_B * UP_TOTAL_NUM; i++)
    UniquePowers[i] = -1;

  cityInitBuildings = new int *[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    cityInitBuildings[i] = new int[NUM_BUILDINGS];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
  ...
  for (int i = 0; i < NUM_ALL_PLAYERS_B * NUM_RELIGIONS; i++)
    civSpreadFactor[i] = 100;

  colonyAIModifier = new int[NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B; i++)
    colonyAIModifier[i] = 100;

  FaithPowers = new int[NUM_RELIGIONS * FP_TOTAL_NUM];
  for (int i = 0; i < NUM_RELIGIONS * FP_TOTAL_NUM; i++)
    FaithPowers[i] = -1;

  FaithPointsCap = new int[NUM_RELIGIONS];
  for (int i = 0; i < NUM_RELIGIONS; i++)
    FaithPointsCap[i] = 100; // 3Miro: this is probably too high, it will be overwritten anyway
  ...
  for (int i = 0; i < NUM_ALL_PLAYERS_B * NUM_BUILDINGS; i++)
  {
    buildingPrefs[i] = 0;
  }

  historicalEnemyAIcheat = new int[NUM_ALL_PLAYERS_B * NUM_ALL_PLAYERS_B];
  for (int i = 0; i < NUM_ALL_PLAYERS_B * NUM_ALL_PLAYERS_B; i++)
  {
    historicalEnemyAIcheat[i] = 0;
  };

  timelineTechDates = new int[MAX_NUM_TECHS];
  for (int i = 0; i < MAX_NUM_TECHS; i++)
  {
    timelineTechDates[i] = 0;
  };
};

void CyGlobalContext::setGrowthModifiersAI(int iCiv, int iPop, int iCult, int iGP, int iWorker, int iHealth,
                                           int iInitPop)
{
...
void CyGlobalContext::setSupportModifiersAI(int iCiv, int iInflation, int iUnits, int iCityDist, int iCityNum,
                                            int iCivic)
{
...
void CyGlobalContext::setGrowthModifiersHu(int iCiv, int iPop, int iCult, int iGP, int iWorker, int iHealth,
                                           int iInitPop)
{
...
void CyGlobalContext::setSupportModifiersHu(int iCiv, int iInflation, int iUnits, int iCityDist, int iCityNum,
                                            int iCivic)
{
...
void CyGlobalContext::setCoreNormal(int iCiv, int iCBLx, int iCBLy, int iCTRx, int iCTRy, int iNBLx, int iNBLy,
                                    int iNTRx, int iNTRy, int iCCE, int iCNE)
{
  CoreAreasRect[iCiv][0] = iCBLx;
  CoreAreasRect[iCiv][1] = iCBLy;
  CoreAreasRect[iCiv][2] = iCTRx;
  CoreAreasRect[iCiv][3] = iCTRy;
  NormalAreasRect[iCiv][0] = iNBLx;
  NormalAreasRect[iCiv][1] = iNBLy;
  NormalAreasRect[iCiv][2] = iNTRx;
  NormalAreasRect[iCiv][3] = iNTRy;
  CoreAreasMinusCount[iCiv] = 0;
  if (iCCE > 0)
    CoreAreasMinus[iCiv] = new int[2 * iCCE];
  NormalAreasMinusCount[iCiv] = 0;
  if (iCNE > 0)
    NormalAreasMinus[iCiv] = new int[2 * iCNE];
};
...
void CyGlobalContext::setTimelineTechModifiers(int iTPTop, int iTPBottom, int iTPCap, int iTBTop, int iTBBottom,
                                               int iTBCap)
{
...
void CyGlobalContext::setProvince(int iX, int iY, int iProvince)
{ // set the province at tile (iX,iY)
  provinceMap[iY * EARTH_X + iX] = iProvince;
};

void CyGlobalContext::createProvinceCrossreferenceList()
{ // call this after setting all provinces
  int i, j, prov;
...
void CyGlobalContext::setNumRegions(int iNumRegions)
{ // set the total number of regions (this should speedup the AI)
  numRegions = iNumRegions;
};
void CyGlobalContext::setProvinceToRegion(int iProvince, int iRegion)
{ // set a province to belong to a region
  provinceRegionMap[iProvince] = iRegion;
};

void CyGlobalContext::setCultureImmume(int iProvince, int iPlayerException, int iNumTurns)
{ // make a province immune to culture not comming from iPlayerException
  iCultureImmune[iProvince] = iNumTurns;
  iCultureImmuneException[iProvince] = iPlayerException;
};
void CyGlobalContext::setProvinceTypeNumber(int iNum)
{ // set the number of province types
  int i = 0;
...
void CyGlobalContext::setProvinceTypeParams(int iType, int iSettlerValue, int iWarValue, int iCultureTop,
                                            int iCultureBottom)
{
