...
void CyInfoPythonInterface2()
{
  ...
  python::class_<CvGameSpeedInfo, python::bases<CvInfoBase> >("CvGameSpeedInfo")
      ...
      .def("getGameTurnInfo", &CvGameSpeedInfo::getGameTurnInfo,
           python::return_value_policy<python::reference_existing_object>(), "GameTurnInfo ()");
  ...
  python::class_<CvBonusInfo, python::bases<CvInfoBase> >("CvBonusInfo")
      ...
      .def("getArtInfo", &CvBonusInfo::getArtInfo, python::return_value_policy<python::reference_existing_object>(),
           "CvArtInfoBonus ()");
