...
void CyMapGeneratorPythonInterface()
{
  ...
  python::class_<CyMapGenerator>("CyMapGenerator")
      ...
      .def("canPlaceBonusAt", &CyMapGenerator::canPlaceBonusAt,
           "bool (int /*BonusTypes*/ eBonus, int iX, int iY, bool bIgnoreLatitude)")
      .def("canPlaceGoodyAt", &CyMapGenerator::canPlaceGoodyAt,
      ...
      .def("doRiver", &CyMapGenerator::doRiver,
      ...
      .def("setPlotTypes", &CyMapGenerator::setPlotTypes,
