...
void CyMessageControl::sendDoTask(int iCity, int eTask, int iData1, int iData2, bool bOption, bool bAlt, bool bShift,
                                  bool bCtrl)
{
...
void CyMessageControl::sendAdvancedStartAction(int /*AdvancedStartActionTypes*/ eAction, int /*PlayerTypes*/ ePlayer,
                                               int iX, int iY, int iData, bool bAdd)
{
  CvMessageControl::getInstance().sendAdvancedStartAction((AdvancedStartActionTypes)eAction, (PlayerTypes)ePlayer, iX,
                                                          iY, iData, bAdd);
}
