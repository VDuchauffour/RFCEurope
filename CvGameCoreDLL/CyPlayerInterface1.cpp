...
void CyPlayerPythonInterface1(python::class_<CyPlayer> &x)
{
  ...
  x.def("isNone", &CyPlayer::isNone, "checks for a null player")
      .def("startingPlotRange", &CyPlayer::startingPlotRange, "int ()")
      .def("startingPlotWithinRange", &CyPlayer::startingPlotWithinRange,
           "bool (CyPlot *pPlot, int /*PlayerTypes*/ ePlayer, int iRange, int iPass)")

      .def("findStartingPlot", &CyPlayer::findStartingPlot, python::return_value_policy<python::manage_new_object>(),
           "findStartingPlot(bool bRandomize) - Finds a starting plot for player")

      .def("initCity", &CyPlayer::initCity, python::return_value_policy<python::manage_new_object>(),
      ...
      .def("initUnit", &CyPlayer::initUnit, python::return_value_policy<python::manage_new_object>(),
           "CyUnit* initUnit(UnitTypes iIndex, plotX, plotY, UnitAITypes iIndex)  - place Unit at X,Y   NOTE: Always "
           "use UnitAITypes.NO_UNITAI")
      .def("disbandUnit", &CyPlayer::disbandUnit, "void (bool bAnnounce)")

      .def("killUnits", &CyPlayer::killUnits, "void ()")
      .def("hasTrait", &CyPlayer::hasTrait,
      ...
      .def("getCivilizationDescription", &CyPlayer::getCivilizationDescription,
           "str() - returns the Civilization Description String")
      //Rhye (jdog) -  start ---------------------
      .def("setCivName", &CyPlayer::setCivName,
           "void(std::wstring szNewDesc, std::wstring szNewShort, std::wstring szNewAdj)")    // Exposed to Python
      .def("setCivDescription", &CyPlayer::setCivDescription, "void(std::wstring szNewDesc)") // Exposed to Python
      //Rhye (jdog) -  end -----------------------
      .def("getCivilizationShortDescription", &CyPlayer::getCivilizationShortDescription,
           "str() - returns the short Civilization Description")
      .def("getCivilizationDescriptionKey", &CyPlayer::getCivilizationDescriptionKey,
           "str() - returns the Civilization Description String")
      .def("getCivilizationShortDescriptionKey", &CyPlayer::getCivilizationShortDescriptionKey,
           "str() - returns the short Civilization Description")
      .def("getCivilizationAdjective", &CyPlayer::getCivilizationAdjective,
           "str() - returns the Civilization name in adjective form")
      .def("getCivilizationAdjectiveKey", &CyPlayer::getCivilizationAdjectiveKey,
           "str() - returns the Civilization name in adjective form")
      .def("getFlagDecal", &CyPlayer::getFlagDecal, "str() - returns the Civilization flag decal")
      .def("isWhiteFlag", &CyPlayer::isWhiteFlag,
           "bool () - Whether or not this player is using a custom texture flag (set in WBS)")
      .def("getStateReligionName", &CyPlayer::getStateReligionName,
           "str() - returns the name of the Civilizations State Religion")
      .def("getBestAttackUnitName", &CyPlayer::getBestAttackUnitName,
      ...
      .def("countCultBorderBonuses", &CyPlayer::countCultBorderBonuses,
           "int (int (BonusTypes) eBonus) - ") // Absinthe: count bonuses inside cultural borders
      .def("countUnimprovedBonuses", &CyPlayer::countUnimprovedBonuses,
      ...
      .def("countNumBuildings", &CyPlayer::countNumBuildings,
           "int (int /*BuildingTypes*/ eBuilding) - Returns the number of buildings?")
      .def("countPotentialForeignTradeCities", &CyPlayer::countPotentialForeignTradeCities,
           "int (CyArea* pIgnoreArea) - Returns the number of potential foreign trade cities")
      .def("countPotentialForeignTradeCitiesConnected", &CyPlayer::countPotentialForeignTradeCitiesConnected,
           "int () - Returns the number of potential foreign trade cities which are also connected to this player's "
           "capital")
      ...
      .def("canReceiveGoody", &CyPlayer::canReceiveGoody,
      ...
      .def("canConstruct", &CyPlayer::canConstruct,
      ...
      .def("isProductionMaxedUnitClass", &CyPlayer::isProductionMaxedUnitClass,
           "int (int /*UnitClassTypes*/ eUnitClass)")
      .def("isProductionMaxedBuildingClass", &CyPlayer::isProductionMaxedBuildingClass,
      ...
      .def("getProjectProductionNeeded", &CyPlayer::getProjectProductionNeeded,
           "bool (int /*ProjectTypes*/ eProject, bool bContinue, bool bTestVisible)")
      .def("getBuildingClassPrereqBuilding", &CyPlayer::getBuildingClassPrereqBuilding,
      ...
      .def("canBuild", &CyPlayer::canBuild,
           "bool (CyPlot* pPlot, int (BuildTypes) eBuild, bool bTestEra, bool bTestVisible)")

      .def("calculateTotalYield", &CyPlayer::calculateTotalYield,
           "int (int /*YieldTypes*/ eYield) - Returns the total sum of all city yield")
      .def("calculateTotalExports", &CyPlayer::calculateTotalExports,
           "int (int /*YieldTypes*/ eYield) - Returns the total sum of all city gold generated for other civs via "
           "trade routes")
      .def("calculateTotalImports", &CyPlayer::calculateTotalImports,
           "int (int /*YieldTypes*/ eYield) - Returns the total sum of all city gold generated for this civ via trade "
           "routes with others")

      .def("calculateTotalCityHappiness", &CyPlayer::calculateTotalCityHappiness,
           "int () - Returns the total sum of all city Happiness values")
      .def("calculateTotalCityUnhappiness", &CyPlayer::calculateTotalCityUnhappiness,
           "int () - Returns the total sum of all city Unhappiness values")

      .def("calculateTotalCityHealthiness", &CyPlayer::calculateTotalCityHealthiness,
           "int () - Returns the total sum of all city Healthiness values")
      .def("calculateTotalCityUnhealthiness", &CyPlayer::calculateTotalCityUnhealthiness,
      ...
      .def("convertForFree", &CyPlayer::convertForFree,
           "void (int /*ReligionTypes*/ iIndex)") // Absinthe: free religious revolution
      ...
      .def("foundReligion", &CyPlayer::foundReligion,
      ...
      .def("countCorporations", &CyPlayer::countCorporations,
      ...
      .def("specialistYield", &CyPlayer::specialistYield,
           "int (int (SpecialistTypes) eSpecialist, int (YieldTypes) eCommerce)")
      .def("specialistCommerce", &CyPlayer::specialistCommerce,
           "int (int (SpecialistTypes) eSpecialist, int (CommerceTypes) eCommerce)")

      .def("getStartingPlot", &CyPlayer::getStartingPlot, python::return_value_policy<python::manage_new_object>(),
           "CyPlot* ()")
      ...
      .def("getAdvancedStartUnitCost", &CyPlayer::getAdvancedStartUnitCost,
      ...
      .def("getAdvancedStartBuildingCost", &CyPlayer::getAdvancedStartBuildingCost,
           "int (int (BuildingTypes) eUnit, bool bAdd, CyCity* pCity)")
      .def("getAdvancedStartImprovementCost", &CyPlayer::getAdvancedStartImprovementCost,
           "int (int (ImprovementTypes) eImprovement, bool bAdd, CyPlot* pPlot)")
      .def("getAdvancedStartRouteCost", &CyPlayer::getAdvancedStartRouteCost,
      ...
      .def("getAdvancedStartVisibilityCost", &CyPlayer::getAdvancedStartVisibilityCost,
           "int (bool bAdd, CyPlot* pPlot)")

      .def("getEspionageSpending", &CyPlayer::getEspionageSpending, "int (PlayerTypes eIndex)")
      .def("canDoEspionageMission", &CyPlayer::canDoEspionageMission,
           "bool (EspionageMissionTypes eMission, PlayerTypes eTargetPlayer, CyPlot* pPlot, int iExtraData)")
      .def("getEspionageMissionCost", &CyPlayer::getEspionageMissionCost,
           "int (EspionageMissionTypes eMission, PlayerTypes eTargetPlayer, CyPlot* pPlot, int iExtraData)")
      .def("doEspionageMission", &CyPlayer::doEspionageMission,
           "void (EspionageMissionTypes eMission, PlayerTypes eTargetPlayer, CyPlot* pPlot, int iExtraData, CyUnit* "
           "pUnit)")
      .def("getEspionageSpendingWeightAgainstTeam", &CyPlayer::getEspionageSpendingWeightAgainstTeam,
           "int (TeamTypes eIndex)")
      .def("setEspionageSpendingWeightAgainstTeam", &CyPlayer::setEspionageSpendingWeightAgainstTeam,
           "void (TeamTypes eIndex, int iValue)")
      .def("changeEspionageSpendingWeightAgainstTeam", &CyPlayer::changeEspionageSpendingWeightAgainstTeam,
      ...
      .def("createGreatPeople", &CyPlayer::createGreatPeople,
      ...
      .def("changeStateReligionUnitProductionModifier", &CyPlayer::changeStateReligionUnitProductionModifier,
           "void (int iChange)")
      .def("getStateReligionBuildingProductionModifier", &CyPlayer::getStateReligionBuildingProductionModifier,
           "int ()")
      .def("changeStateReligionBuildingProductionModifier", &CyPlayer::changeStateReligionBuildingProductionModifier,
           "void (int iChange)")
      .def("getStateReligionFreeExperience", &CyPlayer::getStateReligionFreeExperience, "int ()")
      .def("getCapitalCity", &CyPlayer::getCapitalCity, python::return_value_policy<python::manage_new_object>(),
           "CyCity* (int iID)")
      ...
      .def("setLastStateReligion", &CyPlayer::setLastStateReligion,
      ...
      .def("getPlayerColor", &CyPlayer::getPlayerColor,
      ...
      .def("getStateReligionBuildingCommerce", &CyPlayer::getStateReligionBuildingCommerce,
      ...
      .def("isBuildingClassMaxedOut", &CyPlayer::isBuildingClassMaxedOut,
      ...
      .def("getBuildingClassCountPlusMaking", &CyPlayer::getBuildingClassCountPlusMaking,
      ...
      .def("getSpecialBuildingNotRequiredCount", &CyPlayer::getSpecialBuildingNotRequiredCount,
           "int (int (SpecialBuildingTypes) eIndex)")
      .def("isSpecialBuildingNotRequired", &CyPlayer::isSpecialBuildingNotRequired,
           "int (int (SpecialBuildingTypes) eIndex)")
      ...
      .def("getSingleCivicUpkeep", &CyPlayer::getSingleCivicUpkeep,
      ...
      .def("setCivics", &CyPlayer::setCivics,
      ...
      .def("changeCombatExperience", &CyPlayer::changeCombatExperience,
           "void (int) - Combat experience used to produce Warlords")
      .def("setCombatExperience", &CyPlayer::setCombatExperience,
           "void (int) - Combat experience used to produce Warlords")

      .def("getSpecialistExtraYield", &CyPlayer::getSpecialistExtraYield,
           "int (int /*SpecialistTypes*/ eIndex1, int /*YieldTypes*/ eIndex2)")
      // Absinthe: specialist commerce change
      .def("getSpecialistExtraCommerceByType", &CyPlayer::getSpecialistExtraCommerceByType,
           "int (int /*SpecialistTypes*/ eIndex1, int /*CommerceTypes*/ eIndex2)")
      ...
      .def("nextCity", &CyPlayer::nextCity,
      ...
      .def("nextUnit", &CyPlayer::nextUnit,
      ...
      .def("firstSelectionGroup", &CyPlayer::firstSelectionGroup,
           "tuple(CySelectionGroup, int iterOut) (bool bReverse) - gets the first selectionGroup")
      .def("nextSelectionGroup", &CyPlayer::nextSelectionGroup,
      ...
      .def("getSelectionGroup", &CyPlayer::getSelectionGroup, python::return_value_policy<python::manage_new_object>(),
           "CvSelectionGroup* (int iID)")

      .def("trigger", &CyPlayer::trigger, "void (/*EventTriggerTypes*/int eEventTrigger)")
      .def("getEventOccured", &CyPlayer::getEventOccured,
      ...
      .def("getEventTriggered", &CyPlayer::getEventTriggered,
           python::return_value_policy<python::reference_existing_object>(), "EventTriggeredData* (int iID)")
      .def("initTriggeredData", &CyPlayer::initTriggeredData,
           python::return_value_policy<python::reference_existing_object>(),
           "EventTriggeredData* (int eEventTrigger, bool bFire, int iCityId, int iPlotX, int iPlotY, PlayerTypes "
           "eOtherPlayer, int iOtherPlayerCityId, ReligionTypes eReligion, CorporationTypes eCorporation, int iUnitId, "
