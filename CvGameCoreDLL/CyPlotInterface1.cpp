...
void CyPlotPythonInterface1(python::class_<CyPlot> &x)
{
  ...
  x.def("isNone", &CyPlot::isNone, "bool ()")
      ...
      .def("isConnectedTo", &CyPlot::isConnectedTo,
           "bool (CvCity* pCity) - returns whether this plot is connected to the provided city")
      .def("isConnectedToCapital", &CyPlot::isConnectedToCapital,
           "bool (int (PlayerTypes) ePlayer) - returns whether this plot is connected to the capital of the provided "
           "player")
      .def("getPlotGroupConnectedBonus", &CyPlot::getPlotGroupConnectedBonus,
           "int (int (PlayerTypes) ePlayer, int (BonusTypes) eBonus)")
      .def("isPlotGroupConnectedBonus", &CyPlot::isPlotGroupConnectedBonus,
           "bool (int (PlayerTypes) ePlayer, int (BonusTypes) eBonus)")
      .def("isAdjacentPlotGroupConnectedBonus", &CyPlot::isAdjacentPlotGroupConnectedBonus,
           "bool (int (PlayerTypes) ePlayer, int (BonusTypes) eBonus)")
      ...
      .def("isWithinTeamCityRadius", &CyPlot::isWithinTeamCityRadius,
      ...
      .def("getNearestLandPlot", &CyPlot::getNearestLandPlot, python::return_value_policy<python::manage_new_object>(),
           "CyPlot* ()")
      ...
      .def("canHaveImprovement", &CyPlot::canHaveImprovement,
           "bool (int (ImprovementTypes) eImprovement, int (TeamTypes) eTeam, bool bPotential)")
      .def("canBuild", &CyPlot::canBuild,
      ...
      .def("getBuildTurnsLeft", &CyPlot::getBuildTurnsLeft,
           "int (int (BuildTypes) eBuild, int iNowExtra, int iThenExtra)")
      .def("getFeatureProduction", &CyPlot::getFeatureProduction,
           "int (int (BuildTypes) eBuild, int (TeamTypes) eTeam, CvCity** ppCity)")

      .def("getBestDefender", &CyPlot::getBestDefender, python::return_value_policy<python::manage_new_object>(),
           "CyUnit* (int (PlayerTypes) eOwner, int (PlayerTypes) eAttackingPlayer, CvUnit* pAttacker, bool bTestAtWar, "
           "bool bTestPotentialEnemy, bool bTestCanMove)")
      .def("getSelectedUnit", &CyPlot::getSelectedUnit, python::return_value_policy<python::manage_new_object>(),
           "CyUnit* ()")
      ...
      .def("getUpgradeTimeLeft", &CyPlot::getUpgradeTimeLeft,
      ...
      .def("setTerrainType", &CyPlot::setTerrainType,
      ...
      .def("getWorkingCity", &CyPlot::getWorkingCity, python::return_value_policy<python::manage_new_object>(),
           "CyCity* ()")
      .def("getWorkingCityOverride", &CyPlot::getWorkingCityOverride,
      ...
      .def("calculateNatureYield", &CyPlot::calculateNatureYield,
           "int (int (YieldTypes) eYield, int (TeamTypes) eTeam, bool bIgnoreFeature)")
      .def("calculateBestNatureYield", &CyPlot::calculateBestNatureYield,
      ...
      .def("calculateImprovementYieldChange", &CyPlot::calculateImprovementYieldChange,
           "int (int (ImprovementTypes) eImprovement, int (YieldTypes) eYield, int (PlayerTypes) ePlayer, bool "
           "bOptimal)")
      ...
      .def("changeVisibilityCount", &CyPlot::changeVisibilityCount,
      ...
      .def("setRevealed", &CyPlot::setRevealed,
           "void (int /*TeamTypes*/ eTeam, bool bNewValue, bool bTerrainOnly, int /*TeamTypes*/ eFromTeam)")
      .def("getRevealedImprovementType", &CyPlot::getRevealedImprovementType,
      ...
      .def("changeBuildProgress", &CyPlot::changeBuildProgress,
           "bool (int /*BuildTypes*/ eBuild, int iChange, int /*TeamTypes*/ eTeam)")

      .def("getCultureRangeCities", &CyPlot::getCultureRangeCities,
      ...
      .def("getInvisibleVisibilityCount", &CyPlot::getInvisibleVisibilityCount,
           "int (int (TeamTypes eTeam), int (InvisibleTypes) eInvisible)")
      .def("isInvisibleVisible", &CyPlot::isInvisibleVisible,
           "int (int (TeamTypes eTeam), int (InvisibleTypes) eInvisible)")
      .def("changeInvisibleVisibilityCount", &CyPlot::changeInvisibleVisibilityCount,
           "int (int (TeamTypes eTeam), int (InvisibleTypes) eInvisible, int iChange)")

      .def("getNumUnits", &CyPlot::getNumUnits, "int ()")
      .def("getUnit", &CyPlot::getUnit, python::return_value_policy<python::manage_new_object>(),
           "CyUnit* (int iIndex)")
      ...
      .def("getLakeNameID", &CyPlot::getLakeNameID, "int ()")
      .def("setLakeNameID", &CyPlot::setLakeNameID, "void (int iNewValue)")
