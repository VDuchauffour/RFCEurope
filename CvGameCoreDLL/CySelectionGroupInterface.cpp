...
void CySelectionGroupInterface()
{
  ...
  python::class_<CySelectionGroup>("CySelectionGroup")
      ...
      .def("pushMission", &CySelectionGroup::pushMission,
      ...
      .def("lastMissionPlot", &CySelectionGroup::lastMissionPlot,
           python::return_value_policy<python::manage_new_object>(), "CvPlot* ()")
      .def("canStartMission", &CySelectionGroup::canStartMission,
           "bool (int iMission, int iData1, int iData2, CyPlot* pPlot, bool bTestVisible)")

      .def("canDoInterfaceMode", &CySelectionGroup::canDoInterfaceMode,
           "bool (int (InterfaceModeTypes) eInterfaceMode)")
      .def("canDoInterfaceModeAt", &CySelectionGroup::canDoInterfaceModeAt,
           "bool (int (InterfaceModeTypes) eInterfaceMode, CyPlot* pPlot)")

      .def("canDoCommand", &CySelectionGroup::canDoCommand,
      ...
      .def("canEnterTerritory", &CySelectionGroup::canEnterTerritory,
           "bool (int /*TeamTypes*/ eTeam, bool bIgnoreRightOfPassage)")
      .def("canEnterArea", &CySelectionGroup::canEnterArea,
           "bool (int /*TeamTypes*/ eTeam, CyArea* pArea, bool bIgnoreRightOfPassage)")
      .def("canMoveInto", &CySelectionGroup::canMoveInto,
           "bool (CyPlot* pPlot, bool bAttack) - can the group move into pPlot?")
      .def("canMoveOrAttackInto", &CySelectionGroup::canMoveOrAttackInto,
      ...
      .def("plot", &CySelectionGroup::plot, python::return_value_policy<python::manage_new_object>(),
      ...
      .def("getBestBuildRoute", &CySelectionGroup::getBestBuildRoute,
      ...
      .def("getActivityType", &CySelectionGroup::getActivityType,
           "int /*ActivityTypes*/ () - ActivityTypes the group is engaging in")
      .def("setActivityType", &CySelectionGroup::setActivityType,
           "void (int /*ActivityTypes*/ eNewValue) - set the group to this ActivityTypes")
      .def("getAutomateType", &CySelectionGroup::getAutomateType,
      ...
      .def("setAutomateType", &CySelectionGroup::setAutomateType,
           "void (int /*AutomateTypes*/ eNewValue) - get the group to perform this AutomateTypes")
      .def("getPathFirstPlot", &CySelectionGroup::getPathFirstPlot,
           python::return_value_policy<python::manage_new_object>(), "CyPlot* ()")
      .def("getPathEndTurnPlot", &CySelectionGroup::getPathEndTurnPlot,
           python::return_value_policy<python::manage_new_object>(), "CyPlot* ()")
      .def("generatePath", &CySelectionGroup::generatePath,
      ...
      .def("getMissionFromQueue", &CySelectionGroup::getMissionFromQueue,
           python::return_value_policy<python::manage_new_object>(), "MissionData* (int iIndex)")
      .def("getHeadUnit", &CySelectionGroup::getHeadUnit, python::return_value_policy<python::manage_new_object>(),
           "CyUnit* ()")
      .def("getUnitAt", &CySelectionGroup::getUnitAt, python::return_value_policy<python::manage_new_object>(),
           "CyUnit* (int index)")
