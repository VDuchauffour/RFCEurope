...
void CyTeam::setHasTech(int /*TechTypes*/ eIndex, bool bNewValue, int /*PlayerTypes*/ ePlayer, bool bFirst,
                        bool bAnnounce)
{
  if (m_pTeam)
...
bool CyTeam::isTrainVassalUU()
{
  return m_pTeam->isTrainVassalUU();
};
int CyTeam::getTrainVassalUU()
{
  return m_pTeam->getTrainVassalUU();
};
void CyTeam::setTrainVassalUU(int iNewVal)
{
  m_pTeam->setTrainVassalUU(iNewVal);
};
