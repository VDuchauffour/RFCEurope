...
void CyTeamPythonInterface()
{
  ...
  python::class_<CyTeam>("CyTeam")
      ...
      .def("declareWar", &CyTeam::declareWar,
           "void (int /*TeamTypes*/ eTeam, bool bNewDiplo, int /*WarPlanTypes*/ eWarPlan) - Forces your team to "
           "declare War on iTeam")
      ...
      .def("getBuildingClassCountPlusMaking", &CyTeam::getBuildingClassCountPlusMaking,
      ...
      .def("changeCommerceFlexibleCount", &CyTeam::changeCommerceFlexibleCount,
      ...
      .def("setProjectDefaultArtType", &CyTeam::setProjectDefaultArtType,
      ...
      .def("changeTerrainTradeCount", &CyTeam::changeTerrainTradeCount,
           "void (TerrainID, iChange) - enables trade through terrain type") // Absinthe
      ...
      .def("changeImprovementYieldChange", &CyTeam::changeImprovementYieldChange,
      ...
      .def("setCounterespionageTurnsLeftAgainstTeam", &CyTeam::setCounterespionageTurnsLeftAgainstTeam,
           "void (TeamTypes eIndex, int iValue)")
      ...
      .def("setCounterespionageModAgainstTeam", &CyTeam::setCounterespionageModAgainstTeam,
           "void (TeamTypes eIndex, int iValue)")
      ...
      // 3Miro: New functions, Vassal UU
      .def("isTrainVassalUU", &CyTeam::isTrainVassalUU, "bool ()")
      .def("getTrainVassalUU", &CyTeam::getTrainVassalUU, "int ()")
      .def("setTrainVassalUU", &CyTeam::setTrainVassalUU, "void (int)")
      .def("setAtWar", &CyTeam::setAtWar, "void (int /*TeamTypes*/ iIndex, bool bNewValue )");
}
