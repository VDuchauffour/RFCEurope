...
void CyUnitPythonInterface1(python::class_<CyUnit> &x)
{
  ...
  x.def("isNone", &CyUnit::isNone, "bool () - Is this a valid unit instance?")
      ...
      .def("canDoCommand", &CyUnit::canDoCommand,
      ...
      .def("getPathEndTurnPlot", &CyUnit::getPathEndTurnPlot, python::return_value_policy<python::manage_new_object>(),
           "CyPlot* ()")
      .def("generatePath", &CyUnit::generatePath,
      ...
      .def("canEnterArea", &CyUnit::canEnterArea,
      ...
      .def("canMoveInto", &CyUnit::canMoveInto,
      ...
      .def("bombardTarget", &CyUnit::bombardTarget, python::return_value_policy<python::manage_new_object>(),
           "CyCity* (CyPlot* pPlot)")
      ...
      .def("upgradeAvailable", &CyUnit::upgradeAvailable,
      ...
      .def("bestInterceptor", &CyUnit::bestInterceptor, python::return_value_policy<python::manage_new_object>(),
           "CyUnit* (CyPlot*)")
      ...
      .def("getGroup", &CyUnit::getGroup, python::return_value_policy<python::manage_new_object>(),
           "CySelectionGroup* ()")
      ...
      .def("getReconPlot", &CyUnit::getReconPlot, python::return_value_policy<python::manage_new_object>(),
           "CyPlot* ()")
      ...
      .def("attackForDamage", &CyUnit::attackForDamage,
      ...
      .def("getArtInfo", &CyUnit::getArtInfo, python::return_value_policy<python::reference_existing_object>(),
