...
template <class T> class FFreeListTrashArray : public FFreeListArrayBase<T>
{
public:
  FFreeListTrashArray();
...
template <class T> FFreeListTrashArray<T>::FFreeListTrashArray()
{
...
template <class T> void FFreeListTrashArray<T>::init(int iNumSlots)
{
  int iCount;
  int iI;
...
template <class T> void FFreeListTrashArray<T>::uninit()
{
  if (m_pArray != NULL)
  {
    removeAll();
...
template <class T> T *FFreeListTrashArray<T>::add()
{
  int iIndex;
...
template <class T> T *FFreeListTrashArray<T>::getAt(int iID) const
{
  int iIndex;
...
template <class T> bool FFreeListTrashArray<T>::remove(T *pData)
{
  int iI;
...
template <class T> bool FFreeListTrashArray<T>::removeAt(int iID)
{
  int iIndex;
...
template <class T> void FFreeListTrashArray<T>::removeAll()
{
  int iI;
...
template <class T> void FFreeListTrashArray<T>::load(T *pData)
{
  int iIndex;
...
template <class T> void FFreeListTrashArray<T>::growArray()
{
...
//
template <class T> inline void FFreeListTrashArray<T>::Read(FDataStreamBase *pStream)
{
  int iTemp;
  pStream->Read(&iTemp);
  init(iTemp);
...
template <class T> inline void FFreeListTrashArray<T>::Write(FDataStreamBase *pStream)
{
