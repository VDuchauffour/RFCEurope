...
#Sedna17. Seeing if I can make plagues last different length of time
iDuration = 6
...
#####################################  
		...
		#self.setGenericPlagueDates(0, 50 + gc.getGame().getSorenRandNum(3, 'Variation') - 10) #Plagues of Constantinople
