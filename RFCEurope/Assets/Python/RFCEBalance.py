...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setGrowthModifiers(iPortugal,     100, 100, 100, 100, 100, 3 )
		gc.setGrowthModifiers(iAustria,      100, 100, 100, 100, 100, 3 )
		gc.setGrowthModifiers(iTurkey,       100, 150, 100, 100, 100, 3 )
		gc.setGrowthModifiers(iSweden,       100, 170, 100, 100, 100, 4 )
		gc.setGrowthModifiers(iDutch,        100, 200, 100, 100, 100, 4 )
		...
		#gc.setProductionModifiers(iBurgundy,     200, 150, 150, 150 )
		##gc.setProductionModifiers(iByzantium,    300, 200, 200, 330 )
		#gc.setProductionModifiers(iByzantium,    400, 200, 200, 330 )
		#gc.setProductionModifiers(iFrankia,      150, 100, 100, 165 )
		#gc.setProductionModifiers(iArabia,       350, 200, 200, 300 )
		#gc.setProductionModifiers(iBulgaria,     150, 100, 100, 190 )
		#gc.setProductionModifiers(iCordoba,      200, 200, 100, 165 )
		#gc.setProductionModifiers(iSpain,        100, 100, 100, 121 )
		#gc.setProductionModifiers(iNorse,        150, 100, 100, 150 )
		#gc.setProductionModifiers(iVenecia,      150, 100, 100, 165 )
		#gc.setProductionModifiers(iKiev,         150, 100, 100, 150 )
		#gc.setProductionModifiers(iHungary,      150, 100, 100, 165 )
		#gc.setProductionModifiers(iGermany,      150, 100, 100, 165 )
		#gc.setProductionModifiers(iPoland,       150, 120, 120, 190 )
		#gc.setProductionModifiers(iMoscow,       150, 100, 100, 110 )
		#gc.setProductionModifiers(iGenoa,        150, 100, 100, 110 )
		#gc.setProductionModifiers(iEngland,      150, 100, 100, 132 )
		...
		#gc.setProductionModifiers(iIndependent2, 150, 100, 500, 450 )
		#gc.setProductionModifiers(iIndependent3, 150, 100, 500, 450 )
		#gc.setProductionModifiers(iIndependent4, 150, 100, 500, 450 )
		#gc.setProductionModifiers(iBarbarian,    150, 100, 1000, 500 )
		# Myri: I was here!
		...
		gc.setProductionModifiers(iKiev, 150, 100, 100, 330 )
		gc.setProductionModifiers(iHungary, 150, 100, 100, 330 )
		gc.setProductionModifiers(iGermany, 150, 100, 100, 240 )
		gc.setProductionModifiers(iPoland, 150, 120, 120, 280 )
		gc.setProductionModifiers(iMoscow, 150, 100, 100, 160 )
		gc.setProductionModifiers(iGenoa, 150, 100, 100, 160 )
		gc.setProductionModifiers(iEngland, 150, 100, 100, 200 )
		gc.setProductionModifiers(iPortugal, 135, 100, 100, 200 )
		gc.setProductionModifiers(iAustria, 120, 90, 100, 200 )
		gc.setProductionModifiers(iTurkey, 75, 70, 100, 160 )
		gc.setProductionModifiers(iSweden, 75, 60, 100, 120 )
		gc.setProductionModifiers(iDutch, 75, 50, 100, 95 )
		...
		gc.setSupportModifiers(iVenecia,       10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iKiev,          10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iHungary,       10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iGermany,       10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iPoland,        10, 150,  60,  25, 100 )
		gc.setSupportModifiers(iMoscow,        10, 150,  50,  25, 100 ) # sync with UP
		gc.setSupportModifiers(iGenoa,         10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iEngland,       10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iPortugal,      10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iAustria,       10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iTurkey,        10, 75,  40,  10, 100 )
		gc.setSupportModifiers(iSweden,        10, 75,  50,  25, 100 )
		gc.setSupportModifiers(iDutch,         10, 150,  50,  25, 100 )
		gc.setSupportModifiers(iPope,          10, 200,  50,  25, 100 )
		gc.setSupportModifiers(iIndependent,   10, 200,  10,  20, 100 )
		gc.setSupportModifiers(iIndependent2,  10, 200,  10,  20, 100 )
		gc.setSupportModifiers(iIndependent3,  10, 200,  10,  20, 100 )
		gc.setSupportModifiers(iIndependent4,  10, 200,  10,  20, 100 )
		...
		gc.setCityClusterAI( iGermany, 1, 4, 1 )
		...
		gc.setCityClusterAI( iTurkey, 1, 2, 1 )
