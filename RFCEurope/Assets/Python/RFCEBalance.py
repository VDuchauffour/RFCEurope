...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setGrowthModifiersAI(iAustria,      100, 300, 100, 100, 100, 3 ) # Austria is squashed by other's culture, they need the boost
		...
		gc.setProductionModifiersAI(iByzantium, 250, 220, 200, 350 )
		gc.setProductionModifiersHu(iByzantium, 200, 150, 200, 350 )
		gc.setProductionModifiersAI(iFrankia,   150, 110, 125, 120 )
		gc.setProductionModifiersHu(iFrankia,   150, 110, 125, 125 )
		gc.setProductionModifiersAI(iArabia,    150, 125, 150, 280 )
		gc.setProductionModifiersHu(iArabia,    150, 125, 150, 230 )
		gc.setProductionModifiersAI(iBulgaria,  150, 125, 125, 250 )
		...
		gc.setProductionModifiersAI(iVenecia,    80,  80, 100, 120 )
