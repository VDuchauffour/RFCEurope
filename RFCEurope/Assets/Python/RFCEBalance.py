...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiersAI(iByzantium, 170, 200, 200, 350 )
		gc.setProductionModifiersHu(iByzantium, 180, 150, 200, 350 )
		gc.setProductionModifiersAI(iFrankia,   140, 110, 125, 120 )
