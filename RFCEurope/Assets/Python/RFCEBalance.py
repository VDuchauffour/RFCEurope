...
class RFCEBalance:
	...
	def setBalanceParameters( self ):
		...
		gc.setProductionModifiersAI(iArabia,    150, 125, 150, 230 )
		...
		gc.setProductionModifiersAI(iVenecia,   100, 100, 100, 125 )
		...
		gc.setSupportModifiersAI(iBulgaria,      20, 150,  70,  25, 110 )
		gc.setSupportModifiersHu(iBulgaria,      20, 150,  70,  25, 110 )
