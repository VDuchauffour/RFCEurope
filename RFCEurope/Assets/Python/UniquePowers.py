...
#####################################  
        ...
        def checkTurn(self, iGameTurn):
                ...
                #if ( iGameTurn >= con.tBirth[con.iHungary] ):
                #	gc.damageFromBuilding( con.iHungary, con.iHungarianStronhold, 8, 16 )
                #print(" NOW ")
                pass
			...
			if (iStateReligion == 3):
			        iTemple = xml.iOrthodoxTemple
                        if (not city.hasBuilding(iTemple)):
                                ...
                                pFaithful.changeFaith( 1 )
                        #if (not city.hasBuilding(xml.iCatholicCathedral + iStateReligion*4)):
                        #        city.setHasRealBuilding((xml.iCatholicCathedral + iStateReligion*4), True)
...
#------------------AZTEC U.P.-------------------
        ...
        #def aztecUP(self, argsList): #Real Slavery by Sevo
                ...
                #if (pLosingUnit.getUnitType() < xml.iSpearman):
                        #return
                ...
                ## Only enslave land units!!
                        ...
                        #if (iRandom < 50):
                                #pNewUnit = pWinningPlayer.initUnit(xml.iWorker, pWinningUnit.getX(), pWinningUnit.getY(), UnitAITypes.UNITAI_WORKER, DirectionTypes.DIRECTION_SOUTH)
