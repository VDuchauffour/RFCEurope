...
tNorseSettle = ( (35, 31, 48, 51 ), (39, 52, 45, 67 ), (35, 52, 38, 56 ), (31, 57, 37, 62 ), ( 18, 71, 21, 72 ), ( 54, 16, 58, 19)  ) # France, Britain, Britain, Ireland, Iseland, Sicily
...
#####################################  
		...
		if ( iPlayer == iBurgundy and pBurgundy.isAlive() ):
			...
			if ( iGameTurn <= i1101AD and self.getGoal( iNorse, 0 ) == -1 ):
			...
			if (iGameTurn == i1101AD+1 and self.getGoal(iNorse,0) == -1):
				self.setGoal( iNorse, 0, 0 )
